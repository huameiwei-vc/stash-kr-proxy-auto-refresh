# KR 免费代理自动刷新报告（2026-07-07T23:42:21+00:00）
...
- 1. `socks5://43.128.150.150:1080` | `socks5` | `elite` | 200 0.728436 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.403969 | source=`geonode`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.040871 | source=`monosans_kr_json`
- 4. `http://168.126.169.198:808` | `http` | `unknown` | 200 8.254345 | source=`niek`
- 5. `http://14.53.55.217:3128` | `http` | `transparent` | 200 0.554962 | source=`proxifly`
- 6. `http://106.10.55.212:1121` | `http` | `transparent` | 200 0.736250 | source=`proxyscrape`
