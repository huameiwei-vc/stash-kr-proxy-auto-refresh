# KR 免费代理自动刷新报告（2026-06-26T13:34:27+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.731883 | source=`monosans_kr_json`
- 2. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.689371 | source=`proxifly`
- 3. `socks5://152.70.241.59:1080` | `socks5` | `transparent` | 200 1.178659 | source=`proxifly`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 3.200374 | source=`proxifly`
