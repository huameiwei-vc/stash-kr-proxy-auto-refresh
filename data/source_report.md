# KR 免费代理自动刷新报告（2026-05-29T22:02:12+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.266712 | source=`geonode`
- 2. `socks5://152.70.91.193:40000` | `socks5` | `elite` | 200 1.297561 | source=`proxyscrape`
- 3. `socks5://158.247.240.61:1080` | `socks5` | `elite` | 200 6.059628 | source=`proxyscrape`
- 4. `socks5://130.162.141.185:52916` | `socks5` | `elite` | 200 7.684924 | source=`proxyscrape`
- 5. `socks5://146.56.191.98:14785` | `socks5` | `elite` | 200 8.106982 | source=`proxyscrape`
- 6. `socks4://146.56.185.39:10800` | `socks4` | `elite` | 200 1.004448 | source=`proxyscrape`
- 7. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 3.174519 | source=`proxyscrape`
- 8. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.874225 | source=`monosans_kr_json`
- 9. `http://43.128.145.26:1080` | `http` | `unknown` | 200 1.769020 | source=`niek`
- 10. `http://210.223.44.230:3128` | `http` | `unknown` | 200 2.061772 | source=`niek`
- 11. `http://43.155.208.105:80` | `http` | `unknown` | 200 8.555346 | source=`monosans_kr_json`
