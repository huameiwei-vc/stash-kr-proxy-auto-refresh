# KR 免费代理自动刷新报告（2026-04-17T04:19:37+00:00）
...
- 1. `socks5://193.122.105.251:65535` | `socks5` | `elite` | 200 1.297712 | source=`geonode`
- 2. `http://175.194.173.105:3128` | `http` | `elite` | 200 0.729092 | source=`proxyscrape`
- 3. `socks5://123.214.62.25:6881` | `socks5` | `unknown` | 200 1.062753 | source=`monosans_kr_json`
- 4. `socks5://158.179.173.238:1080` | `socks5` | `unknown` | 200 2.644253 | source=`monosans_kr_json`
- 5. `socks5://206.123.156.207:8333` | `socks5` | `unknown` | 200 5.708910 | source=`monosans_kr_json`
- 6. `socks5://206.123.156.181:7496` | `socks5` | `unknown` | 200 6.274020 | source=`monosans_kr_json`
- 7. `socks5://206.123.156.218:6717` | `socks5` | `unknown` | 200 7.705254 | source=`monosans_kr_json`
- 8. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.966520 | source=`monosans_kr_json`
- 9. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 3.882462 | source=`proxifly`
- 10. `http://152.69.229.220:3128` | `http` | `transparent` | 200 5.796437 | source=`proxyscrape`
