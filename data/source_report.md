# KR 免费代理自动刷新报告（2026-05-14T14:40:41+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.936021 | source=`geonode`
- 2. `socks5://152.70.91.193:40000` | `socks5` | `elite` | 200 1.633246 | source=`proxyscrape`
- 3. `http://210.223.44.230:3128` | `http` | `unknown` | 200 0.735210 | source=`niek`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.930073 | source=`niek`
- 5. `http://106.10.55.212:1121` | `http` | `unknown` | 200 0.932068 | source=`niek`
