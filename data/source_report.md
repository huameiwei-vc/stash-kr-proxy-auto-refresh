# KR 免费代理自动刷新报告（2026-08-08T05:25:02+00:00）
...
- 1. `socks5://1.245.175.180:1080` | `socks5` | `elite` | 200 0.993234 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.246522 | source=`geonode`
- 3. `http://211.233.44.58:8080` | `http` | `elite` | 200 1.252667 | source=`proxyscrape`
- 4. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.148336 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.759067 | source=`monosans_kr_json`
- 6. `http://121.174.186.199:8080` | `http` | `unknown` | 200 2.498083 | source=`monosans_kr_json`
- 7. `http://47.80.60.84:3128` | `http` | `transparent` | 200 0.771022 | source=`proxyscrape`
