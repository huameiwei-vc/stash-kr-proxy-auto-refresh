# KR 免费代理自动刷新报告（2026-05-30T11:08:28+00:00）
...
- 1. `socks5://152.70.91.193:40000` | `socks5` | `elite` | 200 1.536118 | source=`geonode`
- 2. `socks5://158.247.206.191:1080` | `socks5` | `elite` | 200 2.079757 | source=`proxyscrape`
- 3. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 2.161701 | source=`geonode`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.240281 | source=`geonode`
- 5. `socks5://158.180.77.24:1080` | `socks5` | `elite` | 200 8.734652 | source=`geonode`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.737617 | source=`monosans_kr_json`
- 7. `socks5://218.148.230.126:1080` | `socks5` | `transparent` | 200 0.991805 | source=`proxifly`
