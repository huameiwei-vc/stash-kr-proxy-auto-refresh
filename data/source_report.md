# KR 免费代理自动刷新报告（2026-08-15T08:49:50+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.453443 | source=`geonode`
- 2. `http://43.164.129.36:3128` | `http` | `elite` | 200 3.880396 | source=`geonode`
- 3. `socks4://1.245.175.180:1080` | `socks4` | `elite` | 200 5.295351 | source=`proxyscrape`
- 4. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.849028 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.730061 | source=`monosans_kr_json`
- 6. `http://112.216.54.226:12121` | `http` | `unknown` | 200 0.929323 | source=`monosans_kr_json`
