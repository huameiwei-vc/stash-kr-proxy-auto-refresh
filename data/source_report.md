# KR 免费代理自动刷新报告（2026-06-13T00:05:04+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.970395 | source=`geonode`
- 2. `socks5://158.180.77.24:1080` | `socks5` | `elite` | 200 1.611056 | source=`geonode`
- 3. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 3.580680 | source=`proxyscrape`
- 4. `socks4://211.245.23.166:1080` | `socks4` | `elite` | 200 3.492028 | source=`proxyscrape`
- 5. `socks4://1.245.175.180:1080` | `socks4` | `elite` | 200 4.272847 | source=`proxyscrape`
- 6. `http://169.212.15.161:5000` | `http` | `unknown` | 200 0.985007 | source=`monosans_kr_json`
- 7. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.022676 | source=`monosans_kr_json`
- 8. `socks5://206.123.156.234:6295` | `socks5` | `transparent` | 200 3.930217 | source=`proxifly`
- 9. `socks5://206.123.156.224:5692` | `socks5` | `transparent` | 200 4.511355 | source=`proxifly`
- 10. `socks5://206.123.156.229:45226` | `socks5` | `transparent` | 200 5.030995 | source=`proxifly`
- 11. `http://43.155.238.7:3128` | `http` | `transparent` | 200 6.542644 | source=`proxyscrape`
