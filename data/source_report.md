# KR 免费代理自动刷新报告（2026-07-25T16:29:40+00:00）
...
- 1. `socks5://218.52.249.121:1080` | `socks5` | `elite` | 200 0.670753 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.690798 | source=`geonode`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.660893 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.741608 | source=`monosans_kr_json`
- 5. `socks5://8.213.149.224:1080` | `socks5` | `transparent` | 200 0.670847 | source=`proxifly`
- 6. `socks5://206.123.156.219:5555` | `socks5` | `transparent` | 200 3.361683 | source=`proxifly`
- 7. `socks5://206.123.156.219:4447` | `socks5` | `transparent` | 200 3.386054 | source=`proxifly`
- 8. `socks5://206.123.156.219:4438` | `socks5` | `transparent` | 200 3.665759 | source=`proxifly`
- 9. `socks5://206.123.156.219:6242` | `socks5` | `transparent` | 200 3.985167 | source=`proxifly`
- 10. `http://125.129.15.34:3128` | `http` | `transparent` | 200 0.544900 | source=`proxifly`
