# KR 免费代理自动刷新报告（2026-04-01T07:51:58+00:00）
...
- 1. `socks5://123.214.62.25:6881` | `socks5` | `unknown` | 200 2.658570 | source=`skillter_socks5`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.805380 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.948099 | source=`proxifly`
- 4. `socks5://94.130.16.48:30006` | `socks5` | `transparent` | 200 11.498773 | source=`proxifly`
