# KR 免费代理自动刷新报告（2026-06-23T16:40:02+00:00）
...
- 1. `socks5://158.179.171.148:1080` | `socks5` | `elite` | 200 2.103038 | source=`proxyscrape`
- 2. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 1.196588 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 9.108134 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.928288 | source=`proxifly`
- 5. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 1.004185 | source=`proxifly`
