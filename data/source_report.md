# KR 免费代理自动刷新报告（2026-08-16T19:01:10+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.846567 | source=`monosans_kr_json`
- 2. `http://111.119.162.248:10940` | `http` | `unknown` | 200 9.215197 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.859993 | source=`proxifly`
- 4. `http://132.226.171.101:3128` | `http` | `transparent` | 200 0.861122 | source=`proxifly`
