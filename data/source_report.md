# KR 免费代理自动刷新报告（2026-07-02T03:23:46+00:00）
...
- 1. `socks5://101.33.76.248:1080` | `socks5` | `elite` | 200 0.952750 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 4.168193 | source=`geonode`
- 3. `socks5://152.70.241.59:1080` | `socks5` | `elite` | 200 11.103455 | source=`geonode`
- 4. `socks5://43.128.150.150:1080` | `socks5` | `unknown` | 200 0.693863 | source=`monosans_kr_json`
- 5. `socks5://152.70.237.238:3128` | `socks5` | `unknown` | 200 8.292017 | source=`monosans_kr_json`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.788500 | source=`monosans_kr_json`
- 7. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 1.210126 | source=`proxifly`
