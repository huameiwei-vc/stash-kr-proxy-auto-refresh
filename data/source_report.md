# KR 免费代理自动刷新报告（2026-05-12T10:12:12+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.724350 | source=`geonode`
- 2. `socks5://158.247.212.189:1080` | `socks5` | `elite` | 200 1.982751 | source=`proxyscrape`
- 3. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 4.402059 | source=`proxyscrape`
- 4. `http://210.223.44.230:3128` | `http` | `unknown` | 200 0.605927 | source=`niek`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.889398 | source=`monosans_kr_json`
