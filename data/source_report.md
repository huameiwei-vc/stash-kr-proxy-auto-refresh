# KR 免费代理自动刷新报告（2026-06-29T14:56:03+00:00）
...
- 1. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.797913 | source=`proxifly`
- 2. `socks5://152.70.241.59:1080` | `socks5` | `transparent` | 200 1.414779 | source=`proxifly`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.726779 | source=`proxifly`
- 4. `http://146.56.182.165:3128` | `http` | `transparent` | 200 0.693908 | source=`proxyscrape`
