# KR 免费代理自动刷新报告（2026-08-24T15:05:42+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.782064 | source=`monosans_kr_json`
- 2. `http://101.79.29.143:3128` | `http` | `unknown` | 200 0.633595 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.677020 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.954744 | source=`proxifly`
