# KR 免费代理自动刷新报告（2026-05-07T17:22:13+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 5.371786 | source=`geonode`
- 2. `socks4://47.80.9.115:1080` | `socks4` | `elite` | 200 0.762551 | source=`proxyscrape`
- 3. `socks5://47.80.9.115:1080` | `socks5` | `unknown` | 200 0.928278 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.075582 | source=`monosans_kr_json`
