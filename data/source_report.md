# KR 免费代理自动刷新报告（2026-07-07T21:48:11+00:00）
...
- 1. `socks5://43.128.150.150:1080` | `socks5` | `elite` | 200 0.698247 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.036658 | source=`geonode`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.611863 | source=`monosans_kr_json`
- 4. `http://106.10.55.212:1121` | `http` | `unknown` | 200 2.850425 | source=`monosans_kr_json`
- 5. `socks5://211.200.27.100:11111` | `socks5` | `transparent` | 200 2.330326 | source=`proxifly`
- 6. `http://43.155.138.148:3128` | `http` | `transparent` | 200 3.317275 | source=`proxifly`
