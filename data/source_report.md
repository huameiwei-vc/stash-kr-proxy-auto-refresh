# KR 免费代理自动刷新报告（2026-08-13T13:40:37+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.664075 | source=`geonode`
- 2. `socks5://52.78.144.96:1080` | `socks5` | `elite` | 200 0.982681 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.687254 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.539636 | source=`monosans_kr_json`
- 5. `http://112.216.54.226:12121` | `http` | `unknown` | 200 0.703045 | source=`monosans_kr_json`
- 6. `http://20.249.202.171:443` | `http` | `unknown` | 200 2.843474 | source=`monosans_kr_json`
