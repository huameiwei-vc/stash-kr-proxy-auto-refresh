# KR 免费代理自动刷新报告（2026-08-02T14:19:47+00:00）
...
- 1. `socks5://43.155.185.73:1080` | `socks5` | `unknown` | 200 0.728534 | source=`monosans_kr_json`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.737860 | source=`monosans_kr_json`
- 3. `socks5://43.155.232.123:1080` | `socks5` | `unknown` | 200 1.737886 | source=`monosans_kr_json`
- 4. `socks5://218.52.249.121:1080` | `socks5` | `unknown` | 200 4.739092 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.602355 | source=`monosans_kr_json`
- 6. `http://43.155.232.123:8090` | `http` | `unknown` | 200 1.713262 | source=`monosans_kr_json`
