# KR 免费代理自动刷新报告（2026-09-06T15:44:06+00:00）
...
- 1. `socks5://8.220.245.72:9898` | `socks5` | `elite` | 200 5.890313 | source=`proxyscrape`
- 2. `http://132.145.89.15:6688` | `http` | `anonymous` | 200 1.128802 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.728810 | source=`monosans_kr_json`
- 4. `http://112.216.54.226:12121` | `http` | `unknown` | 200 0.940316 | source=`monosans_kr_json`
- 5. `http://129.154.201.19:33128` | `http` | `transparent` | 200 3.605314 | source=`proxyscrape`
