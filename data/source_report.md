# KR 免费代理自动刷新报告（2026-07-25T15:33:24+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.447065 | source=`geonode`
- 2. `socks5://218.52.249.121:1080` | `socks5` | `elite` | 200 2.576871 | source=`geonode`
- 3. `socks5://140.238.28.230:10808` | `socks5` | `elite` | 200 3.069677 | source=`proxyscrape`
- 4. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.926332 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.971693 | source=`monosans_kr_json`
- 6. `socks5://8.213.149.224:1080` | `socks5` | `transparent` | 200 0.941520 | source=`proxifly`
- 7. `socks5://206.123.156.234:10013` | `socks5` | `transparent` | 200 4.222555 | source=`proxifly`
- 8. `socks5://206.123.156.215:7675` | `socks5` | `transparent` | 200 9.572524 | source=`proxifly`
- 9. `socks5://206.123.156.215:7035` | `socks5` | `transparent` | 200 11.924429 | source=`proxifly`
