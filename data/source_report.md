# KR 免费代理自动刷新报告（2026-08-17T08:05:44+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 4.668941 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.762301 | source=`monosans_kr_json`
- 3. `http://111.119.162.248:10940` | `http` | `unknown` | 200 11.644822 | source=`monosans_kr_json`
