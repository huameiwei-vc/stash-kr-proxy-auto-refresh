# KR 免费代理自动刷新报告（2026-07-14T19:10:31+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.430493 | source=`geonode`
- 2. `http://8.220.216.57:3128` | `http` | `elite` | 200 1.479062 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.713440 | source=`monosans_kr_json`
- 4. `http://43.131.224.66:80` | `http` | `transparent` | 200 1.387960 | source=`proxyscrape`
- 5. `http://58.180.17.51:3128` | `http` | `transparent` | 200 2.408632 | source=`proxifly`
