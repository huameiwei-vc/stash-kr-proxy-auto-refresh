# KR 免费代理自动刷新报告（2026-07-05T10:32:16+00:00）
...
- 1. `socks5://43.128.150.150:1080` | `socks5` | `elite` | 200 0.880955 | source=`geonode`
- 2. `socks5://101.33.76.248:1080` | `socks5` | `elite` | 200 1.218971 | source=`geonode`
- 3. `socks5://146.56.191.98:14785` | `socks5` | `elite` | 200 2.310901 | source=`proxyscrape`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 3.205511 | source=`geonode`
- 5. `http://8.220.216.57:3128` | `http` | `elite` | 200 0.676063 | source=`proxyscrape`
- 6. `socks5://152.70.241.59:1080` | `socks5` | `unknown` | 200 1.904410 | source=`iplocate`
- 7. `http://220.95.64.74:1521` | `http` | `unknown` | 200 0.898551 | source=`niek`
- 8. `http://220.95.121.83:1521` | `http` | `unknown` | 200 0.940217 | source=`niek`
- 9. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.941675 | source=`niek`
- 10. `http://121.180.75.228:1723` | `http` | `unknown` | 200 0.953858 | source=`niek`
- 11. `socks4://146.56.185.39:10800` | `socks4` | `unknown` | 200 1.110857 | source=`iplocate`
- 12. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 1.016007 | source=`proxifly`
- 13. `socks5://206.123.156.228:5662` | `socks5` | `transparent` | 200 5.113975 | source=`proxifly`
- 14. `socks5://206.123.156.228:6685` | `socks5` | `transparent` | 200 7.447935 | source=`proxifly`
