# KR 免费代理自动刷新报告（2026-05-07T22:40:31+00:00）
...
- 1. `socks5://152.70.91.193:40000` | `socks5` | `elite` | 200 1.334239 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.764315 | source=`geonode`
- 3. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 9.201930 | source=`proxyscrape`
- 4. `socks4://47.80.9.115:1080` | `socks4` | `elite` | 200 0.762091 | source=`proxyscrape`
- 5. `socks5://47.80.9.115:1080` | `socks5` | `unknown` | 200 0.900940 | source=`monosans_kr_json`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.155701 | source=`monosans_kr_json`
