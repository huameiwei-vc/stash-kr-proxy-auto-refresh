# KR 免费代理自动刷新报告（2026-08-08T10:56:16+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 4.265674 | source=`geonode`
- 2. `http://211.233.44.58:8080` | `http` | `elite` | 200 0.881045 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.630379 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.536209 | source=`monosans_kr_json`
- 5. `http://221.165.95.161:8080` | `http` | `unknown` | 200 1.793389 | source=`monosans_kr_json`
- 6. `http://118.33.124.132:52427` | `http` | `unknown` | 200 6.721468 | source=`monosans_kr_json`
