# KR 免费代理自动刷新报告（2026-08-24T19:49:43+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.529882 | source=`geonode`
- 2. `http://112.216.54.226:12121` | `http` | `elite` | 200 0.656348 | source=`geonode`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.610158 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.512546 | source=`monosans_kr_json`
- 5. `http://43.203.234.171:3128` | `http` | `transparent` | 200 8.176562 | source=`proxifly`
