# KR 免费代理自动刷新报告（2026-04-19T11:31:25+00:00）
...
- 1. `socks5://158.179.173.238:1080` | `socks5` | `elite` | 200 1.004894 | source=`proxyscrape`
- 2. `socks5://193.122.105.251:65535` | `socks5` | `elite` | 200 1.645712 | source=`geonode`
- 3. `socks4://158.247.206.191:1080` | `socks4` | `elite` | 200 4.391534 | source=`proxyscrape`
- 4. `socks5://123.214.62.25:6881` | `socks5` | `unknown` | 200 0.982261 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.612965 | source=`monosans_kr_json`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.620537 | source=`proxifly`
