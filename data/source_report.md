# KR 免费代理自动刷新报告（2026-04-12T08:28:18+00:00）
...
- 1. `http://210.223.44.230:3128` | `http` | `anonymous` | 200 1.955460 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.857036 | source=`niek`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.937871 | source=`proxifly`
- 4. `socks5://206.123.156.223:4873` | `socks5` | `transparent` | 200 3.390527 | source=`proxifly`
- 5. `socks5://206.123.156.223:4627` | `socks5` | `transparent` | 200 3.964995 | source=`proxifly`
- 6. `http://119.195.17.15:3128` | `http` | `transparent` | 200 3.838199 | source=`proxyscrape`
- 7. `http://121.177.154.16:3176` | `http` | `transparent` | 200 6.511320 | source=`proxyscrape`
