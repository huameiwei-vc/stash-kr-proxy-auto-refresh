# KR 免费代理自动刷新报告（2026-07-24T14:07:33+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.182028 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.661685 | source=`monosans_kr_json`
- 3. `socks5://8.213.149.224:1080` | `socks5` | `unknown` | 200 1.906802 | source=`iplocate`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.766548 | source=`monosans_kr_json`
- 5. `http://211.233.44.58:8080` | `http` | `unknown` | 200 4.977149 | source=`niek`
- 6. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.686934 | source=`proxifly`
- 7. `http://125.129.15.34:3128` | `http` | `transparent` | 200 0.539493 | source=`proxifly`
- 8. `http://106.10.55.212:1121` | `http` | `transparent` | 200 0.625077 | source=`proxyscrape`
