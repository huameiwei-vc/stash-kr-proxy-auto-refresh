# KR 免费代理自动刷新报告（2026-04-27T20:46:58+00:00）
...
- 1. `socks5://43.133.90.161:8088` | `socks5` | `unknown` | 200 7.554516 | source=`monosans_kr_json`
- 2. `http://43.133.90.161:8888` | `http` | `unknown` | 200 6.397665 | source=`niek`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.729390 | source=`proxifly`
