# KR 免费代理自动刷新报告（2026-08-22T11:10:46+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.128021 | source=`monosans_kr_json`
- 2. `socks5://150.109.247.86:8443` | `socks5` | `unknown` | 200 1.158654 | source=`monosans_kr_json`
- 3. `socks5://111.119.162.248:10940` | `socks5` | `unknown` | 200 4.054466 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.784208 | source=`niek`
- 5. `http://111.119.162.248:10940` | `http` | `unknown` | 200 2.758983 | source=`monosans_kr_json`
