# KR 免费代理自动刷新报告（2026-08-25T19:20:11+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.179611 | source=`geonode`
- 2. `socks5://43.155.159.164:1080` | `socks5` | `elite` | 200 2.410914 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.936404 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.748512 | source=`monosans_kr_json`
