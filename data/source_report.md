# KR 免费代理自动刷新报告（2026-07-01T10:32:06+00:00）
...
- 1. `socks5://43.128.150.150:1080` | `socks5` | `elite` | 200 0.961842 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.147527 | source=`geonode`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.030462 | source=`niek`
- 4. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.920035 | source=`proxifly`
- 5. `http://193.122.96.242:3128` | `http` | `transparent` | 200 0.784084 | source=`proxyscrape`
- 6. `http://106.10.55.212:1121` | `http` | `transparent` | 200 4.983586 | source=`proxyscrape`
