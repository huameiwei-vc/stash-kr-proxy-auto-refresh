# KR 免费代理自动刷新报告（2026-05-15T21:38:57+00:00）
...
- 1. `socks5://152.70.91.193:40000` | `socks5` | `elite` | 200 1.078483 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.122565 | source=`geonode`
- 3. `http://175.194.173.105:3128` | `http` | `elite` | 200 0.572206 | source=`proxyscrape`
- 4. `socks4://158.247.212.189:1080` | `socks4` | `elite` | 200 1.281635 | source=`proxyscrape`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.735538 | source=`monosans_kr_json`
- 6. `http://106.10.55.212:1121` | `http` | `transparent` | 200 0.667721 | source=`proxyscrape`
- 7. `http://146.56.164.121:3128` | `http` | `transparent` | 200 11.473134 | source=`proxyscrape`
