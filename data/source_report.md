# KR 免费代理自动刷新报告（2026-05-12T19:07:14+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.705973 | source=`geonode`
- 2. `http://43.200.174.49:3128` | `http` | `unknown` | 200 0.563076 | source=`monosans_kr_json`
- 3. `http://106.10.55.212:1121` | `http` | `unknown` | 200 2.894023 | source=`monosans_kr_json`
