# KR 免费代理自动刷新报告（2026-06-24T11:26:03+00:00）
...
- 1. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 1.200406 | source=`proxyscrape`
- 2. `socks5://158.179.171.148:1080` | `socks5` | `elite` | 200 1.801608 | source=`proxyscrape`
- 3. `socks5://158.179.173.238:1080` | `socks5` | `elite` | 200 5.097397 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.776491 | source=`niek`
- 5. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.688543 | source=`proxifly`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.546123 | source=`proxifly`
