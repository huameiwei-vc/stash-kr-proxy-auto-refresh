# KR 免费代理自动刷新报告（2026-08-12T11:27:04+00:00）
...
- 1. `socks5://47.80.27.150:1080` | `socks5` | `elite` | 200 0.735312 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.533291 | source=`geonode`
- 3. `http://150.230.249.56:1080` | `http` | `elite` | 200 1.317426 | source=`proxyscrape`
- 4. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.845960 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.588818 | source=`monosans_kr_json`
- 6. `socks5://150.230.249.56:1080` | `socks5` | `transparent` | 200 1.585931 | source=`proxifly`
