# KR 免费代理自动刷新报告（2026-04-25T18:53:52+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `unknown` | 200 1.231745 | source=`iplocate`
- 2. `socks5://152.70.237.238:3128` | `socks5` | `unknown` | 200 1.598031 | source=`monosans_kr_json`
- 3. `http://43.133.90.161:8888` | `http` | `unknown` | 200 3.146256 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 5.206462 | source=`monosans_kr_json`
