# KR 免费代理自动刷新报告（2026-05-19T19:22:45+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.540980 | source=`geonode`
- 2. `socks5://152.70.91.193:40000` | `socks5` | `elite` | 200 1.822706 | source=`proxyscrape`
- 3. `socks5://206.123.156.238:7547` | `socks5` | `unknown` | 200 11.632286 | source=`iplocate`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.031583 | source=`niek`
- 5. `http://106.10.55.212:1121` | `http` | `unknown` | 200 4.444222 | source=`niek`
