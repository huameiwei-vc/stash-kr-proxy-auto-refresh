# KR 免费代理自动刷新报告（2026-04-11T09:39:30+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 3.380806 | source=`monosans_kr_json`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.832473 | source=`proxifly`
- 3. `socks5://206.123.156.223:4627` | `socks5` | `transparent` | 200 3.557708 | source=`proxifly`
- 4. `socks5://206.123.156.229:10694` | `socks5` | `transparent` | 200 4.342734 | source=`proxifly`
- 5. `socks5://206.123.156.224:4200` | `socks5` | `transparent` | 200 10.034725 | source=`proxifly`
- 6. `socks5://206.123.156.181:5649` | `socks5` | `transparent` | 200 10.203852 | source=`proxifly`
