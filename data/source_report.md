# KR 免费代理自动刷新报告（2026-06-28T20:21:33+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.706352 | source=`monosans_kr_json`
- 2. `socks5://203.227.191.225:1080` | `socks5` | `transparent` | 200 0.941390 | source=`proxifly`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.591621 | source=`proxifly`
- 4. `http://121.146.163.32:3028` | `http` | `transparent` | 200 6.349072 | source=`proxyscrape`
- 5. `socks4://152.70.237.238:3128` | `socks4` | `transparent` | 200 4.197464 | source=`proxifly`
