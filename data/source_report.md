# KR 免费代理自动刷新报告（2026-07-28T15:19:49+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.921660 | source=`geonode`
- 2. `socks5://138.2.119.222:80` | `socks5` | `elite` | 200 1.025176 | source=`proxyscrape`
- 3. `socks5://150.230.249.50:1080` | `socks5` | `elite` | 200 2.871939 | source=`geonode`
- 4. `socks5://146.56.191.98:14785` | `socks5` | `elite` | 200 10.553154 | source=`geonode`
- 5. `socks5://43.155.185.73:1080` | `socks5` | `unknown` | 200 0.797204 | source=`monosans_kr_json`
- 6. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 4.128979 | source=`monosans_kr_json`
- 7. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.642627 | source=`niek`
- 8. `http://150.230.249.50:1080` | `http` | `unknown` | 200 0.686997 | source=`niek`
- 9. `socks5://43.155.232.123:1080` | `socks5` | `transparent` | 200 0.804349 | source=`proxifly`
- 10. `socks5://8.213.149.224:1080` | `socks5` | `transparent` | 200 0.805846 | source=`proxifly`
- 11. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 1.085729 | source=`proxifly`
- 12. `http://140.245.66.105:8081` | `http` | `transparent` | 200 3.438157 | source=`proxifly`
- 13. `http://193.122.96.242:3128` | `http` | `transparent` | 200 3.888588 | source=`proxifly`
