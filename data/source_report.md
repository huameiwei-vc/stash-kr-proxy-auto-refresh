# KR 免费代理自动刷新报告（2026-08-09T08:57:54+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.920269 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.809762 | source=`niek`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 3.345479 | source=`proxifly`
- 4. `http://47.80.26.236:8080` | `http` | `transparent` | 200 2.401430 | source=`proxifly`
