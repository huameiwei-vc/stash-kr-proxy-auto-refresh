# KR 免费代理自动刷新报告（2026-05-03T12:43:31+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.694645 | source=`geonode`
- 2. `http://121.135.144.141:8072` | `http` | `elite` | 200 3.484396 | source=`proxyscrape`
- 3. `socks5://193.123.250.39:1080` | `socks5` | `unknown` | 200 5.101476 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.760531 | source=`monosans_kr_json`
- 5. `socks5://52.78.177.181:1080` | `socks5` | `transparent` | 200 2.749318 | source=`proxifly`
