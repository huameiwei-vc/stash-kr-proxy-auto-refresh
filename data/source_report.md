# KR 免费代理自动刷新报告（2026-07-26T15:19:45+00:00）
...
- 1. `socks5://52.78.144.96:1080` | `socks5` | `elite` | 200 0.987048 | source=`proxyscrape`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 4.159312 | source=`monosans_kr_json`
- 3. `socks5://8.213.149.224:1080` | `socks5` | `unknown` | 200 4.434079 | source=`iplocate`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.728294 | source=`monosans_kr_json`
- 5. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.671555 | source=`proxifly`
- 6. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 1.310359 | source=`proxifly`
