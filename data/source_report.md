# KR 免费代理自动刷新报告（2026-07-07T01:12:00+00:00）
...
- 1. `socks5://43.128.150.150:1080` | `socks5` | `elite` | 200 0.831064 | source=`geonode`
- 2. `http://220.95.64.74:1521` | `http` | `unknown` | 200 0.935694 | source=`niek`
- 3. `http://121.180.75.228:1723` | `http` | `unknown` | 200 1.144664 | source=`niek`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 5.083009 | source=`niek`
- 5. `socks5://152.70.241.59:1080` | `socks5` | `transparent` | 200 3.820421 | source=`proxifly`
