# KR 免费代理自动刷新报告（2026-03-28T23:50:48+00:00）
...
- 1. `http://121.126.185.63:25152` | `http` | `elite` | 200 1.250274 | source=`proxyscrape`
- 2. `http://45.93.30.241:6005` | `http` | `elite` | 200 1.799490 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.194836 | source=`niek`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.231670 | source=`proxifly`
- 5. `socks5://1.225.116.115:1080` | `socks5` | `transparent` | 200 4.038699 | source=`proxifly`
- 6. `http://146.56.182.165:3128` | `http` | `transparent` | 200 0.787231 | source=`proxyscrape`
