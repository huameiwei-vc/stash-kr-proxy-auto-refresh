# KR 免费代理自动刷新报告（2026-08-16T14:35:14+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.573196 | source=`monosans_kr_json`
- 2. `http://112.216.54.226:12121` | `http` | `unknown` | 200 0.742865 | source=`monosans_kr_json`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `transparent` | 200 5.104404 | source=`proxifly`
- 4. `http://132.226.171.101:3128` | `http` | `transparent` | 200 2.365563 | source=`proxyscrape`
