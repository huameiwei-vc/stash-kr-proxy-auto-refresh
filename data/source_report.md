# KR 免费代理自动刷新报告（2026-08-12T14:40:54+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.692601 | source=`geonode`
- 2. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 5.297683 | source=`proxyscrape`
- 3. `http://211.233.44.58:8080` | `http` | `elite` | 200 6.375903 | source=`proxyscrape`
- 4. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.702319 | source=`monosans_kr_json`
- 5. `http://150.230.249.56:1080` | `http` | `unknown` | 200 2.200676 | source=`iplocate`
- 6. `socks5://150.230.249.56:1080` | `socks5` | `transparent` | 200 2.475686 | source=`proxifly`
