# KR 免费代理自动刷新报告（2026-08-12T10:30:54+00:00）
...
- 1. `http://150.230.249.56:1080` | `http` | `elite` | 200 1.890625 | source=`proxyscrape`
- 2. `http://211.233.44.58:8080` | `http` | `elite` | 200 11.711087 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 5.507850 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.572948 | source=`monosans_kr_json`
- 5. `socks5://150.230.249.56:1080` | `socks5` | `transparent` | 200 2.816563 | source=`proxifly`
