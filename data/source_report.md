# KR 免费代理自动刷新报告（2026-08-30T01:54:17+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.940254 | source=`geonode`
- 2. `socks4://130.162.141.185:52916` | `socks4` | `elite` | 200 4.907636 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.912314 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.774196 | source=`monosans_kr_json`
