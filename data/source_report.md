# KR 免费代理自动刷新报告（2026-08-14T04:26:12+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.885683 | source=`monosans_kr_json`
- 2. `socks5://61.78.63.200:30001` | `socks5` | `unknown` | 200 2.675074 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.535701 | source=`monosans_kr_json`
- 4. `http://132.226.171.101:3128` | `http` | `transparent` | 200 0.817737 | source=`proxifly`
