# KR 免费代理自动刷新报告（2026-05-08T16:59:09+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.959152 | source=`geonode`
- 2. `http://106.10.55.212:1121` | `http` | `unknown` | 200 6.977462 | source=`monosans_kr_json`
- 3. `http://43.203.140.58:6512` | `http` | `unknown` | 200 7.183543 | source=`iplocate`
- 4. `http://193.122.96.242:3128` | `http` | `transparent` | 200 0.643088 | source=`geonode`
- 5. `http://121.130.199.80:3128` | `http` | `transparent` | 200 0.853673 | source=`proxifly`
- 6. `http://1.231.81.166:3128` | `http` | `transparent` | 200 1.872971 | source=`proxyscrape`
