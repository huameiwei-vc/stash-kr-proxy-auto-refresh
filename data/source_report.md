# KR 免费代理自动刷新报告（2026-06-12T22:43:57+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.970241 | source=`geonode`
- 2. `socks5://193.123.254.182:1080` | `socks5` | `elite` | 200 1.829996 | source=`proxyscrape`
- 3. `socks5://158.179.173.238:1080` | `socks5` | `elite` | 200 4.006493 | source=`proxyscrape`
- 4. `socks5://158.180.77.24:1080` | `socks5` | `elite` | 200 6.776051 | source=`geonode`
- 5. `socks5://211.245.23.166:1080` | `socks5` | `elite` | 200 10.926569 | source=`proxyscrape`
- 6. `socks4://211.245.23.166:1080` | `socks4` | `elite` | 200 8.583257 | source=`proxyscrape`
- 7. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.019055 | source=`monosans_kr_json`
- 8. `http://169.212.15.161:5000` | `http` | `unknown` | 200 5.278801 | source=`monosans_kr_json`
- 9. `http://125.135.136.210:3176` | `http` | `transparent` | 200 0.774141 | source=`proxifly`
