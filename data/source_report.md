# KR 免费代理自动刷新报告（2026-08-10T18:08:48+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.129033 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.623002 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.507052 | source=`monosans_kr_json`
- 4. `socks5://47.80.27.150:1080` | `socks5` | `transparent` | 200 0.618618 | source=`proxifly`
- 5. `socks5://152.70.237.238:3128` | `socks5` | `transparent` | 200 5.312100 | source=`proxifly`
