# KR 免费代理自动刷新报告（2026-08-04T21:32:30+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `elite` | 200 1.141050 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.811650 | source=`geonode`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.748679 | source=`monosans_kr_json`
- 4. `http://211.233.44.58:8080` | `http` | `unknown` | 200 6.542778 | source=`monosans_kr_json`
