# KR 免费代理自动刷新报告（2026-06-30T17:54:36+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.042474 | source=`geonode`
- 2. `socks5://152.70.241.59:1080` | `socks5` | `elite` | 200 1.955768 | source=`proxyscrape`
- 3. `socks4://43.128.140.213:1080` | `socks4` | `elite` | 200 3.824777 | source=`proxyscrape`
- 4. `socks5://43.128.150.150:1080` | `socks5` | `unknown` | 200 0.756325 | source=`monosans_kr_json`
- 5. `socks5://43.128.140.213:1080` | `socks5` | `unknown` | 200 1.240465 | source=`monosans_kr_json`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.744970 | source=`monosans_kr_json`
- 7. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 1.735193 | source=`proxifly`
