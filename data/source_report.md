# KR 免费代理自动刷新报告（2026-08-19T22:15:25+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 5.297910 | source=`geonode`
- 2. `http://47.80.26.236:8080` | `http` | `elite` | 200 4.146029 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.542477 | source=`monosans_kr_json`
