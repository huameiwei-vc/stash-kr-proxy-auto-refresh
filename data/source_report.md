# KR 免费代理自动刷新报告（2026-07-04T20:40:30+00:00）
...
- 1. `socks5://43.128.150.150:1080` | `socks5` | `elite` | 200 0.898561 | source=`geonode`
- 2. `socks5://130.162.141.185:52916` | `socks5` | `elite` | 200 2.706262 | source=`geonode`
- 3. `socks5://152.70.241.59:1080` | `socks5` | `elite` | 200 6.898517 | source=`geonode`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 7.202702 | source=`geonode`
- 5. `http://220.95.121.83:1521` | `http` | `unknown` | 200 0.706128 | source=`monosans_kr_json`
- 6. `http://106.10.55.212:1121` | `http` | `unknown` | 200 0.798837 | source=`monosans_kr_json`
- 7. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.883296 | source=`monosans_kr_json`
- 8. `http://180.136.129.80:1080` | `http` | `unknown` | 200 2.149185 | source=`monosans_kr_json`
