# KR 免费代理自动刷新报告（2026-06-23T05:56:03+00:00）
...
- 1. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 3.108776 | source=`proxyscrape`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.760555 | source=`monosans_kr_json`
- 3. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.697312 | source=`proxifly`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.828105 | source=`proxifly`
- 5. `socks5://206.123.156.218:20675` | `socks5` | `transparent` | 200 6.051787 | source=`proxifly`
