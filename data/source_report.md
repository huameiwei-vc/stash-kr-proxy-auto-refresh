# KR 免费代理自动刷新报告（2026-07-21T09:14:00+00:00）
...
- 1. `socks4://43.133.242.194:888` | `socks4` | `elite` | 200 1.162105 | source=`proxyscrape`
- 2. `socks5://43.133.242.194:888` | `socks5` | `unknown` | 200 2.297166 | source=`monosans_kr_json`
- 3. `http://58.180.17.51:3128` | `http` | `unknown` | 200 0.722238 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.854244 | source=`monosans_kr_json`
- 5. `http://211.233.44.58:8080` | `http` | `unknown` | 200 0.945408 | source=`monosans_kr_json`
- 6. `socks5://158.247.223.73:1080` | `socks5` | `transparent` | 200 0.700513 | source=`proxifly`
- 7. `socks5://8.213.149.224:1080` | `socks5` | `transparent` | 200 0.703149 | source=`proxifly`
- 8. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 2.888963 | source=`proxifly`
- 9. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 4.798296 | source=`proxifly`
