# KR 免费代理自动刷新报告（2026-04-04T17:53:27+00:00）
...
- 1. `http://106.10.55.212:1121` | `http` | `unknown` | 200 0.922957 | source=`skillter_http`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.114470 | source=`monosans_kr_json`
- 3. `socks5://34.47.70.107:1080` | `socks5` | `transparent` | 200 1.132831 | source=`proxifly`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.257855 | source=`proxifly`
