# KR 免费代理自动刷新报告（2026-07-20T07:49:01+00:00）
...
- 1. `socks4://43.133.242.194:888` | `socks4` | `elite` | 200 1.217260 | source=`proxyscrape`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.811025 | source=`niek`
- 3. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.770189 | source=`proxifly`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.789494 | source=`proxifly`
- 5. `socks5://43.133.242.194:888` | `socks5` | `transparent` | 200 2.324793 | source=`proxifly`
- 6. `http://58.180.17.51:3128` | `http` | `transparent` | 200 3.911054 | source=`proxifly`
