# KR 免费代理自动刷新报告（2026-06-07T23:00:25+00:00）
...
- 1. `socks5://59.11.209.162:1080` | `socks5` | `elite` | 200 1.239532 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.972734 | source=`geonode`
- 3. `socks5://158.179.173.238:1080` | `socks5` | `elite` | 200 8.308505 | source=`proxyscrape`
- 4. `socks4://1.245.175.180:1080` | `socks4` | `elite` | 200 1.754849 | source=`proxyscrape`
- 5. `socks4://158.247.240.61:1080` | `socks4` | `elite` | 200 3.145538 | source=`proxyscrape`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.958031 | source=`niek`
- 7. `http://43.128.145.26:1080` | `http` | `unknown` | 200 1.727210 | source=`monosans_kr_json`
- 8. `http://169.212.15.161:5000` | `http` | `unknown` | 200 2.523583 | source=`monosans_kr_json`
- 9. `http://112.186.12.207:3128` | `http` | `transparent` | 200 1.650563 | source=`proxyscrape`
