# KR 免费代理自动刷新报告（2026-05-20T22:47:56+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.967560 | source=`geonode`
- 2. `socks5://152.70.91.193:40000` | `socks5` | `elite` | 200 1.816484 | source=`proxyscrape`
- 3. `http://125.129.15.95:3128` | `http` | `elite` | 200 6.365851 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.790743 | source=`monosans_kr_json`
- 5. `http://112.186.12.207:3128` | `http` | `transparent` | 200 0.788774 | source=`proxifly`
