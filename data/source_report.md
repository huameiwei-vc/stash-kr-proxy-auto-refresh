# KR 免费代理自动刷新报告（2026-05-03T15:35:13+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.292530 | source=`geonode`
- 2. `http://193.123.250.39:1080` | `http` | `elite` | 200 1.138737 | source=`proxyscrape`
- 3. `http://121.130.199.80:3128` | `http` | `elite` | 200 1.277468 | source=`proxyscrape`
- 4. `socks5://193.123.250.39:1080` | `socks5` | `unknown` | 200 1.823957 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.038588 | source=`monosans_kr_json`
- 6. `http://152.69.229.220:3128` | `http` | `transparent` | 200 5.594214 | source=`proxyscrape`
