# KR 免费代理自动刷新报告（2026-03-31T04:06:39+00:00）
...
- 1. `http://45.93.30.241:6005` | `http` | `elite` | 200 2.808408 | source=`proxyscrape`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.799865 | source=`monosans_kr_json`
- 3. `http://121.126.185.63:25152` | `http` | `unknown` | 200 2.457651 | source=`monosans_kr_json`
- 4. `socks5://94.130.16.48:30006` | `socks5` | `transparent` | 200 11.552515 | source=`proxifly`
