# KR 免费代理自动刷新报告（2026-08-29T00:56:53+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.936043 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.928278 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.748606 | source=`monosans_kr_json`
- 4. `http://43.203.140.58:27862` | `http` | `unknown` | 200 5.353483 | source=`iplocate`
- 5. `http://43.203.140.58:17755` | `http` | `unknown` | 200 5.532050 | source=`iplocate`
