# KR 免费代理自动刷新报告（2026-07-04T23:40:01+00:00）
...
- 1. `socks5://43.128.150.150:1080` | `socks5` | `elite` | 200 0.716336 | source=`geonode`
- 2. `socks5://152.70.241.59:1080` | `socks5` | `elite` | 200 2.307756 | source=`proxyscrape`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 3.157427 | source=`geonode`
- 4. `http://220.95.121.83:1521` | `http` | `unknown` | 200 0.557300 | source=`monosans_kr_json`
- 5. `http://220.95.64.74:1521` | `http` | `unknown` | 200 0.713729 | source=`monosans_kr_json`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.758870 | source=`monosans_kr_json`
- 7. `http://121.180.75.228:1723` | `http` | `transparent` | 200 0.737155 | source=`proxyscrape`
- 8. `http://168.126.169.198:808` | `http` | `transparent` | 200 8.083426 | source=`proxyscrape`
