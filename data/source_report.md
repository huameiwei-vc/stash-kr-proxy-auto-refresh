# KR 免费代理自动刷新报告（2026-07-23T14:56:59+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.930671 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.919545 | source=`monosans_kr_json`
- 3. `socks5://218.52.249.121:1080` | `socks5` | `unknown` | 200 1.947445 | source=`iplocate`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.974639 | source=`monosans_kr_json`
- 5. `http://58.180.17.51:3128` | `http` | `transparent` | 200 3.542783 | source=`proxyscrape`
- 6. `http://140.245.66.105:8081` | `http` | `transparent` | 200 9.790245 | source=`proxyscrape`
