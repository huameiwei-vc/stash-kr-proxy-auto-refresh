# KR 免费代理自动刷新报告（2026-04-17T06:16:55+00:00）
...
- 1. `socks5://158.179.173.238:1080` | `socks5` | `unknown` | 200 3.612689 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.161167 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.992981 | source=`proxifly`
- 4. `socks5://3.35.138.52:1080` | `socks5` | `transparent` | 200 1.261406 | source=`proxifly`
- 5. `socks5://206.123.156.210:43464` | `socks5` | `transparent` | 200 3.726610 | source=`proxifly`
