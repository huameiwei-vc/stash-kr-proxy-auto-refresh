# KR 免费代理自动刷新报告（2026-07-19T13:48:17+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.767088 | source=`monosans_kr_json`
- 2. `http://211.233.44.58:8080` | `http` | `unknown` | 200 7.194072 | source=`monosans_kr_json`
- 3. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.690018 | source=`proxifly`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.092581 | source=`proxifly`
- 5. `http://58.180.17.51:3128` | `http` | `transparent` | 200 3.510525 | source=`proxifly`
