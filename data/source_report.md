# KR 免费代理自动刷新报告（2026-05-07T23:31:04+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.060328 | source=`geonode`
- 2. `http://220.121.143.33:3128` | `http` | `elite` | 200 0.709714 | source=`proxyscrape`
- 3. `socks4://47.80.9.115:1080` | `socks4` | `elite` | 200 0.678142 | source=`proxyscrape`
- 4. `socks5://47.80.9.115:1080` | `socks5` | `unknown` | 200 0.840938 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.175043 | source=`monosans_kr_json`
