# KR 免费代理自动刷新报告（2026-08-01T16:34:22+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `elite` | 200 0.936322 | source=`geonode`
- 2. `socks4://168.107.13.220:50161` | `socks4` | `elite` | 200 1.079924 | source=`proxyscrape`
- 3. `socks5://43.155.185.73:1080` | `socks5` | `unknown` | 200 0.963872 | source=`monosans_kr_json`
- 4. `socks5://218.52.249.121:1080` | `socks5` | `unknown` | 200 1.112993 | source=`monosans_kr_json`
- 5. `socks5://43.155.232.123:1080` | `socks5` | `unknown` | 200 1.378485 | source=`monosans_kr_json`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.804145 | source=`monosans_kr_json`
- 7. `socks5://168.107.13.220:50161` | `socks5` | `transparent` | 200 1.243369 | source=`proxifly`
