# KR 免费代理自动刷新报告（2026-07-30T12:58:40+00:00）
...
- 1. `socks5://43.155.232.123:1080` | `socks5` | `elite` | 200 0.797327 | source=`geonode`
- 2. `socks5://168.107.13.220:50161` | `socks5` | `elite` | 200 1.096932 | source=`geonode`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.339753 | source=`geonode`
- 4. `socks4://168.107.13.220:50161` | `socks4` | `elite` | 200 0.927836 | source=`proxyscrape`
- 5. `socks5://61.82.142.10:1080` | `socks5` | `unknown` | 200 0.820833 | source=`monosans_kr_json`
- 6. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.616780 | source=`monosans_kr_json`
- 7. `socks5://43.155.185.73:1080` | `socks5` | `unknown` | 200 5.922935 | source=`monosans_kr_json`
- 8. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.648532 | source=`monosans_kr_json`
- 9. `http://43.155.179.47:8080` | `http` | `unknown` | 200 6.492504 | source=`monosans_kr_json`
- 10. `socks5://152.70.253.226:1080` | `socks5` | `transparent` | 200 0.794770 | source=`proxifly`
- 11. `socks5://8.213.149.224:1080` | `socks5` | `transparent` | 200 0.799210 | source=`proxifly`
- 12. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.819927 | source=`proxifly`
