# KR 免费代理自动刷新报告（2026-08-26T04:52:09+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 6.775809 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.622920 | source=`monosans_kr_json`
- 3. `http://130.162.144.61:1080` | `http` | `unknown` | 200 0.512561 | source=`niek`
- 4. `socks5://130.162.144.61:1080` | `socks5` | `transparent` | 200 1.001219 | source=`proxifly`
