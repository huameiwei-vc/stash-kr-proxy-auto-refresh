# KR 免费代理自动刷新报告（2026-08-07T23:52:58+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.681862 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.680933 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.552651 | source=`monosans_kr_json`
- 4. `socks4://58.120.135.195:1080` | `socks4` | `transparent` | 200 0.672865 | source=`proxifly`
