# KR 免费代理自动刷新报告（2026-08-02T23:37:09+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.941954 | source=`geonode`
- 2. `socks5://1.245.175.180:1080` | `socks5` | `elite` | 200 2.172209 | source=`geonode`
- 3. `socks5://43.155.232.123:1080` | `socks5` | `unknown` | 200 1.123760 | source=`monosans_kr_json`
- 4. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 7.959152 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.503565 | source=`monosans_kr_json`
- 6. `http://43.155.232.123:8090` | `http` | `unknown` | 200 0.517391 | source=`monosans_kr_json`
- 7. `http://121.174.186.199:8080` | `http` | `unknown` | 200 1.002082 | source=`iplocate`
