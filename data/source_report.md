# KR 免费代理自动刷新报告（2026-05-06T15:30:51+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.075349 | source=`geonode`
- 2. `socks5://193.122.105.251:65535` | `socks5` | `elite` | 200 1.887672 | source=`geonode`
- 3. `http://175.194.173.105:3128` | `http` | `elite` | 200 4.102289 | source=`geonode`
- 4. `http://140.245.66.105:8081` | `http` | `transparent` | 200 3.038802 | source=`proxyscrape`
