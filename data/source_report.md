# KR 免费代理自动刷新报告（2026-04-15T16:42:04+00:00）
...
- 1. `http://150.230.249.50:1080` | `http` | `elite` | 200 0.563889 | source=`proxyscrape`
- 2. `socks5://123.214.62.25:6881` | `socks5` | `unknown` | 200 0.878997 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.803084 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.776844 | source=`proxifly`
- 5. `socks5://158.179.173.238:1080` | `socks5` | `transparent` | 200 3.393937 | source=`proxifly`
- 6. `socks5://206.123.156.204:7542` | `socks5` | `transparent` | 200 7.650373 | source=`proxifly`
