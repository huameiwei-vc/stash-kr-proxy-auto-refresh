# KR 免费代理自动刷新报告（2026-04-01T09:56:15+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 5.058298 | source=`monosans_kr_json`
- 2. `http://20.196.129.97:3128` | `http` | `transparent` | 200 0.752077 | source=`proxyscrape`
