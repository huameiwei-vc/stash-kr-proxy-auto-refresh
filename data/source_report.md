# KR 免费代理自动刷新报告（2026-07-20T10:36:27+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 3.051577 | source=`geonode`
- 2. `http://8.220.216.57:3128` | `http` | `elite` | 200 6.244552 | source=`proxyscrape`
- 3. `socks4://43.133.242.194:888` | `socks4` | `elite` | 200 1.306681 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.705104 | source=`niek`
- 5. `http://211.233.44.58:8080` | `http` | `unknown` | 200 1.159421 | source=`niek`
- 6. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.972223 | source=`proxifly`
- 7. `socks5://43.133.242.194:888` | `socks5` | `transparent` | 200 2.926206 | source=`proxifly`
- 8. `http://58.180.17.51:3128` | `http` | `transparent` | 200 4.502327 | source=`proxifly`
