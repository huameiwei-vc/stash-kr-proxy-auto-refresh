# KR 免费代理自动刷新报告（2026-08-12T13:40:19+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.870707 | source=`geonode`
- 2. `socks5://61.78.63.200:30001` | `socks5` | `elite` | 200 1.568780 | source=`proxyscrape`
- 3. `http://150.230.249.56:1080` | `http` | `elite` | 200 1.979278 | source=`proxyscrape`
- 4. `http://211.233.44.58:8080` | `http` | `elite` | 200 7.899173 | source=`proxyscrape`
- 5. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.843212 | source=`monosans_kr_json`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.699924 | source=`monosans_kr_json`
- 7. `socks5://150.230.249.56:1080` | `socks5` | `transparent` | 200 2.268979 | source=`proxifly`
