# KR 免费代理自动刷新报告（2026-03-31T23:22:17+00:00）
...
- 1. `socks5://94.130.16.48:30006` | `socks5` | `unknown` | 200 8.713821 | source=`iplocate`
- 2. `http://59.11.138.229:3128` | `http` | `unknown` | 200 0.559202 | source=`niek`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.753608 | source=`monosans_kr_json`
- 4. `http://121.126.185.63:25152` | `http` | `unknown` | 200 0.927116 | source=`monosans_kr_json`
- 5. `http://146.56.182.165:3128` | `http` | `unknown` | 200 6.592506 | source=`monosans_kr_json`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.729100 | source=`proxifly`
