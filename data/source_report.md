# KR 免费代理自动刷新报告（2026-06-21T14:37:04+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.633061 | source=`geonode`
- 2. `socks5://152.70.237.238:3128` | `socks5` | `unknown` | 200 3.691128 | source=`iplocate`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.705497 | source=`monosans_kr_json`
- 4. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.644705 | source=`proxifly`
- 5. `socks5://206.123.156.212:18810` | `socks5` | `transparent` | 200 5.188506 | source=`proxifly`
