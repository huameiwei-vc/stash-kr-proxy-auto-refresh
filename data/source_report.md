# KR 免费代理自动刷新报告（2026-06-14T21:38:13+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.971799 | source=`geonode`
- 2. `socks5://193.123.254.182:1080` | `socks5` | `unknown` | 200 1.578105 | source=`iplocate`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.900588 | source=`monosans_kr_json`
