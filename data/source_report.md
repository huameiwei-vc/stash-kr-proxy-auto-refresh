# KR 免费代理自动刷新报告（2026-07-30T21:54:41+00:00）
...
- 1. `socks5://43.155.232.123:1080` | `socks5` | `elite` | 200 0.654964 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 4.273335 | source=`geonode`
- 3. `socks4://168.107.13.220:50161` | `socks4` | `elite` | 200 0.752847 | source=`proxyscrape`
- 4. `socks5://43.155.185.73:1080` | `socks5` | `unknown` | 200 0.658383 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.537981 | source=`monosans_kr_json`
- 6. `socks5://168.107.13.220:50161` | `socks5` | `transparent` | 200 0.821627 | source=`proxifly`
- 7. `socks5://152.70.253.226:1080` | `socks5` | `transparent` | 200 1.078502 | source=`proxifly`
