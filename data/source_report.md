# KR 免费代理自动刷新报告（2026-06-23T14:13:28+00:00）
...
- 1. `socks5://158.179.171.148:1080` | `socks5` | `elite` | 200 1.782507 | source=`proxyscrape`
- 2. `http://175.194.173.105:3128` | `http` | `elite` | 200 1.313155 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 4.080992 | source=`niek`
- 4. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.963901 | source=`proxifly`
- 5. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 7.312584 | source=`proxifly`
