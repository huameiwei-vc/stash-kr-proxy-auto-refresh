# KR 免费代理自动刷新报告（2026-04-14T23:56:25+00:00）
...
- 1. `socks5://123.214.62.25:6881` | `socks5` | `unknown` | 200 1.110889 | source=`monosans_kr_json`
- 2. `socks5://1.225.116.115:1080` | `socks5` | `unknown` | 200 1.531208 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.026916 | source=`monosans_kr_json`
- 4. `http://1.225.116.115:1080` | `http` | `unknown` | 200 1.226921 | source=`monosans_kr_json`
- 5. `http://146.56.110.131:8118` | `http` | `unknown` | 200 4.448403 | source=`niek`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.667493 | source=`proxifly`
