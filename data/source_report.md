# KR 免费代理自动刷新报告（2026-08-08T03:55:17+00:00）
...
- 1. `socks5://141.164.58.134:1080` | `socks5` | `elite` | 200 0.678827 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.707777 | source=`geonode`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.662383 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.538987 | source=`monosans_kr_json`
