# KR 免费代理自动刷新报告（2026-08-02T20:39:45+00:00）
...
- 1. `socks5://1.245.175.180:1080` | `socks5` | `elite` | 200 2.918275 | source=`proxyscrape`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `elite` | 200 4.025702 | source=`geonode`
- 3. `socks5://43.155.232.123:1080` | `socks5` | `unknown` | 200 1.396611 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.764327 | source=`monosans_kr_json`
- 5. `http://43.155.232.123:8090` | `http` | `unknown` | 200 2.082877 | source=`monosans_kr_json`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.368564 | source=`proxifly`
