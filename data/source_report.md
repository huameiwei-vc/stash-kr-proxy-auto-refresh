# KR 免费代理自动刷新报告（2026-04-11T22:57:07+00:00）
...
- 1. `socks5://1.225.116.115:1080` | `socks5` | `unknown` | 200 1.481726 | source=`iplocate`
- 2. `http://1.225.116.115:1080` | `http` | `unknown` | 200 0.965381 | source=`skillter_http`
- 3. `http://121.135.144.141:8008` | `http` | `unknown` | 200 2.238404 | source=`skillter_http`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 5.997639 | source=`niek`
- 5. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.963601 | source=`proxifly`
