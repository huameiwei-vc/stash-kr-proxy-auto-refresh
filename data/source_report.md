# KR 免费代理自动刷新报告（2026-04-28T11:24:30+00:00）
...
- 1. `socks5://43.133.90.161:8088` | `socks5` | `unknown` | 200 3.191831 | source=`monosans_kr_json`
- 2. `http://43.133.90.161:8888` | `http` | `unknown` | 200 5.881384 | source=`niek`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.131039 | source=`proxifly`
- 4. `http://221.156.27.160:3068` | `http` | `transparent` | 200 0.934905 | source=`proxyscrape`
