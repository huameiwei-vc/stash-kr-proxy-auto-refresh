# KR 免费代理自动刷新报告（2026-08-03T21:54:57+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.956879 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `elite` | 200 3.480911 | source=`geonode`
- 3. `http://211.233.44.58:8080` | `http` | `elite` | 200 1.348663 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.527782 | source=`monosans_kr_json`
- 5. `http://183.101.185.89:20002` | `http` | `unknown` | 200 2.379701 | source=`monosans_kr_json`
