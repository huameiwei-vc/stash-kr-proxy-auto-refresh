# KR 免费代理自动刷新报告（2026-08-18T14:02:18+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 3.868172 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.744204 | source=`monosans_kr_json`
- 3. `http://43.201.69.43:3128` | `http` | `transparent` | 200 0.761153 | source=`proxifly`
- 4. `http://132.226.171.101:3128` | `http` | `transparent` | 200 11.718315 | source=`proxifly`
