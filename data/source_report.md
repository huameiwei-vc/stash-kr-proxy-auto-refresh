# KR 免费代理自动刷新报告（2026-04-04T09:29:48+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.180420 | source=`niek`
- 2. `http://122.45.51.68:8889` | `http` | `unknown` | 200 2.367964 | source=`skillter_http`
- 3. `http://122.45.51.68:54321` | `http` | `unknown` | 200 2.813729 | source=`skillter_http`
- 4. `http://122.45.51.68:8887` | `http` | `unknown` | 200 2.890704 | source=`skillter_http`
- 5. `http://122.45.51.68:9991` | `http` | `unknown` | 200 3.189376 | source=`skillter_http`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.570179 | source=`proxifly`
