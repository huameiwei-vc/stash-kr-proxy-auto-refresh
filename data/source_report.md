# KR 免费代理自动刷新报告（2026-04-04T15:19:09+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.026352 | source=`niek`
- 2. `http://59.11.138.229:3128` | `http` | `unknown` | 200 2.060324 | source=`niek`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.934903 | source=`proxifly`
