# KR 免费代理自动刷新报告（2026-09-13T22:36:44+00:00）
...
- 1. `http://13.125.183.28:3128` | `http` | `unknown` | 200 0.758049 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.762727 | source=`monosans_kr_json`
