# KR 免费代理自动刷新报告（2026-06-04T00:09:12+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.929903 | source=`geonode`
- 2. `socks5://59.11.209.162:1080` | `socks5` | `elite` | 200 1.284023 | source=`proxyscrape`
- 3. `socks5://203.232.107.6:2080` | `socks5` | `elite` | 200 4.524413 | source=`proxyscrape`
- 4. `socks5://150.230.249.50:1080` | `socks5` | `elite` | 200 5.656759 | source=`geonode`
- 5. `socks4://203.232.107.6:2080` | `socks4` | `elite` | 200 2.382095 | source=`proxyscrape`
- 6. `http://150.230.249.50:1080` | `http` | `unknown` | 200 0.725977 | source=`niek`
- 7. `http://43.155.214.75:8080` | `http` | `unknown` | 200 2.863115 | source=`monosans_kr_json`
- 8. `http://1.231.81.166:3128` | `http` | `unknown` | 200 3.125999 | source=`monosans_kr_json`
- 9. `http://43.128.145.26:1080` | `http` | `unknown` | 200 3.867898 | source=`monosans_kr_json`
- 10. `http://203.232.107.6:2080` | `http` | `unknown` | 200 4.735971 | source=`monosans_kr_json`
- 11. `http://175.198.235.18:3128` | `http` | `unknown` | 200 6.058324 | source=`niek`
