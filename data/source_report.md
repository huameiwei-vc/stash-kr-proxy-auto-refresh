# KR 免费代理自动刷新报告（2026-08-22T10:39:03+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.020332 | source=`geonode`
- 2. `socks5://61.111.131.202:1088` | `socks5` | `elite` | 200 8.906172 | source=`proxyscrape`
- 3. `socks4://61.111.131.202:1088` | `socks4` | `elite` | 200 7.225911 | source=`proxyscrape`
- 4. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.796355 | source=`monosans_kr_json`
- 5. `socks5://150.109.247.86:8443` | `socks5` | `unknown` | 200 1.216602 | source=`monosans_kr_json`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.661157 | source=`niek`
- 7. `http://112.216.54.226:12121` | `http` | `unknown` | 200 0.847677 | source=`niek`
