# KR 免费代理自动刷新报告（2026-06-09T01:53:37+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.364786 | source=`geonode`
- 2. `socks5://1.245.175.180:1080` | `socks5` | `elite` | 200 2.158895 | source=`proxyscrape`
- 3. `http://175.194.173.105:3128` | `http` | `elite` | 200 0.684493 | source=`proxyscrape`
- 4. `socks5://206.123.156.225:6207` | `socks5` | `unknown` | 200 7.804830 | source=`iplocate`
- 5. `http://43.128.145.26:1080` | `http` | `unknown` | 200 0.679875 | source=`monosans_kr_json`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.908791 | source=`monosans_kr_json`
- 7. `http://169.212.15.161:5000` | `http` | `unknown` | 200 1.532649 | source=`monosans_kr_json`
