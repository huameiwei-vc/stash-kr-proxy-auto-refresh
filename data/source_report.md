# KR 免费代理自动刷新报告（2026-04-21T16:49:08+00:00）
...
- 1. `socks5://193.122.105.251:65535` | `socks5` | `elite` | 200 1.096757 | source=`geonode`
- 2. `socks5://152.70.91.193:40000` | `socks5` | `unknown` | 200 1.705160 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.761372 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.586891 | source=`proxifly`
- 5. `http://152.69.229.220:3128` | `http` | `transparent` | 200 6.136806 | source=`proxyscrape`
