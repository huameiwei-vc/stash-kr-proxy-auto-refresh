# KR 免费代理自动刷新报告（2026-07-04T22:36:12+00:00）
...
- 1. `socks5://43.128.150.150:1080` | `socks5` | `elite` | 200 0.695298 | source=`geonode`
- 2. `socks5://152.70.241.59:1080` | `socks5` | `elite` | 200 2.002592 | source=`geonode`
- 3. `http://220.95.121.83:1521` | `http` | `unknown` | 200 0.548184 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.685242 | source=`monosans_kr_json`
- 5. `http://220.95.64.74:1521` | `http` | `unknown` | 200 0.709142 | source=`monosans_kr_json`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.126398 | source=`proxifly`
- 7. `http://121.180.75.228:1723` | `http` | `transparent` | 200 0.756573 | source=`proxyscrape`
