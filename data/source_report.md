# KR 免费代理自动刷新报告（2026-07-14T07:41:10+00:00）
...
- 1. `socks5://218.52.249.121:1080` | `socks5` | `elite` | 200 0.939833 | source=`geonode`
- 2. `socks5://112.151.153.131:7603` | `socks5` | `elite` | 200 2.363505 | source=`proxyscrape`
- 3. `http://211.233.44.58:8080` | `http` | `elite` | 200 6.295254 | source=`proxyscrape`
- 4. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 4.391568 | source=`proxyscrape`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.070180 | source=`monosans_kr_json`
- 6. `http://58.180.17.51:3128` | `http` | `unknown` | 200 2.708195 | source=`monosans_kr_json`
- 7. `http://106.10.55.212:1121` | `http` | `transparent` | 200 0.734892 | source=`proxyscrape`
