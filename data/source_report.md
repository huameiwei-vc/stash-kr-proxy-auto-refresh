# KR 免费代理自动刷新报告（2026-06-26T15:57:40+00:00）
...
- iplocate: 0
- iplocate_error: 0
- monosans_fallback: 24
- monosans_kr_json: 0
- niek: 9
- proxifly: 15
- proxyscrape: 16
- skillter_fallback: 168
- 去重后总候选: 38

## 当前验证通过的代理

- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.861237 | source=`niek`
- 2. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.795160 | source=`proxifly`
- 3. `socks5://152.70.241.59:1080` | `socks5` | `transparent` | 200 3.402022 | source=`proxifly`
