# KR 免费代理自动刷新报告（2026-06-30T01:34:48+00:00）
...
- 1. `socks5://203.227.191.225:1080` | `socks5` | `elite` | 200 0.942514 | source=`proxyscrape`
- 2. `socks5://152.70.241.59:1080` | `socks5` | `elite` | 200 1.024430 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.947281 | source=`monosans_kr_json`
- 4. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.694797 | source=`proxifly`
- 5. `socks5://43.128.150.150:1080` | `socks5` | `transparent` | 200 0.699417 | source=`proxifly`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.321288 | source=`proxifly`
