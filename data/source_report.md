# KR 免费代理自动刷新报告（2026-08-18T03:05:23+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.841473 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.798472 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.642645 | source=`monosans_kr_json`
- 4. `http://124.61.132.233:4444` | `http` | `unknown` | 200 0.857284 | source=`monosans_kr_json`
- 5. `socks5://111.48.191.24:7890` | `socks5` | `transparent` | 200 4.477603 | source=`proxifly`
