# KR 免费代理自动刷新报告（2026-05-01T12:10:21+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.154479 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.220969 | source=`monosans_kr_json`
- 3. `http://175.215.147.9:3100` | `http` | `transparent` | 200 6.224348 | source=`proxyscrape`
