# KR 免费代理自动刷新报告（2026-07-24T06:12:52+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.950953 | source=`geonode`
- 2. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 7.005634 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.021796 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.796070 | source=`monosans_kr_json`
- 5. `http://58.180.17.51:3128` | `http` | `unknown` | 200 1.787178 | source=`monosans_kr_json`
- 6. `socks5://8.213.149.224:1080` | `socks5` | `transparent` | 200 0.690022 | source=`proxifly`
- 7. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.711469 | source=`proxifly`
- 8. `http://221.167.81.223:3108` | `http` | `transparent` | 200 11.936598 | source=`proxyscrape`
