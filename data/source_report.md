# KR 免费代理自动刷新报告（2026-08-16T07:41:50+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.479555 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.542388 | source=`niek`
- 3. `http://183.101.185.89:20002` | `http` | `unknown` | 200 0.851448 | source=`monosans_kr_json`
