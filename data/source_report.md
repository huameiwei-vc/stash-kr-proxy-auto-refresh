# KR 免费代理自动刷新报告（2026-08-13T14:40:57+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.789846 | source=`geonode`
- 2. `socks5://52.78.144.96:1080` | `socks5` | `elite` | 200 1.190402 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.782851 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.672291 | source=`monosans_kr_json`
- 5. `http://43.155.203.19:3128` | `http` | `transparent` | 200 7.142593 | source=`proxyscrape`
