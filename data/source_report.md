# KR 免费代理自动刷新报告（2026-08-06T07:10:19+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.824035 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.211298 | source=`monosans_kr_json`
- 3. `socks5://218.52.249.121:1080` | `socks5` | `unknown` | 200 1.792548 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.658652 | source=`monosans_kr_json`
- 5. `http://152.67.217.8:1080` | `http` | `unknown` | 200 4.788688 | source=`niek`
