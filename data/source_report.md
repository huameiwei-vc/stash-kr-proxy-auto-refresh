# KR 免费代理自动刷新报告（2026-05-14T20:10:24+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.278782 | source=`geonode`
- 2. `socks5://158.247.206.191:1080` | `socks5` | `elite` | 200 1.508951 | source=`geonode`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.195621 | source=`monosans_kr_json`
