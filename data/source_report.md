# KR 免费代理自动刷新报告（2026-09-09T05:12:40+00:00）
...
- 1. `socks5://43.155.204.231:1080` | `socks5` | `unknown` | 200 0.654945 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.537831 | source=`monosans_kr_json`
- 3. `http://112.216.54.226:12121` | `http` | `unknown` | 200 0.700815 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.055738 | source=`proxifly`
