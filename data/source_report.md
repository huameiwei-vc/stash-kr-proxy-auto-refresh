# KR 免费代理自动刷新报告（2026-09-12T12:50:49+00:00）
...
- 1. `socks5://202.141.161.50:10808` | `socks5` | `unknown` | 200 3.599216 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.762452 | source=`monosans_kr_json`
- 3. `http://202.141.161.50:10808` | `http` | `unknown` | 200 4.055515 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.984366 | source=`proxifly`
