# KR 免费代理自动刷新报告（2026-08-24T15:51:30+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.954274 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.621814 | source=`monosans_kr_json`
- 3. `http://220.81.123.23:48678` | `http` | `transparent` | 200 2.302673 | source=`proxyscrape`
