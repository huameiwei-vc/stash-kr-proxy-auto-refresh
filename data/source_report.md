# KR 免费代理自动刷新报告（2026-08-02T12:49:32+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.311646 | source=`geonode`
- 2. `http://43.155.232.123:8090` | `http` | `elite` | 200 0.641433 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.799808 | source=`monosans_kr_json`
- 4. `socks5://43.155.185.73:1080` | `socks5` | `unknown` | 200 0.999384 | source=`monosans_kr_json`
- 5. `socks5://43.155.232.123:1080` | `socks5` | `unknown` | 200 1.546148 | source=`monosans_kr_json`
- 6. `socks5://218.52.249.121:1080` | `socks5` | `unknown` | 200 5.814553 | source=`monosans_kr_json`
- 7. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.642456 | source=`monosans_kr_json`
