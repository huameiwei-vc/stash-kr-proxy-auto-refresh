# KR 免费代理自动刷新报告（2026-07-15T22:37:16+00:00）
...
- 1. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 7.812905 | source=`proxyscrape`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.662450 | source=`monosans_kr_json`
- 3. `http://58.180.17.51:3128` | `http` | `unknown` | 200 0.739849 | source=`monosans_kr_json`
- 4. `http://211.233.44.58:8080` | `http` | `unknown` | 200 0.857970 | source=`monosans_kr_json`
- 5. `http://168.126.169.198:808` | `http` | `unknown` | 200 6.431758 | source=`monosans_kr_json`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.194971 | source=`proxifly`
- 7. `http://146.56.182.165:3128` | `http` | `transparent` | 200 0.493723 | source=`proxyscrape`
