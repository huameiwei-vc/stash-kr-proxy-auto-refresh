# KR 免费代理自动刷新报告（2026-04-02T20:06:24+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.144471 | source=`monosans_kr_json`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.261081 | source=`proxifly`
- 3. `http://175.215.73.18:3116` | `http` | `transparent` | 200 4.446032 | source=`proxyscrape`
