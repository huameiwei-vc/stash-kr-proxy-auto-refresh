# KR 免费代理自动刷新报告（2026-07-03T15:22:37+00:00）
...
- 1. `socks5://43.128.150.150:1080` | `socks5` | `elite` | 200 1.008124 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.018223 | source=`geonode`
- 3. `socks5://152.70.241.59:1080` | `socks5` | `unknown` | 200 3.980241 | source=`iplocate`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.004667 | source=`niek`
- 5. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.979225 | source=`proxifly`
- 6. `socks5://152.70.237.238:3128` | `socks5` | `transparent` | 200 6.710938 | source=`proxifly`
