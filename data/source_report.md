# KR 免费代理自动刷新报告（2026-07-14T05:49:56+00:00）
...
- 1. `socks5://218.52.249.121:1080` | `socks5` | `elite` | 200 0.669999 | source=`geonode`
- 2. `http://146.56.133.63:1080` | `http` | `elite` | 200 0.534981 | source=`proxyscrape`
- 3. `socks4://175.209.7.181:1082` | `socks4` | `elite` | 200 0.648947 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.787074 | source=`niek`
- 5. `http://58.180.17.51:3128` | `http` | `transparent` | 200 4.565375 | source=`proxyscrape`
