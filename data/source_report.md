# KR 免费代理自动刷新报告（2026-08-08T20:56:56+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.061037 | source=`geonode`
- 2. `http://43.164.129.36:3128` | `http` | `elite` | 200 0.956999 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.959841 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.763894 | source=`monosans_kr_json`
