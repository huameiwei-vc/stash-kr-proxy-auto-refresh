# KR 免费代理自动刷新报告（2026-05-08T21:37:39+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.021459 | source=`geonode`
- 2. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 7.527031 | source=`proxyscrape`
- 3. `socks5://152.70.91.193:40000` | `socks5` | `unknown` | 200 1.479614 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `transparent` | 200 1.994396 | source=`proxyscrape`
- 5. `http://106.10.55.212:1121` | `http` | `transparent` | 200 2.279771 | source=`proxyscrape`
