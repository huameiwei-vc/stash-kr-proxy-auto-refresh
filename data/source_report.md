# KR 免费代理自动刷新报告（2026-05-07T20:36:11+00:00）
...
- 1. `socks5://152.70.91.193:40000` | `socks5` | `elite` | 200 1.348709 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.424581 | source=`geonode`
- 3. `socks5://158.247.206.191:1080` | `socks5` | `elite` | 200 2.165154 | source=`geonode`
- 4. `socks4://47.80.9.115:1080` | `socks4` | `elite` | 200 0.633378 | source=`proxyscrape`
- 5. `socks5://47.80.9.115:1080` | `socks5` | `unknown` | 200 0.803007 | source=`monosans_kr_json`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.833037 | source=`niek`
- 7. `http://210.223.44.230:3128` | `http` | `unknown` | 200 1.738001 | source=`niek`
