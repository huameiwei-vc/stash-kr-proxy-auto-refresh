# KR 免费代理自动刷新报告（2026-08-26T18:53:29+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.800093 | source=`geonode`
- 2. `http://211.188.65.185:80` | `http` | `elite` | 200 2.675687 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.789925 | source=`monosans_kr_json`
- 4. `socks5://152.67.221.233:8008` | `socks5` | `unknown` | 200 10.691204 | source=`iplocate`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.642321 | source=`monosans_kr_json`
- 6. `socks5://43.155.159.164:1080` | `socks5` | `transparent` | 200 0.796127 | source=`proxifly`
