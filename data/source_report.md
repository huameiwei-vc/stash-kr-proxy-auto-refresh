# KR 免费代理自动刷新报告（2026-07-17T12:55:02+00:00）
...
- 1. `socks5://218.52.249.121:1080` | `socks5` | `elite` | 200 0.729881 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.175770 | source=`geonode`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.738181 | source=`monosans_kr_json`
- 4. `http://222.119.192.67:3080` | `http` | `transparent` | 200 4.365329 | source=`proxyscrape`
- 5. `http://222.119.192.8:3080` | `http` | `transparent` | 200 4.452329 | source=`proxyscrape`
- 6. `http://58.180.17.51:3128` | `http` | `transparent` | 200 4.957200 | source=`proxyscrape`
