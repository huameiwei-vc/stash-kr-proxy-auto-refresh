# KR 免费代理自动刷新报告（2026-08-04T14:55:20+00:00）
...
- 1. `socks5://152.67.217.8:1080` | `socks5` | `elite` | 200 1.310148 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.830340 | source=`geonode`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.580300 | source=`monosans_kr_json`
- 4. `socks5://218.52.249.121:1080` | `socks5` | `unknown` | 200 5.975992 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.768352 | source=`monosans_kr_json`
