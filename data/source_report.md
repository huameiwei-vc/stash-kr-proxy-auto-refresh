# KR 免费代理自动刷新报告（2026-08-25T02:06:10+00:00）
...
- 1. `socks5://49.143.59.205:110` | `socks5` | `elite` | 200 0.860494 | source=`proxyscrape`
- 2. `http://112.216.54.226:12121` | `http` | `elite` | 200 0.858360 | source=`geonode`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.993932 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.667720 | source=`monosans_kr_json`
