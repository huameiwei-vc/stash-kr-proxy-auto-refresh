# KR 免费代理自动刷新报告（2026-06-25T05:59:39+00:00）
...
- proxifly: 14
- proxyscrape: 23
- skillter_fallback: 145
- 去重后总候选: 51

## 当前验证通过的代理

- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.913570 | source=`niek`
- 2. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.873087 | source=`proxifly`
