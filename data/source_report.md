# KR 免费代理自动刷新报告（2026-03-29T10:51:49+00:00）
...
- 1. `socks5://94.130.16.48:30006` | `socks5` | `unknown` | 200 8.849515 | source=`iplocate`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.990976 | source=`monosans_kr_json`
- 3. `http://121.126.185.63:25152` | `http` | `unknown` | 200 2.230871 | source=`iplocate`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.941174 | source=`proxifly`
