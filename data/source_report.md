# KR 免费代理自动刷新报告（2026-08-07T18:10:30+00:00）
...
- 1. `http://61.111.252.85:3128` | `http` | `elite` | 200 1.006080 | source=`proxyscrape`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.952347 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.768794 | source=`monosans_kr_json`
- 4. `http://183.101.185.89:20002` | `http` | `unknown` | 200 8.515119 | source=`monosans_kr_json`
