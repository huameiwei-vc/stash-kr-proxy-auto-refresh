# KR 免费代理自动刷新报告（2026-05-01T17:38:14+00:00）
...
- 1. `socks5://193.122.105.251:65535` | `socks5` | `elite` | 200 0.959895 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.846866 | source=`geonode`
- 3. `socks5://206.123.156.211:4289` | `socks5` | `unknown` | 200 8.855341 | source=`iplocate`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.064206 | source=`monosans_kr_json`
- 5. `http://43.155.138.148:3128` | `http` | `unknown` | 200 5.649588 | source=`monosans_kr_json`
