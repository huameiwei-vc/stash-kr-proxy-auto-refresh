# KR 免费代理自动刷新报告（2026-06-19T07:22:56+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.174749 | source=`geonode`
- 2. `socks5://146.56.191.98:19422` | `socks5` | `elite` | 200 4.893105 | source=`proxyscrape`
- 3. `http://43.155.132.199:3128` | `http` | `elite` | 200 1.846115 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.743059 | source=`niek`
- 5. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.686787 | source=`proxifly`
- 6. `http://106.10.55.212:1121` | `http` | `transparent` | 200 0.742235 | source=`proxyscrape`
