# KR 免费代理自动刷新报告（2026-06-24T23:46:10+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.884402 | source=`monosans_kr_json`
- 2. `socks5://113.89.43.22:10802` | `socks5` | `transparent` | 200 4.233804 | source=`proxifly`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 5.460751 | source=`proxifly`
- 4. `http://121.177.104.201:3100` | `http` | `transparent` | 200 3.589384 | source=`proxyscrape`
