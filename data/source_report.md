# KR 免费代理自动刷新报告（2026-08-23T02:08:37+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.641757 | source=`geonode`
- 2. `http://47.80.26.236:8080` | `http` | `elite` | 200 3.172046 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.789183 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.632574 | source=`monosans_kr_json`
- 5. `socks5://203.227.191.4:10809` | `socks5` | `transparent` | 200 0.829877 | source=`proxifly`
