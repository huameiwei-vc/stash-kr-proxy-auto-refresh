# KR 免费代理自动刷新报告（2026-06-20T22:07:57+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.659482 | source=`geonode`
- 2. `socks4://1.245.175.180:1080` | `socks4` | `elite` | 200 4.183750 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.756974 | source=`monosans_kr_json`
- 4. `http://193.122.96.242:3128` | `http` | `transparent` | 200 0.554299 | source=`proxyscrape`
- 5. `http://146.56.148.222:3128` | `http` | `transparent` | 200 0.750107 | source=`proxyscrape`
- 6. `http://175.215.192.51:3104` | `http` | `transparent` | 200 6.479299 | source=`proxyscrape`
