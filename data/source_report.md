# KR 免费代理自动刷新报告（2026-08-21T14:49:49+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.939633 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.924742 | source=`monosans_kr_json`
- 3. `socks5://182.231.145.236:1080` | `socks5` | `unknown` | 200 1.390223 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.771229 | source=`monosans_kr_json`
- 5. `http://182.231.145.236:1080` | `http` | `unknown` | 200 0.935975 | source=`monosans_kr_json`
