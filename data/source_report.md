# KR 免费代理自动刷新报告（2026-04-27T21:42:44+00:00）
...
- 1. `socks5://43.133.90.161:8088` | `socks5` | `unknown` | 200 8.920573 | source=`iplocate`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.875644 | source=`niek`
- 3. `http://43.133.90.161:8888` | `http` | `unknown` | 200 7.525748 | source=`niek`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.315492 | source=`proxifly`
