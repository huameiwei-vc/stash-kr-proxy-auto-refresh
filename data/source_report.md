# KR 免费代理自动刷新报告（2026-05-30T09:46:57+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.255787 | source=`geonode`
- 2. `socks5://158.179.173.238:1080` | `socks5` | `elite` | 200 4.211122 | source=`proxyscrape`
- 3. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 4.435398 | source=`proxyscrape`
- 4. `socks5://158.247.206.191:1080` | `socks5` | `elite` | 200 8.685400 | source=`proxyscrape`
- 5. `socks4://158.247.240.61:1080` | `socks4` | `elite` | 200 2.367325 | source=`proxyscrape`
- 6. `socks4://146.56.191.98:14785` | `socks4` | `elite` | 200 8.156664 | source=`proxyscrape`
- 7. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.005703 | source=`niek`
- 8. `http://43.128.145.26:1080` | `http` | `unknown` | 200 2.895386 | source=`monosans_kr_json`
