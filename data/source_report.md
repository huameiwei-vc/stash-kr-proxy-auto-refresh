# KR 免费代理自动刷新报告（2026-08-23T13:00:04+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.671888 | source=`geonode`
- 2. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 3.297419 | source=`proxyscrape`
- 3. `socks5://152.67.207.34:1080` | `socks5` | `unknown` | 200 0.755347 | source=`iplocate`
- 4. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.907745 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.885176 | source=`monosans_kr_json`
