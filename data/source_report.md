# KR 免费代理自动刷新报告（2026-04-14T04:34:40+00:00）
...
- 1. `socks5://123.214.62.25:6881` | `socks5` | `unknown` | 200 0.944831 | source=`monosans_kr_json`
- 2. `socks5://129.154.48.5:1080` | `socks5` | `unknown` | 200 1.057989 | source=`monosans_kr_json`
- 3. `socks5://43.133.77.87:1080` | `socks5` | `unknown` | 200 1.094428 | source=`monosans_kr_json`
- 4. `http://129.154.48.5:1080` | `http` | `unknown` | 200 0.891553 | source=`monosans_kr_json`
- 5. `http://54.180.117.151:32001` | `http` | `unknown` | 200 3.667311 | source=`iplocate`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.309372 | source=`proxifly`
