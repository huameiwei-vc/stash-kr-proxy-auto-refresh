# KR 免费代理自动刷新报告（2026-07-01T23:59:03+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 7.295140 | source=`geonode`
- 2. `socks5://43.128.150.150:1080` | `socks5` | `unknown` | 200 1.007814 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.078672 | source=`monosans_kr_json`
- 4. `socks5://152.70.241.59:1080` | `socks5` | `transparent` | 200 5.178469 | source=`proxifly`
- 5. `http://106.10.55.212:1121` | `http` | `transparent` | 200 2.999939 | source=`proxyscrape`
