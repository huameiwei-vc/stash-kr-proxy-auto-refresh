# KR 免费代理自动刷新报告（2026-04-18T17:05:31+00:00）
...
- 1. `socks5://121.148.104.105:1080` | `socks5` | `elite` | 200 0.997477 | source=`proxyscrape`
- 2. `socks5://158.179.173.238:1080` | `socks5` | `elite` | 200 5.442594 | source=`proxyscrape`
- 3. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 4.823351 | source=`proxyscrape`
- 4. `socks5://123.214.62.25:6881` | `socks5` | `unknown` | 200 1.194515 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.820458 | source=`monosans_kr_json`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.938031 | source=`proxifly`
- 7. `socks5://206.123.156.177:9508` | `socks5` | `transparent` | 200 6.276108 | source=`proxifly`
