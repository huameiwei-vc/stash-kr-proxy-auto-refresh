# KR 免费代理自动刷新报告（2026-05-24T08:11:32+00:00）
...
- 1. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 1.002097 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.531077 | source=`geonode`
- 3. `http://3.35.242.248:1080` | `http` | `elite` | 200 0.567267 | source=`proxyscrape`
- 4. `http://121.135.144.141:8026` | `http` | `elite` | 200 3.168524 | source=`proxyscrape`
- 5. `http://210.223.44.230:3128` | `http` | `anonymous` | 200 2.449391 | source=`geonode`
- 6. `http://43.128.145.26:1080` | `http` | `unknown` | 200 0.514869 | source=`monosans_kr_json`
- 7. `http://13.125.240.195:1080` | `http` | `unknown` | 200 0.566929 | source=`niek`
- 8. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.727020 | source=`monosans_kr_json`
- 9. `http://43.155.238.7:3128` | `http` | `transparent` | 200 7.926360 | source=`proxyscrape`
