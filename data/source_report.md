# KR 免费代理自动刷新报告（2026-08-14T17:08:04+00:00）
...
- 1. `socks5://47.80.27.150:1080` | `socks5` | `elite` | 200 0.940505 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.002344 | source=`geonode`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.796268 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 3.620095 | source=`monosans_kr_json`
- 5. `http://132.226.171.101:3128` | `http` | `transparent` | 200 1.894202 | source=`proxifly`
