# KR 免费代理自动刷新报告（2026-07-20T16:17:48+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.028426 | source=`geonode`
- 2. `socks5://58.120.135.195:1080` | `socks5` | `elite` | 200 1.049129 | source=`proxyscrape`
- 3. `socks4://43.133.242.194:888` | `socks4` | `elite` | 200 0.976896 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.013279 | source=`monosans_kr_json`
- 5. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 1.161080 | source=`proxifly`
- 6. `socks5://43.133.242.194:888` | `socks5` | `transparent` | 200 1.525296 | source=`proxifly`
- 7. `http://58.180.17.51:3128` | `http` | `transparent` | 200 10.047668 | source=`proxifly`
