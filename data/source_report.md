# KR 免费代理自动刷新报告（2026-06-30T11:36:26+00:00）
...
- 1. `socks5://43.128.150.150:1080` | `socks5` | `elite` | 200 0.974716 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.737747 | source=`geonode`
- 3. `socks5://152.70.241.59:1080` | `socks5` | `elite` | 200 3.492113 | source=`geonode`
- 4. `socks4://43.128.140.213:1080` | `socks4` | `elite` | 200 1.717462 | source=`proxyscrape`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.992728 | source=`niek`
- 6. `socks5://43.128.140.213:1080` | `socks5` | `transparent` | 200 0.934808 | source=`proxifly`
- 7. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.939770 | source=`proxifly`
