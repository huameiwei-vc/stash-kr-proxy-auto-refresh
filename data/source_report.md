# KR 免费代理自动刷新报告（2026-05-03T14:48:58+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.103522 | source=`geonode`
- 2. `socks5://193.123.250.39:1080` | `socks5` | `unknown` | 200 2.756263 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.072764 | source=`niek`
- 4. `http://193.123.250.39:1080` | `http` | `unknown` | 200 1.686310 | source=`monosans_kr_json`
- 5. `socks5://206.123.156.236:48211` | `socks5` | `transparent` | 200 8.681093 | source=`proxifly`
- 6. `http://193.122.96.242:3128` | `http` | `transparent` | 200 3.321912 | source=`proxyscrape`
