# KR 免费代理自动刷新报告（2026-08-24T04:03:29+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.644875 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `elite` | 200 2.292345 | source=`geonode`
- 3. `socks5://150.109.247.86:8443` | `socks5` | `unknown` | 200 0.611788 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.502460 | source=`monosans_kr_json`
- 5. `socks4://221.133.129.35:1080` | `socks4` | `transparent` | 200 0.822331 | source=`proxifly`
