# KR 免费代理自动刷新报告（2026-06-07T17:11:51+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.692697 | source=`geonode`
- 2. `socks5://158.180.77.24:1080` | `socks5` | `elite` | 200 1.203972 | source=`geonode`
- 3. `http://169.212.15.161:5000` | `http` | `unknown` | 200 0.732274 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.749771 | source=`niek`
- 5. `http://43.128.145.26:1080` | `http` | `unknown` | 200 1.437355 | source=`monosans_kr_json`
- 6. `socks4://1.245.175.180:1080` | `socks4` | `transparent` | 200 1.924272 | source=`proxifly`
