# KR 免费代理自动刷新报告（2026-03-29T01:10:18+00:00）
...
- 1. `http://112.163.160.93:3128` | `http` | `elite` | 200 0.790334 | source=`proxyscrape`
- 2. `http://1.234.153.14:80` | `http` | `anonymous` | 200 4.285999 | source=`proxyscrape`
- 3. `socks5://1.225.116.115:1080` | `socks5` | `unknown` | 200 6.012458 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.656053 | source=`niek`
- 5. `http://121.126.185.63:25152` | `http` | `unknown` | 200 2.022646 | source=`monosans_kr_json`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.263799 | source=`proxifly`
