# KR 免费代理自动刷新报告（2026-04-29T10:29:41+00:00）
...
- proxifly: 13
- proxyscrape: 15
- skillter_fallback: 238
- 去重后总候选: 101

## 当前验证通过的代理

- 1. `socks5://43.133.90.161:8088` | `socks5` | `elite` | 200 6.551516 | source=`proxyscrape`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.843929 | source=`monosans_kr_json`
