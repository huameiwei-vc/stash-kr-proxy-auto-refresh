# KR 免费代理自动刷新报告（2026-06-05T20:19:24+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 3.184113 | source=`geonode`
- 2. `http://125.129.15.95:3128` | `http` | `elite` | 200 0.760024 | source=`proxyscrape`
- 3. `http://43.128.145.26:1080` | `http` | `unknown` | 200 1.590833 | source=`monosans_kr_json`
- 4. `socks5://168.107.55.115:50161` | `socks5` | `transparent` | 200 1.295045 | source=`proxifly`
- 5. `http://146.56.182.165:3128` | `http` | `transparent` | 200 0.828166 | source=`proxifly`
