# KR 免费代理自动刷新报告（2026-09-05T04:59:41+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.564359 | source=`monosans_kr_json`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `unknown` | 200 2.362572 | source=`iplocate`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.594140 | source=`monosans_kr_json`
- 4. `http://152.67.221.233:8008` | `http` | `unknown` | 200 5.191693 | source=`niek`
