# KR 免费代理自动刷新报告（2026-05-08T04:27:10+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.971814 | source=`geonode`
- 2. `http://210.223.44.230:3128` | `http` | `anonymous` | 200 0.953408 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.065045 | source=`monosans_kr_json`
- 4. `http://220.121.143.33:3128` | `http` | `unknown` | 200 4.182443 | source=`monosans_kr_json`
