# KR 免费代理自动刷新报告（2026-05-17T07:19:12+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.915211 | source=`geonode`
- 2. `http://210.223.44.230:3128` | `http` | `anonymous` | 200 2.980838 | source=`geonode`
- 3. `socks5://206.123.156.215:5221` | `socks5` | `unknown` | 200 3.404995 | source=`monosans_kr_json`
- 4. `socks5://206.123.156.204:4877` | `socks5` | `unknown` | 200 5.249960 | source=`monosans_kr_json`
- 5. `socks5://206.123.156.207:7945` | `socks5` | `unknown` | 200 7.607260 | source=`monosans_kr_json`
- 6. `socks5://206.123.156.189:8615` | `socks5` | `unknown` | 200 11.458131 | source=`monosans_kr_json`
