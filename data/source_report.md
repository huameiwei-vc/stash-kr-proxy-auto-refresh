# KR 免费代理自动刷新报告（2026-08-02T11:50:06+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.780283 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.661898 | source=`monosans_kr_json`
- 3. `socks5://43.155.185.73:1080` | `socks5` | `unknown` | 200 0.682626 | source=`monosans_kr_json`
- 4. `socks5://218.52.249.121:1080` | `socks5` | `unknown` | 200 0.734135 | source=`monosans_kr_json`
- 5. `socks5://43.155.232.123:1080` | `socks5` | `unknown` | 200 0.889181 | source=`monosans_kr_json`
- 6. `socks5://112.168.139.118:1080` | `socks5` | `unknown` | 200 0.990077 | source=`monosans_kr_json`
- 7. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.565690 | source=`monosans_kr_json`
