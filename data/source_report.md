# KR 免费代理自动刷新报告（2026-04-14T14:44:27+00:00）
...
- 1. `http://183.98.143.134:8055` | `http` | `elite` | 200 0.726579 | source=`proxyscrape`
- 2. `socks5://123.214.62.25:6881` | `socks5` | `unknown` | 200 4.208003 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.065496 | source=`monosans_kr_json`
- 4. `http://218.153.163.186:8781` | `http` | `unknown` | 200 5.005049 | source=`monosans_kr_json`
- 5. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.745232 | source=`proxifly`
