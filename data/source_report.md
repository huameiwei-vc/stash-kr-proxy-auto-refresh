# KR 免费代理自动刷新报告（2026-08-26T05:20:36+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.692702 | source=`geonode`
- 2. `socks5://152.67.221.233:8008` | `socks5` | `elite` | 200 3.796580 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.658008 | source=`monosans_kr_json`
- 4. `http://130.162.144.61:1080` | `http` | `unknown` | 200 1.550439 | source=`niek`
- 5. `http://54.180.117.151:39985` | `http` | `unknown` | 200 4.159897 | source=`iplocate`
- 6. `socks5://130.162.144.61:1080` | `socks5` | `transparent` | 200 1.242759 | source=`proxifly`
- 7. `socks5://5.75.133.113:10811` | `socks5` | `transparent` | 200 2.273400 | source=`proxifly`
