# KR 免费代理自动刷新报告（2026-09-08T05:11:27+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.747581 | source=`monosans_kr_json`
- 2. `http://217.142.139.207:8085` | `http` | `unknown` | 200 6.105066 | source=`niek`
- 3. `socks5://43.155.204.231:1080` | `socks5` | `transparent` | 200 0.940267 | source=`proxifly`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.958388 | source=`proxifly`
