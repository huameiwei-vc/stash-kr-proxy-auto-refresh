# KR 免费代理自动刷新报告（2026-04-25T23:52:09+00:00）
...
- 1. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 3.386872 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `unknown` | 200 1.015736 | source=`monosans_kr_json`
- 3. `http://43.133.90.161:8888` | `http` | `unknown` | 200 2.298004 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 3.489987 | source=`monosans_kr_json`
- 5. `socks5://206.123.156.207:6772` | `socks5` | `transparent` | 200 4.599077 | source=`proxifly`
- 6. `socks5://206.123.156.217:5063` | `socks5` | `transparent` | 200 8.632779 | source=`proxifly`
- 7. `http://121.147.253.205:3012` | `http` | `transparent` | 200 0.651714 | source=`proxifly`
