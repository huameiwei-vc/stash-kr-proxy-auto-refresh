# KR 免费代理自动刷新报告（2026-06-28T16:53:52+00:00）
...
- 1. `socks5://49.143.59.205:110` | `socks5` | `elite` | 200 0.912047 | source=`proxyscrape`
- 2. `socks5://152.70.241.59:1080` | `socks5` | `elite` | 200 1.496140 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.879326 | source=`monosans_kr_json`
- 4. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.959675 | source=`proxifly`
- 5. `http://211.197.77.76:3116` | `http` | `transparent` | 200 9.956114 | source=`proxyscrape`
