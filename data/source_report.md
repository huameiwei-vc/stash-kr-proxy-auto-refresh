# KR 免费代理自动刷新报告（2026-03-31T06:59:22+00:00）
...
- 1. `http://112.163.160.93:3128` | `http` | `elite` | 200 1.861420 | source=`proxyscrape`
- 2. `http://121.126.185.63:25152` | `http` | `elite` | 200 1.925769 | source=`geonode`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.013766 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.243911 | source=`proxifly`
