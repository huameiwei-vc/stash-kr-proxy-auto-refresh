# KR 免费代理自动刷新报告（2026-04-02T23:54:50+00:00）
...
- 1. `socks5://1.225.116.115:1080` | `socks5` | `unknown` | 200 2.271330 | source=`skillter_socks5`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.749806 | source=`monosans_kr_json`
- 3. `http://1.225.116.115:1080` | `http` | `unknown` | 200 3.238025 | source=`skillter_http`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.066129 | source=`proxifly`
