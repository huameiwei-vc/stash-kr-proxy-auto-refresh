# KR 免费代理自动刷新报告（2026-08-16T21:07:38+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 2.453691 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.696682 | source=`monosans_kr_json`
- 3. `http://111.119.162.248:10940` | `http` | `unknown` | 200 6.186402 | source=`monosans_kr_json`
