# KR 免费代理自动刷新报告（2026-06-14T17:42:40+00:00）
...
- 1. `socks5://193.122.105.251:65535` | `socks5` | `elite` | 200 0.997210 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.408088 | source=`geonode`
- 3. `socks5://158.179.173.238:1080` | `socks5` | `elite` | 200 9.426979 | source=`proxyscrape`
- 4. `http://169.212.15.161:5000` | `http` | `unknown` | 200 0.987973 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.941134 | source=`monosans_kr_json`
- 6. `socks5://193.123.254.182:1080` | `socks5` | `transparent` | 200 1.593365 | source=`proxifly`
- 7. `socks5://206.123.156.225:4705` | `socks5` | `transparent` | 200 8.538167 | source=`proxifly`
