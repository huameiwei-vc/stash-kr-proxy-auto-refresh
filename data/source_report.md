# KR 免费代理自动刷新报告（2026-08-13T04:28:39+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.846701 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `elite` | 200 1.270746 | source=`geonode`
- 3. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 5.496398 | source=`proxyscrape`
- 4. `socks5://47.80.27.150:1080` | `socks5` | `unknown` | 200 0.856245 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.551064 | source=`monosans_kr_json`
