# KR 免费代理自动刷新报告（2026-08-21T15:54:22+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.666769 | source=`geonode`
- 2. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 4.104441 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.029775 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.536009 | source=`monosans_kr_json`
- 5. `http://112.216.54.226:12121` | `http` | `unknown` | 200 0.713049 | source=`niek`
- 6. `http://119.28.233.241:3128` | `http` | `transparent` | 200 7.903352 | source=`proxyscrape`
