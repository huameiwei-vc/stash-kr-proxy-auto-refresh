# KR 免费代理自动刷新报告（2026-04-11T23:56:18+00:00）
...
- 1. `socks5://1.225.116.115:1080` | `socks5` | `unknown` | 200 2.576967 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.121786 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.389981 | source=`proxifly`
- 4. `http://119.195.17.15:3192` | `http` | `transparent` | 200 1.485042 | source=`proxyscrape`
