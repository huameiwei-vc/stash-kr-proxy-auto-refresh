# KR 免费代理自动刷新报告（2026-05-05T12:55:57+00:00）
...
- 1. `socks4://158.247.193.221:1080` | `socks4` | `elite` | 200 9.859280 | source=`proxyscrape`
- 2. `http://193.123.250.39:1080` | `http` | `unknown` | 200 0.957365 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.984540 | source=`monosans_kr_json`
- 4. `socks5://193.123.250.39:1080` | `socks5` | `transparent` | 200 2.461212 | source=`proxifly`
