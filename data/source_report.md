# KR 免费代理自动刷新报告（2026-07-26T16:27:10+00:00）
...
- 1. `socks5://8.213.149.224:1080` | `socks5` | `elite` | 200 0.662043 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.687807 | source=`geonode`
- 3. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 8.396150 | source=`proxyscrape`
- 4. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.883934 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.773561 | source=`monosans_kr_json`
- 6. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.672861 | source=`proxifly`
