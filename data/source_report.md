# KR 免费代理自动刷新报告（2026-08-21T07:55:22+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `elite` | 200 2.401415 | source=`geonode`
- 2. `socks5://182.231.145.236:1080` | `socks5` | `unknown` | 200 0.813839 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.604945 | source=`monosans_kr_json`
- 4. `http://101.79.29.143:3128` | `http` | `unknown` | 200 0.616337 | source=`monosans_kr_json`
- 5. `http://182.231.145.236:1080` | `http` | `unknown` | 200 0.623480 | source=`monosans_kr_json`
- 6. `http://112.216.54.226:12121` | `http` | `unknown` | 200 0.843042 | source=`monosans_kr_json`
- 7. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.141455 | source=`proxifly`
