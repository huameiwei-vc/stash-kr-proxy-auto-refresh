# KR 免费代理自动刷新报告（2026-07-20T12:37:28+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 3.757627 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.024329 | source=`niek`
- 3. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.925755 | source=`proxifly`
- 4. `socks5://43.133.242.194:888` | `socks5` | `transparent` | 200 1.676204 | source=`proxifly`
- 5. `http://58.180.17.51:3128` | `http` | `transparent` | 200 2.108182 | source=`proxifly`
