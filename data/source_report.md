# KR 免费代理自动刷新报告（2026-08-22T21:11:33+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.787961 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.640614 | source=`monosans_kr_json`
- 3. `socks5://203.227.191.4:10809` | `socks5` | `transparent` | 200 0.798424 | source=`proxifly`
