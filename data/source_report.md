# KR 免费代理自动刷新报告（2026-07-30T15:07:44+00:00）
...
- 1. `socks5://43.155.232.123:1080` | `socks5` | `elite` | 200 1.130880 | source=`geonode`
- 2. `socks5://168.107.13.220:50161` | `socks5` | `elite` | 200 1.214488 | source=`geonode`
- 3. `socks4://168.107.13.220:50161` | `socks4` | `elite` | 200 0.988877 | source=`proxyscrape`
- 4. `socks5://43.155.185.73:1080` | `socks5` | `unknown` | 200 0.936777 | source=`monosans_kr_json`
- 5. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.749808 | source=`monosans_kr_json`
- 6. `socks5://218.52.249.121:1080` | `socks5` | `unknown` | 200 4.950191 | source=`iplocate`
- 7. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.771703 | source=`monosans_kr_json`
- 8. `socks5://152.70.253.226:1080` | `socks5` | `transparent` | 200 0.928772 | source=`proxifly`
