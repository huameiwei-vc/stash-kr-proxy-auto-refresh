# KR 免费代理自动刷新报告（2026-06-19T11:44:07+00:00）
...
- 1. `socks5://101.33.76.248:1080` | `socks5` | `elite` | 200 0.969602 | source=`proxyscrape`
- 2. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 6.356749 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.755957 | source=`monosans_kr_json`
- 4. `http://43.155.132.199:3128` | `http` | `unknown` | 200 4.554218 | source=`monosans_kr_json`
- 5. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.688141 | source=`proxifly`
- 6. `http://221.161.204.152:3016` | `http` | `transparent` | 200 9.158033 | source=`proxyscrape`
