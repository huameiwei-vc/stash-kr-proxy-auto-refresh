# KR 免费代理自动刷新报告（2026-04-21T15:50:02+00:00）
...
- 1. `socks5://158.247.212.189:1080` | `socks5` | `elite` | 200 7.508379 | source=`proxyscrape`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.572547 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.923440 | source=`proxifly`
- 4. `http://106.10.55.212:1121` | `http` | `transparent` | 200 0.531171 | source=`proxyscrape`
