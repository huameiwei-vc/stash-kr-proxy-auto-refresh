# KR 免费代理自动刷新报告（2026-04-25T19:35:54+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.244367 | source=`monosans_kr_json`
- 2. `http://43.133.90.161:8888` | `http` | `unknown` | 200 10.195340 | source=`skillter_http`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.032057 | source=`proxifly`
- 4. `http://121.148.239.82:3046` | `http` | `transparent` | 200 3.234121 | source=`proxyscrape`
