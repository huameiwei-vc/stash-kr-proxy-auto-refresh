# KR 免费代理自动刷新报告（2026-08-22T16:07:55+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 3.902521 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.694603 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.565156 | source=`monosans_kr_json`
- 4. `http://111.119.162.248:10940` | `http` | `unknown` | 200 2.832001 | source=`monosans_kr_json`
