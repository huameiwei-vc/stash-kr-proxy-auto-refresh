# KR 免费代理自动刷新报告（2026-08-15T03:50:17+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.066542 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.783086 | source=`monosans_kr_json`
- 3. `socks5://47.80.27.150:1080` | `socks5` | `unknown` | 200 0.799069 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.651628 | source=`monosans_kr_json`
- 5. `http://132.226.171.101:3128` | `http` | `transparent` | 200 1.296144 | source=`proxifly`
