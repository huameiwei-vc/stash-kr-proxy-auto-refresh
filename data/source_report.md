# KR 免费代理自动刷新报告（2026-04-19T21:49:55+00:00）
...
- 1. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 8.987831 | source=`proxyscrape`
- 2. `http://210.223.44.230:3128` | `http` | `anonymous` | 200 2.944834 | source=`proxyscrape`
- 3. `socks5://152.70.91.193:40000` | `socks5` | `unknown` | 200 1.758993 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.512696 | source=`monosans_kr_json`
- 5. `socks5://123.214.62.25:6881` | `socks5` | `transparent` | 200 0.812080 | source=`proxifly`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.904940 | source=`proxifly`
- 7. `http://106.10.55.212:1121` | `http` | `transparent` | 200 0.694525 | source=`proxyscrape`
