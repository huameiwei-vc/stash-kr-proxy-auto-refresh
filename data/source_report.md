# KR 免费代理自动刷新报告（2026-04-22T21:40:06+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.695177 | source=`monosans_kr_json`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.621790 | source=`proxifly`
- 3. `socks5://206.123.156.177:9468` | `socks5` | `transparent` | 200 4.285563 | source=`proxifly`
- 4. `socks5://206.123.156.226:7285` | `socks5` | `transparent` | 200 6.174941 | source=`proxifly`
