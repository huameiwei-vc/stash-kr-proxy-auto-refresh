# KR 免费代理自动刷新报告（2026-06-25T09:20:36+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.939439 | source=`niek`
- 2. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.682694 | source=`proxifly`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.297875 | source=`proxifly`
- 4. `socks5://206.123.156.238:5249` | `socks5` | `transparent` | 200 8.321535 | source=`proxifly`
- 5. `http://106.10.55.212:1121` | `http` | `transparent` | 200 2.753205 | source=`proxyscrape`
