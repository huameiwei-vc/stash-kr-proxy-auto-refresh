# KR 免费代理自动刷新报告（2026-08-22T22:55:17+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.291401 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 3.132694 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.752620 | source=`monosans_kr_json`
- 4. `http://112.216.54.226:12121` | `http` | `unknown` | 200 0.969685 | source=`monosans_kr_json`
- 5. `socks5://203.227.191.4:10809` | `socks5` | `transparent` | 200 0.927410 | source=`proxifly`
