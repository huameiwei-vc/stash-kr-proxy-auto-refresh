# KR 免费代理自动刷新报告（2026-08-29T21:57:10+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.095031 | source=`geonode`
- 2. `socks5://152.67.221.233:8008` | `socks5` | `elite` | 200 7.195137 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 2.245945 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.728926 | source=`monosans_kr_json`
