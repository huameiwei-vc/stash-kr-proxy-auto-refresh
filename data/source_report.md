# KR 免费代理自动刷新报告（2026-08-26T05:54:58+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 3.099632 | source=`geonode`
- 2. `socks5://152.67.221.233:8008` | `socks5` | `elite` | 200 8.190908 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.501102 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.532864 | source=`niek`
- 5. `http://130.162.144.61:1080` | `http` | `unknown` | 200 3.271493 | source=`niek`
- 6. `socks5://130.162.144.61:1080` | `socks5` | `transparent` | 200 0.931825 | source=`proxifly`
