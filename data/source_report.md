# KR 免费代理自动刷新报告（2026-05-12T23:58:33+00:00）
...
- 1. `socks5://152.70.91.193:40000` | `socks5` | `elite` | 200 1.413188 | source=`proxyscrape`
- 2. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 1.512254 | source=`proxyscrape`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.571743 | source=`geonode`
- 4. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 4.079909 | source=`proxyscrape`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.941433 | source=`monosans_kr_json`
- 6. `http://210.223.44.230:3128` | `http` | `unknown` | 200 0.991417 | source=`niek`
- 7. `http://43.200.174.49:3128` | `http` | `transparent` | 200 0.665253 | source=`proxyscrape`
- 8. `http://49.254.24.114:15648` | `http` | `transparent` | 200 5.420063 | source=`proxifly`
- 9. `http://146.56.164.121:3128` | `http` | `transparent` | 200 8.600495 | source=`proxifly`
