# KR 免费代理自动刷新报告（2026-08-25T03:55:48+00:00）
...
- 1. `socks5://150.109.247.86:8443` | `socks5` | `elite` | 200 0.914958 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.207204 | source=`geonode`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.937599 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.790709 | source=`niek`
- 5. `http://112.186.12.196:3128` | `http` | `unknown` | 200 7.252705 | source=`monosans_kr_json`
