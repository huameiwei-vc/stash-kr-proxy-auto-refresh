# KR 免费代理自动刷新报告（2026-07-28T16:54:30+00:00）
...
- 1. `socks5://43.155.232.123:1080` | `socks5` | `elite` | 200 0.622800 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.663527 | source=`geonode`
- 3. `socks5://138.2.119.222:80` | `socks5` | `elite` | 200 0.688740 | source=`proxyscrape`
- 4. `socks5://43.155.185.73:1080` | `socks5` | `unknown` | 200 0.616727 | source=`monosans_kr_json`
- 5. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.620637 | source=`monosans_kr_json`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.512290 | source=`monosans_kr_json`
- 7. `http://150.230.249.50:1080` | `http` | `unknown` | 200 0.955064 | source=`niek`
- 8. `http://13.209.192.128:3129` | `http` | `unknown` | 200 10.499275 | source=`niek`
- 9. `socks5://8.213.149.224:1080` | `socks5` | `transparent` | 200 0.631607 | source=`proxifly`
- 10. `socks5://150.230.249.50:1080` | `socks5` | `transparent` | 200 1.706661 | source=`proxifly`
- 11. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 3.731524 | source=`proxifly`
