# KR 免费代理自动刷新报告（2026-08-02T19:49:16+00:00）
...
- 1. `socks5://43.155.232.123:1080` | `socks5` | `unknown` | 200 1.166667 | source=`monosans_kr_json`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 4.787510 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.747247 | source=`monosans_kr_json`
- 4. `http://43.155.232.123:8090` | `http` | `unknown` | 200 0.759501 | source=`monosans_kr_json`
- 5. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.051372 | source=`proxifly`
