# KR 免费代理自动刷新报告（2026-07-20T14:52:57+00:00）
...
- 1. `socks5://43.155.215.149:20000` | `socks5` | `elite` | 200 0.859925 | source=`proxyscrape`
- 2. `socks4://43.133.242.194:888` | `socks4` | `elite` | 200 0.864986 | source=`proxyscrape`
- 3. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 1.029487 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.886049 | source=`monosans_kr_json`
- 5. `http://211.233.44.58:8080` | `http` | `unknown` | 200 6.275371 | source=`monosans_kr_json`
- 6. `http://58.180.17.51:3128` | `http` | `unknown` | 200 6.381757 | source=`monosans_kr_json`
- 7. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 1.832110 | source=`proxifly`
- 8. `socks5://43.133.242.194:888` | `socks5` | `transparent` | 200 2.472465 | source=`proxifly`
