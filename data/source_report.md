# KR 免费代理自动刷新报告（2026-08-21T03:58:51+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.951747 | source=`monosans_kr_json`
- 2. `socks5://182.231.145.236:1080` | `socks5` | `unknown` | 200 0.953941 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.776962 | source=`monosans_kr_json`
- 4. `http://182.231.145.236:1080` | `http` | `unknown` | 200 0.809671 | source=`monosans_kr_json`
- 5. `http://112.216.54.226:12121` | `http` | `unknown` | 200 1.005100 | source=`niek`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.616410 | source=`proxifly`
- 7. `http://47.80.60.84:3128` | `http` | `transparent` | 200 2.062632 | source=`proxifly`
