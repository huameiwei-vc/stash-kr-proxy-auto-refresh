# KR 免费代理自动刷新报告（2026-08-14T21:12:26+00:00）
...
- 1. `socks5://47.80.27.150:1080` | `socks5` | `elite` | 200 0.804400 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.000813 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.638906 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.908395 | source=`proxifly`
- 5. `http://132.226.171.101:3128` | `http` | `transparent` | 200 2.661994 | source=`proxyscrape`
