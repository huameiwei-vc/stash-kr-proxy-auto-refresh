# KR 免费代理自动刷新报告（2026-06-08T00:19:49+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.949030 | source=`geonode`
- 2. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 4.055101 | source=`proxyscrape`
- 3. `socks5://211.245.23.166:1080` | `socks5` | `elite` | 200 5.044617 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.728007 | source=`niek`
- 5. `http://169.212.15.161:5000` | `http` | `unknown` | 200 0.741759 | source=`monosans_kr_json`
- 6. `http://43.128.145.26:1080` | `http` | `unknown` | 200 1.039178 | source=`monosans_kr_json`
- 7. `socks5://59.11.209.162:1080` | `socks5` | `transparent` | 200 0.986175 | source=`proxifly`
- 8. `http://140.245.66.105:8081` | `http` | `transparent` | 200 10.482881 | source=`proxifly`
