# KR 免费代理自动刷新报告（2026-08-25T17:01:06+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `elite` | 200 1.486017 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.755259 | source=`monosans_kr_json`
- 3. `socks5://43.155.159.164:1080` | `socks5` | `transparent` | 200 0.901432 | source=`proxifly`
