# KR 免费代理自动刷新报告（2026-08-24T20:47:19+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.068346 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.685668 | source=`monosans_kr_json`
- 3. `http://217.160.249.182:8888` | `http` | `unknown` | 200 3.987577 | source=`monosans_kr_json`
- 4. `http://47.80.60.84:3128` | `http` | `transparent` | 200 1.406429 | source=`proxyscrape`
