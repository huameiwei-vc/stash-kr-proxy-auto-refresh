# KR 免费代理自动刷新报告（2026-09-11T22:49:57+00:00）
...
- 1. `socks5://8.213.157.143:1080` | `socks5` | `elite` | 200 0.984472 | source=`proxyscrape`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.648030 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.819987 | source=`proxifly`
