# KR 免费代理自动刷新报告（2026-06-21T17:59:03+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.861377 | source=`geonode`
- 2. `socks4://1.245.175.180:1080` | `socks4` | `elite` | 200 1.183491 | source=`proxyscrape`
- 3. `socks5://206.123.156.224:5692` | `socks5` | `unknown` | 200 8.530163 | source=`iplocate`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.752025 | source=`niek`
- 5. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.748540 | source=`proxifly`
