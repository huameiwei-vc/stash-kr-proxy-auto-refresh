# KR 免费代理自动刷新报告（2026-05-30T07:49:30+00:00）
...
- 1. `socks5://152.70.91.193:40000` | `socks5` | `elite` | 200 1.378318 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.899809 | source=`geonode`
- 3. `socks5://158.179.173.238:1080` | `socks5` | `elite` | 200 3.083620 | source=`proxyscrape`
- 4. `socks5://158.247.241.3:1080` | `socks5` | `elite` | 200 3.343965 | source=`geonode`
- 5. `socks4://158.247.240.61:1080` | `socks4` | `elite` | 200 2.291451 | source=`proxyscrape`
- 6. `socks4://158.247.206.191:1080` | `socks4` | `elite` | 200 3.494588 | source=`proxyscrape`
- 7. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 9.283483 | source=`proxyscrape`
- 8. `http://43.128.145.26:1080` | `http` | `unknown` | 200 0.729189 | source=`monosans_kr_json`
- 9. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.065374 | source=`niek`
- 10. `http://106.10.55.212:1121` | `http` | `transparent` | 200 0.884084 | source=`proxyscrape`
