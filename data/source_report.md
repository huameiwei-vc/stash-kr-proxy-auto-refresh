# KR 免费代理自动刷新报告（2026-08-16T11:31:18+00:00）
...
- 1. `socks5://158.179.171.148:1080` | `socks5` | `elite` | 200 6.575798 | source=`proxyscrape`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 2.156880 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.761559 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.941928 | source=`proxifly`
