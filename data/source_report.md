# KR 免费代理自动刷新报告（2026-08-08T04:43:37+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.805206 | source=`geonode`
- 2. `socks5://141.164.58.134:1080` | `socks5` | `elite` | 200 9.163622 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.003482 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.671641 | source=`monosans_kr_json`
- 5. `socks5://152.70.237.238:3128` | `socks5` | `transparent` | 200 1.197770 | source=`proxifly`
