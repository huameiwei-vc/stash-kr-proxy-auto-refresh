# KR 免费代理自动刷新报告（2026-08-19T23:55:15+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.106231 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.536454 | source=`monosans_kr_json`
- 3. `socks5://111.48.191.24:7890` | `socks5` | `transparent` | 200 11.213209 | source=`proxifly`
- 4. `socks4://1.245.175.180:1080` | `socks4` | `transparent` | 200 0.813003 | source=`proxifly`
