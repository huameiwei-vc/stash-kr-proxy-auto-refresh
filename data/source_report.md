# KR 免费代理自动刷新报告（2026-04-16T04:40:54+00:00）
...
- 1. `socks5://123.214.62.25:6881` | `socks5` | `unknown` | 200 0.974205 | source=`monosans_kr_json`
- 2. `socks5://206.123.156.234:6322` | `socks5` | `unknown` | 200 3.207106 | source=`monosans_kr_json`
- 3. `socks5://206.123.156.187:5559` | `socks5` | `unknown` | 200 4.315763 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.946913 | source=`monosans_kr_json`
- 5. `socks5://152.70.237.238:3128` | `socks5` | `transparent` | 200 3.495913 | source=`proxifly`
- 6. `socks5://206.123.156.177:23010` | `socks5` | `transparent` | 200 3.801054 | source=`proxifly`
