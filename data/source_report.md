# KR 免费代理自动刷新报告（2026-08-22T22:35:01+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.994722 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.263835 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.531476 | source=`monosans_kr_json`
- 4. `socks5://203.227.191.4:10809` | `socks5` | `transparent` | 200 0.641173 | source=`proxifly`
