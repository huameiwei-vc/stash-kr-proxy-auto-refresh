# KR 免费代理自动刷新报告（2026-05-04T16:59:16+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.205437 | source=`geonode`
- 2. `socks5://222.98.9.205:1080` | `socks5` | `elite` | 200 1.497431 | source=`geonode`
- 3. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 4.701731 | source=`proxyscrape`
- 4. `socks5://193.123.250.39:1080` | `socks5` | `unknown` | 200 2.045289 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.085156 | source=`monosans_kr_json`
- 6. `http://193.123.250.39:1080` | `http` | `unknown` | 200 3.625870 | source=`niek`
- 7. `http://106.10.55.212:1121` | `http` | `transparent` | 200 0.894895 | source=`proxyscrape`
