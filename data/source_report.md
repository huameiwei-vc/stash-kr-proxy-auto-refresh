# KR 免费代理自动刷新报告（2026-06-06T19:00:09+00:00）
...
- 1. `socks5://150.230.249.50:1080` | `socks5` | `elite` | 200 0.698254 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.744860 | source=`geonode`
- 3. `socks5://158.247.212.189:1080` | `socks5` | `elite` | 200 4.561800 | source=`geonode`
- 4. `http://43.128.145.26:1080` | `http` | `unknown` | 200 1.509376 | source=`monosans_kr_json`
- 5. `http://150.230.249.50:1080` | `http` | `unknown` | 200 4.543233 | source=`monosans_kr_json`
- 6. `http://220.92.130.114:3036` | `http` | `transparent` | 200 4.424946 | source=`proxyscrape`
