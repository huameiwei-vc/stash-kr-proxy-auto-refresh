# KR 免费代理自动刷新报告（2026-03-28T15:50:40+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.505404 | source=`monosans_kr_json`
- 2. `http://106.10.55.212:1121` | `http` | `unknown` | 200 6.320007 | source=`skillter_http`
- 3. `http://121.126.185.63:25152` | `http` | `unknown` | 200 6.950821 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.031421 | source=`proxifly`
