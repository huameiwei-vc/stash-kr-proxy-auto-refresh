# KR 免费代理自动刷新报告（2026-04-24T07:14:22+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.368527 | source=`monosans_kr_json`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.512820 | source=`proxifly`
- 3. `http://183.98.143.134:8012` | `http` | `transparent` | 200 0.843300 | source=`proxifly`
- 4. `http://106.10.55.212:1121` | `http` | `transparent` | 200 7.664932 | source=`geonode`
