# KR 免费代理自动刷新报告（2026-04-04T21:23:49+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.049191 | source=`monosans_kr_json`
- 2. `http://122.45.51.68:8887` | `http` | `unknown` | 200 2.456793 | source=`skillter_http`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.955277 | source=`proxifly`
