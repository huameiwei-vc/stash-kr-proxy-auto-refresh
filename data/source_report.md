# KR 免费代理自动刷新报告（2026-04-12T22:52:55+00:00）
...
- 1. `socks5://43.133.77.87:1080` | `socks5` | `unknown` | 200 2.418769 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.993070 | source=`monosans_kr_json`
- 3. `socks5://1.225.116.115:1080` | `socks5` | `transparent` | 200 0.961307 | source=`proxifly`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.026154 | source=`proxifly`
