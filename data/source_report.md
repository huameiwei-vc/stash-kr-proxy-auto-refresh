# KR 免费代理自动刷新报告（2026-08-12T15:33:51+00:00）
...
- 1. `http://150.230.249.56:1080` | `http` | `elite` | 200 2.566344 | source=`proxyscrape`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.696093 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.555700 | source=`monosans_kr_json`
- 4. `socks5://150.230.249.56:1080` | `socks5` | `transparent` | 200 4.674444 | source=`proxifly`
