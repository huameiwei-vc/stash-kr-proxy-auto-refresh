# KR 免费代理自动刷新报告（2026-07-15T18:17:58+00:00）
...
- 1. `socks5://218.52.249.121:1080` | `socks5` | `elite` | 200 1.207729 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.871346 | source=`geonode`
- 3. `http://43.164.129.36:3128` | `http` | `elite` | 200 4.621706 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.002178 | source=`monosans_kr_json`
- 5. `http://211.233.44.58:8080` | `http` | `unknown` | 200 3.277614 | source=`monosans_kr_json`
- 6. `http://58.180.17.51:3128` | `http` | `transparent` | 200 1.036163 | source=`proxifly`
- 7. `http://140.245.66.105:8081` | `http` | `transparent` | 200 10.429092 | source=`proxyscrape`
