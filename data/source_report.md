# KR 免费代理自动刷新报告（2026-08-24T10:34:57+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 3.713600 | source=`geonode`
- 2. `http://14.34.180.21:38157` | `http` | `elite` | 200 4.966423 | source=`geonode`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.018162 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 6.659347 | source=`monosans_kr_json`
