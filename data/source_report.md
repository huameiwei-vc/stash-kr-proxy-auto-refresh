# KR 免费代理自动刷新报告（2026-09-03T01:13:48+00:00）
...
- 1. `socks5://8.220.197.112:30001` | `socks5` | `elite` | 200 0.860134 | source=`proxyscrape`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.295715 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.711104 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.479567 | source=`proxifly`
