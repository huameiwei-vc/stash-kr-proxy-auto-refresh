# KR 免费代理自动刷新报告（2026-09-06T12:36:36+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.536101 | source=`monosans_kr_json`
- 2. `http://217.142.139.207:8085` | `http` | `unknown` | 200 2.171715 | source=`niek`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 6.125474 | source=`proxifly`
- 4. `http://140.245.66.105:8081` | `http` | `transparent` | 200 0.551906 | source=`proxyscrape`
