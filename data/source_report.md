# KR 免费代理自动刷新报告（2026-05-02T01:16:00+00:00）
...
- 1. `http://222.107.27.7:8074` | `http` | `elite` | 200 0.765698 | source=`proxyscrape`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.951526 | source=`monosans_kr_json`
