# KR 免费代理自动刷新报告（2026-04-29T21:35:36+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.127681 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.809851 | source=`monosans_kr_json`
- 3. `http://221.156.27.160:3172` | `http` | `transparent` | 200 1.680851 | source=`proxyscrape`
- 4. `http://146.56.182.165:3128` | `http` | `transparent` | 200 3.230040 | source=`proxyscrape`
