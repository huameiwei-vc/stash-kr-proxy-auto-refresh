# KR 免费代理自动刷新报告（2026-07-03T16:49:15+00:00）
...
- 1. `socks5://43.128.150.150:1080` | `socks5` | `elite` | 200 1.001750 | source=`geonode`
- 2. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 2.211947 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.042289 | source=`monosans_kr_json`
- 4. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 1.003389 | source=`proxifly`
- 5. `socks5://152.70.237.238:3128` | `socks5` | `transparent` | 200 2.497687 | source=`proxifly`
- 6. `socks5://206.123.156.215:4573` | `socks5` | `transparent` | 200 5.129684 | source=`proxifly`
- 7. `socks5://206.123.156.209:5546` | `socks5` | `transparent` | 200 5.195840 | source=`proxifly`
- 8. `socks5://206.123.156.209:5731` | `socks5` | `transparent` | 200 5.932810 | source=`proxifly`
- 9. `http://140.245.66.105:8081` | `http` | `transparent` | 200 6.958825 | source=`proxifly`
