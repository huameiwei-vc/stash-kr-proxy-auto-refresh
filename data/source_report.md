# KR 免费代理自动刷新报告（2026-07-15T23:37:19+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.932263 | source=`geonode`
- 2. `http://43.155.222.216:3128` | `http` | `elite` | 200 0.741010 | source=`proxyscrape`
- 3. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 6.193336 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.075314 | source=`monosans_kr_json`
- 5. `http://211.233.44.58:8080` | `http` | `unknown` | 200 1.221720 | source=`monosans_kr_json`
- 6. `http://58.180.17.51:3128` | `http` | `unknown` | 200 1.448996 | source=`monosans_kr_json`
- 7. `http://43.131.224.66:80` | `http` | `transparent` | 200 8.137266 | source=`proxyscrape`
- 8. `http://140.245.66.105:8081` | `http` | `transparent` | 200 9.880259 | source=`proxyscrape`
