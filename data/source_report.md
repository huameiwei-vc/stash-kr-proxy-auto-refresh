# KR 免费代理自动刷新报告（2026-08-21T04:34:25+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.653423 | source=`monosans_kr_json`
- 2. `socks5://182.231.145.236:1080` | `socks5` | `unknown` | 200 0.676048 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.532697 | source=`monosans_kr_json`
- 4. `http://182.231.145.236:1080` | `http` | `unknown` | 200 0.537946 | source=`monosans_kr_json`
- 5. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.675363 | source=`proxifly`
