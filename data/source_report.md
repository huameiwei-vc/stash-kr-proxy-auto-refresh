# KR 免费代理自动刷新报告（2026-07-28T18:05:35+00:00）
...
- 1. `socks5://43.155.232.123:1080` | `socks5` | `elite` | 200 0.926614 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.970868 | source=`geonode`
- 3. `socks5://138.2.119.222:80` | `socks5` | `elite` | 200 1.012255 | source=`proxyscrape`
- 4. `socks5://43.155.185.73:1080` | `socks5` | `unknown` | 200 0.918055 | source=`monosans_kr_json`
- 5. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.919727 | source=`monosans_kr_json`
- 6. `socks5://61.82.142.10:1080` | `socks5` | `unknown` | 200 0.955603 | source=`monosans_kr_json`
- 7. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.745019 | source=`monosans_kr_json`
- 8. `http://150.230.249.50:1080` | `http` | `unknown` | 200 0.794835 | source=`niek`
- 9. `http://61.82.142.10:1080` | `http` | `unknown` | 200 1.149791 | source=`monosans_kr_json`
- 10. `http://211.233.44.58:8080` | `http` | `unknown` | 200 3.966052 | source=`niek`
- 11. `socks5://8.213.149.224:1080` | `socks5` | `transparent` | 200 0.924754 | source=`proxifly`
- 12. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.934191 | source=`proxifly`
- 13. `socks5://150.230.249.50:1080` | `socks5` | `transparent` | 200 0.981109 | source=`proxifly`
