# KR 免费代理自动刷新报告（2026-06-23T08:57:03+00:00）
...
- geonode_error: 0
- iplocate: 6
- monosans_fallback: 22
- monosans_kr_json: 0
- niek: 7
- proxifly: 19
- proxyscrape: 24
- skillter_fallback: 162
- 去重后总候选: 53

## 当前验证通过的代理

- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.944558 | source=`niek`
- 2. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.829201 | source=`proxifly`
