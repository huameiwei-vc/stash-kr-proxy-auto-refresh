# KR 免费代理自动刷新报告（2026-09-08T00:31:43+00:00）
...
- 1. `socks5://43.155.204.231:1080` | `socks5` | `unknown` | 200 0.664732 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.540563 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.750164 | source=`proxifly`
