# KR 免费代理自动刷新报告（2026-08-15T02:02:28+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 4.081056 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `transparent` | 200 0.744805 | source=`proxyscrape`
- 3. `http://132.226.171.101:3128` | `http` | `transparent` | 200 2.162318 | source=`proxifly`
