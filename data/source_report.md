# KR 免费代理自动刷新报告（2026-09-14T00:24:12+00:00）
...
- 1. `http://210.121.160.240:14589` | `http` | `elite` | 200 9.156722 | source=`proxyscrape`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.758956 | source=`monosans_kr_json`
- 3. `http://210.121.160.116:22420` | `http` | `unknown` | 200 9.540747 | source=`monosans_kr_json`
- 4. `http://121.170.165.72:29199` | `http` | `transparent` | 200 8.093080 | source=`proxifly`
- 5. `http://43.164.129.84:3128` | `http` | `transparent` | 200 8.198779 | source=`proxyscrape`
- 6. `http://121.170.165.96:26618` | `http` | `transparent` | 200 8.529413 | source=`proxifly`
