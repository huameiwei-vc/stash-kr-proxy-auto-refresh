# KR 免费代理自动刷新报告（2026-09-12T17:54:40+00:00）
...
- 1. `http://43.164.129.36:3128` | `http` | `elite` | 200 5.151545 | source=`proxyscrape`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.737060 | source=`monosans_kr_json`
