# KR 免费代理自动刷新报告（2026-06-28T09:29:16+00:00）
...
- geonode_error: 0
- iplocate: 10
- monosans_fallback: 21
- monosans_kr_json: 1
- niek: 6
- proxifly: 29
- proxyscrape: 26
- skillter_fallback: 174
- 去重后总候选: 65

## 当前验证通过的代理

- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.688418 | source=`monosans_kr_json`
- 2. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 6.493885 | source=`proxifly`
- 3. `socks5://206.123.156.223:5520` | `socks5` | `transparent` | 200 8.014195 | source=`proxifly`
