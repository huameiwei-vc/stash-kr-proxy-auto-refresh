# KR 免费代理自动刷新报告（2026-07-15T05:50:38+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.861259 | source=`geonode`
- 2. `socks5://218.52.249.121:1080` | `socks5` | `elite` | 200 0.953372 | source=`geonode`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.029040 | source=`niek`
- 4. `http://58.180.17.51:3128` | `http` | `transparent` | 200 1.757515 | source=`proxifly`
