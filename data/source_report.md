# KR 免费代理自动刷新报告（2026-04-29T14:28:20+00:00）
...
- geonode: 69
- iplocate: 1
- monosans_fallback: 143
- monosans_kr_json: 1
- niek: 10
- proxifly: 13
- proxyscrape: 17
- skillter_fallback: 223
- 去重后总候选: 107

## 当前验证通过的代理

- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.687131 | source=`geonode`
- 2. `http://175.194.173.105:3128` | `http` | `elite` | 200 1.354543 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.834871 | source=`monosans_kr_json`
