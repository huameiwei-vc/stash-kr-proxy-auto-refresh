# KR 免费代理自动刷新报告（2026-08-02T18:37:30+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.683071 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.650599 | source=`monosans_kr_json`
- 3. `socks5://43.155.232.123:1080` | `socks5` | `unknown` | 200 1.601183 | source=`monosans_kr_json`
- 4. `socks5://218.52.249.121:1080` | `socks5` | `unknown` | 200 3.871779 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.535822 | source=`monosans_kr_json`
- 6. `http://43.155.232.123:8090` | `http` | `unknown` | 200 2.650356 | source=`monosans_kr_json`
