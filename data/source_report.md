# KR 免费代理自动刷新报告（2026-05-20T23:58:53+00:00）
...
- 1. `socks5://158.179.173.238:1080` | `socks5` | `elite` | 200 0.993457 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.711061 | source=`geonode`
- 3. `socks5://206.123.156.233:6029` | `socks5` | `unknown` | 200 10.743067 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.181802 | source=`monosans_kr_json`
- 5. `http://43.155.206.118:3128` | `http` | `transparent` | 200 6.734091 | source=`proxifly`
