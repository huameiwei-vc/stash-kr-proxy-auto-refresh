# KR 免费代理自动刷新报告（2026-07-23T16:20:43+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.670027 | source=`geonode`
- 2. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 5.997726 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.666918 | source=`monosans_kr_json`
- 4. `socks5://8.213.149.224:1080` | `socks5` | `unknown` | 200 0.670646 | source=`iplocate`
- 5. `http://106.10.55.212:1121` | `http` | `unknown` | 200 0.563340 | source=`niek`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.712184 | source=`monosans_kr_json`
- 7. `http://58.180.17.51:3128` | `http` | `unknown` | 200 1.347234 | source=`monosans_kr_json`
- 8. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 4.675138 | source=`proxifly`
