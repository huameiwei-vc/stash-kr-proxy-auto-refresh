# KR 免费代理自动刷新报告（2026-08-21T08:23:32+00:00）
...
- 1. `http://101.79.29.143:3128` | `http` | `anonymous` | 200 0.542080 | source=`proxyscrape`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.873704 | source=`monosans_kr_json`
- 3. `socks5://150.109.247.86:8443` | `socks5` | `unknown` | 200 3.188723 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.550561 | source=`monosans_kr_json`
- 5. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.672403 | source=`proxifly`
