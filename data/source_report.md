# KR 免费代理自动刷新报告（2026-07-02T23:52:34+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.858375 | source=`geonode`
- 2. `socks5://43.128.150.150:1080` | `socks5` | `elite` | 200 0.898979 | source=`geonode`
- 3. `socks5://3.34.99.7:1080` | `socks5` | `elite` | 200 1.062872 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.986112 | source=`monosans_kr_json`
- 5. `socks5://152.70.241.59:1080` | `socks5` | `transparent` | 200 4.590346 | source=`proxifly`
