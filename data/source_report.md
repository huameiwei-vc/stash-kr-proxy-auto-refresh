# KR 免费代理自动刷新报告（2026-04-11T20:18:04+00:00）
...
- 1. `http://210.223.44.230:3128` | `http` | `unknown` | 200 0.535952 | source=`niek`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.853067 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.769807 | source=`proxifly`
- 4. `socks5://206.123.156.192:15127` | `socks5` | `transparent` | 200 5.262421 | source=`proxifly`
- 5. `socks5://206.123.156.178:4919` | `socks5` | `transparent` | 200 5.493960 | source=`proxifly`
