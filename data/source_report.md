# KR 免费代理自动刷新报告（2026-08-03T23:56:06+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 7.052806 | source=`geonode`
- 2. `socks5://1.245.175.180:1080` | `socks5` | `elite` | 200 10.830983 | source=`proxyscrape`
- 3. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 0.988165 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.776535 | source=`monosans_kr_json`
- 5. `http://121.174.186.199:8080` | `http` | `unknown` | 200 1.414665 | source=`monosans_kr_json`
- 6. `http://211.233.44.58:8080` | `http` | `unknown` | 200 4.413423 | source=`monosans_kr_json`
