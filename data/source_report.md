# KR 免费代理自动刷新报告（2026-09-06T17:42:15+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.566161 | source=`monosans_kr_json`
- 2. `socks4://8.220.245.72:9898` | `socks4` | `unknown` | 200 0.841660 | source=`iplocate`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.921609 | source=`proxifly`
