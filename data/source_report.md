# KR 免费代理自动刷新报告（2026-07-12T14:44:39+00:00）
...
- 1. `socks5://218.52.249.121:1080` | `socks5` | `elite` | 200 0.733542 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.807318 | source=`geonode`
- 3. `http://106.249.44.10:3128` | `http` | `elite` | 200 0.655434 | source=`proxyscrape`
- 4. `socks5://119.28.234.212:1080` | `socks5` | `unknown` | 200 0.786211 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.777461 | source=`monosans_kr_json`
- 6. `http://58.180.17.51:3128` | `http` | `unknown` | 200 2.387646 | source=`monosans_kr_json`
