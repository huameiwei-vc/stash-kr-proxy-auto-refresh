# KR 免费代理自动刷新报告（2026-05-14T18:20:46+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.084656 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.781998 | source=`monosans_kr_json`
- 3. `http://210.223.44.230:3128` | `http` | `unknown` | 200 1.631303 | source=`niek`
- 4. `http://146.56.164.121:3128` | `http` | `transparent` | 200 9.446439 | source=`proxyscrape`
