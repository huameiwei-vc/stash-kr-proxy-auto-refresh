# KR 免费代理自动刷新报告（2026-04-12T22:02:21+00:00）
...
- 1. `socks5://43.133.77.87:1080` | `socks5` | `unknown` | 200 1.140063 | source=`monosans_kr_json`
- 2. `http://122.45.51.68:8887` | `http` | `unknown` | 200 2.072442 | source=`skillter_http`
- 3. `http://122.45.51.68:45680` | `http` | `unknown` | 200 2.389848 | source=`skillter_http`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 3.110890 | source=`monosans_kr_json`
- 5. `http://122.45.51.68:6666` | `http` | `unknown` | 200 8.393619 | source=`skillter_http`
- 6. `http://122.45.51.68:56789` | `http` | `unknown` | 200 8.407969 | source=`skillter_http`
- 7. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.097970 | source=`proxifly`
