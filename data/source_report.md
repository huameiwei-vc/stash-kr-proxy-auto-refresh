# KR 免费代理自动刷新报告（2026-06-30T08:50:27+00:00）
...
- 1. `socks5://152.70.241.59:1080` | `socks5` | `unknown` | 200 1.295868 | source=`iplocate`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.037108 | source=`niek`
- 3. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.959542 | source=`proxifly`
- 4. `socks5://43.128.150.150:1080` | `socks5` | `transparent` | 200 0.966955 | source=`proxifly`
- 5. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.036433 | source=`proxifly`
