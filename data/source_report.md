# KR 免费代理自动刷新报告（2026-05-15T14:42:30+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.005001 | source=`geonode`
- 2. `socks5://158.247.206.191:1080` | `socks5` | `elite` | 200 6.223897 | source=`geonode`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.086101 | source=`monosans_kr_json`
- 4. `http://210.223.44.230:3128` | `http` | `unknown` | 200 3.261545 | source=`niek`
