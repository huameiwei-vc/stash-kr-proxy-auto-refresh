# KR 免费代理自动刷新报告（2026-06-18T13:53:32+00:00）
...
- proxifly: 11
- proxyscrape: 30
- skillter_fallback: 163
- 去重后总候选: 147

## 当前验证通过的代理

- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.894255 | source=`niek`
- 2. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.878824 | source=`proxifly`
