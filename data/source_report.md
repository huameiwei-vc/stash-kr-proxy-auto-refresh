# KR 免费代理自动刷新报告（2026-07-20T18:25:15+00:00）
...
- 1. `socks5://8.213.149.224:1080` | `socks5` | `elite` | 200 0.923195 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.050703 | source=`geonode`
- 3. `socks4://43.133.242.194:888` | `socks4` | `elite` | 200 2.188036 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.926353 | source=`monosans_kr_json`
- 5. `http://211.233.44.58:8080` | `http` | `unknown` | 200 6.775542 | source=`niek`
- 6. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.944289 | source=`proxifly`
- 7. `socks5://206.123.156.220:24761` | `socks5` | `transparent` | 200 11.424182 | source=`proxifly`
