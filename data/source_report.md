# KR 免费代理自动刷新报告（2026-05-01T14:43:51+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.949791 | source=`geonode`
- 2. `socks4://158.247.206.191:1080` | `socks4` | `elite` | 200 2.770526 | source=`proxyscrape`
- 3. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 9.393683 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 7.672405 | source=`monosans_kr_json`
- 5. `http://221.156.27.160:3176` | `http` | `transparent` | 200 1.205880 | source=`proxyscrape`
