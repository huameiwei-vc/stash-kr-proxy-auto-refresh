# KR 免费代理自动刷新报告（2026-07-19T15:37:30+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.909166 | source=`monosans_kr_json`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.889979 | source=`proxifly`
- 3. `http://125.129.15.34:3128` | `http` | `transparent` | 200 0.683163 | source=`proxifly`
- 4. `http://175.194.173.105:3128` | `http` | `transparent` | 200 0.695702 | source=`proxifly`
- 5. `http://58.180.17.51:3128` | `http` | `transparent` | 200 2.424050 | source=`proxyscrape`
- 6. `http://106.10.55.212:1121` | `http` | `transparent` | 200 3.797278 | source=`proxyscrape`
