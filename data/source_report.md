# KR 免费代理自动刷新报告（2026-03-29T23:20:02+00:00）
...
- 1. `socks5://1.225.116.115:1080` | `socks5` | `unknown` | 200 4.399041 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.127537 | source=`monosans_kr_json`
- 3. `http://121.126.185.63:25152` | `http` | `unknown` | 200 1.236691 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.935909 | source=`proxifly`
- 5. `http://140.245.66.105:8081` | `http` | `transparent` | 200 1.064392 | source=`proxyscrape`
