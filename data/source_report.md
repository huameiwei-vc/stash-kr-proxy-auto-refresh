# KR 免费代理自动刷新报告（2026-04-12T18:29:18+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `unknown` | 200 0.925555 | source=`iplocate`
- 2. `socks5://43.133.77.87:1080` | `socks5` | `unknown` | 200 1.692194 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.926209 | source=`monosans_kr_json`
- 4. `http://218.153.163.156:8581` | `http` | `transparent` | 200 1.083470 | source=`proxifly`
