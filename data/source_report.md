# KR 免费代理自动刷新报告（2026-06-08T19:21:05+00:00）
...
- 1. `socks5://52.231.219.53:1433` | `socks5` | `elite` | 200 0.947415 | source=`proxyscrape`
- 2. `socks5://59.11.209.162:1080` | `socks5` | `elite` | 200 1.159110 | source=`proxyscrape`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.950994 | source=`geonode`
- 4. `http://169.212.15.161:5000` | `http` | `unknown` | 200 0.972961 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.976923 | source=`monosans_kr_json`
- 6. `http://43.128.145.26:1080` | `http` | `unknown` | 200 2.740433 | source=`monosans_kr_json`
