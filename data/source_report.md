# KR 免费代理自动刷新报告（2026-06-02T06:19:48+00:00）
...
- 1. `socks5://59.11.209.162:1080` | `socks5` | `elite` | 200 1.282178 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.001378 | source=`geonode`
- 3. `socks5://158.247.206.191:1080` | `socks5` | `elite` | 200 2.324852 | source=`geonode`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.051093 | source=`monosans_kr_json`
- 5. `http://43.128.145.26:1080` | `http` | `unknown` | 200 1.333591 | source=`monosans_kr_json`
