# KR 免费代理自动刷新报告（2026-03-30T10:40:07+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.293038 | source=`monosans_kr_json`
- 2. `http://121.126.185.63:25152` | `http` | `unknown` | 200 3.629547 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.090989 | source=`proxifly`
- 4. `http://146.56.182.165:3128` | `http` | `transparent` | 200 5.193484 | source=`proxyscrape`
