# KR 免费代理自动刷新报告（2026-07-18T12:33:52+00:00）
...
- 1. `socks5://218.52.249.121:1080` | `socks5` | `elite` | 200 1.060421 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 4.217022 | source=`geonode`
- 3. `socks5://193.122.105.251:65535` | `socks5` | `elite` | 200 4.802236 | source=`geonode`
- 4. `http://43.131.224.66:80` | `http` | `unknown` | 200 3.704335 | source=`niek`
- 5. `http://1.231.81.166:3128` | `http` | `transparent` | 200 0.727934 | source=`proxyscrape`
- 6. `http://58.180.17.51:3128` | `http` | `transparent` | 200 2.488476 | source=`proxyscrape`
