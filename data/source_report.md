# KR 免费代理自动刷新报告（2026-08-12T12:05:30+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.964621 | source=`geonode`
- 2. `http://150.230.249.56:1080` | `http` | `elite` | 200 0.998858 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.853662 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.696465 | source=`monosans_kr_json`
- 5. `socks5://150.230.249.56:1080` | `socks5` | `transparent` | 200 1.592256 | source=`proxifly`
