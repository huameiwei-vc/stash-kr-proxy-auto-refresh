# KR 免费代理自动刷新报告（2026-08-22T03:52:22+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.936455 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.763884 | source=`monosans_kr_json`
- 3. `http://130.162.144.61:1080` | `http` | `unknown` | 200 1.854897 | source=`niek`
- 4. `socks5://130.162.144.61:1080` | `socks5` | `transparent` | 200 1.105948 | source=`proxifly`
