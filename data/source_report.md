# KR 免费代理自动刷新报告（2026-05-08T18:08:41+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.906818 | source=`geonode`
- 2. `socks4://158.247.193.221:1080` | `socks4` | `elite` | 200 2.736377 | source=`proxyscrape`
- 3. `http://106.10.55.212:1121` | `http` | `transparent` | 200 2.962188 | source=`proxyscrape`
- 4. `http://193.122.96.242:3128` | `http` | `transparent` | 200 5.402281 | source=`geonode`
- 5. `http://1.231.81.166:3128` | `http` | `transparent` | 200 6.886788 | source=`proxyscrape`
