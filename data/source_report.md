# KR 免费代理自动刷新报告（2026-08-23T15:21:17+00:00）
...
- 1. `http://152.67.207.34:1080` | `http` | `elite` | 200 1.417970 | source=`proxyscrape`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 4.522947 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.769023 | source=`monosans_kr_json`
- 4. `socks5://152.67.207.34:1080` | `socks5` | `transparent` | 200 2.031179 | source=`proxifly`
