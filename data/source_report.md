# KR 免费代理自动刷新报告（2026-08-26T11:17:05+00:00）
...
- 1. `socks5://152.67.221.233:8008` | `socks5` | `elite` | 200 6.499417 | source=`proxyscrape`
- 2. `http://112.216.54.226:12121` | `http` | `elite` | 200 0.707083 | source=`geonode`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.865379 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.535794 | source=`monosans_kr_json`
