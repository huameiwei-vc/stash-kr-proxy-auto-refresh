# KR 免费代理自动刷新报告（2026-03-30T16:31:31+00:00）
...
- 1. `http://121.126.185.63:25152` | `http` | `unknown` | 200 1.008974 | source=`monosans_kr_json`
- 2. `http://106.10.55.212:1121` | `http` | `unknown` | 200 4.617555 | source=`skillter_http`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.756910 | source=`proxifly`
