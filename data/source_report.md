# KR 免费代理自动刷新报告（2026-05-23T01:26:00+00:00）
...
- 1. `socks5://158.247.193.221:1080` | `socks5` | `elite` | 200 10.267309 | source=`proxyscrape`
- 2. `http://210.223.44.230:3128` | `http` | `anonymous` | 200 1.805748 | source=`geonode`
- 3. `socks5://158.247.206.191:1080` | `socks5` | `unknown` | 200 1.575784 | source=`iplocate`
- 4. `socks5://158.179.173.238:1080` | `socks5` | `unknown` | 200 4.008461 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.358382 | source=`monosans_kr_json`
- 6. `http://106.10.55.212:1121` | `http` | `unknown` | 200 3.863744 | source=`monosans_kr_json`
- 7. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.230152 | source=`proxifly`
