# KR 免费代理自动刷新报告（2026-05-01T11:20:47+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.922669 | source=`geonode`
- 2. `socks5://152.70.237.238:3128` | `socks5` | `unknown` | 200 2.897659 | source=`monosans_kr_json`
- 3. `http://221.156.27.160:3060` | `http` | `transparent` | 200 1.192240 | source=`proxyscrape`
