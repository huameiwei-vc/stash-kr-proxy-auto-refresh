# KR 免费代理自动刷新报告（2026-08-22T16:36:20+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 3.564127 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 7.171282 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.652590 | source=`monosans_kr_json`
- 4. `http://47.80.26.236:8080` | `http` | `unknown` | 200 10.744527 | source=`niek`
