# KR 免费代理自动刷新报告（2026-04-05T11:27:04+00:00）
...
- 1. `http://1.234.153.14:80` | `http` | `anonymous` | 200 6.606311 | source=`proxyscrape`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.198553 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.580714 | source=`proxifly`
