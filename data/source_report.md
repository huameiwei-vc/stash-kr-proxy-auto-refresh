# KR 免费代理自动刷新报告（2026-06-04T19:34:44+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.997251 | source=`geonode`
- 2. `socks5://150.230.249.50:1080` | `socks5` | `elite` | 200 5.855345 | source=`geonode`
- 3. `socks5://158.179.173.238:1080` | `socks5` | `elite` | 200 7.398088 | source=`proxyscrape`
- 4. `http://43.128.145.26:1080` | `http` | `unknown` | 200 0.589054 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 3.168607 | source=`monosans_kr_json`
- 6. `http://150.230.249.50:1080` | `http` | `unknown` | 200 3.514026 | source=`monosans_kr_json`
- 7. `socks4://146.56.191.98:14785` | `socks4` | `unknown` | 200 11.021514 | source=`iplocate`
- 8. `socks5://59.11.209.162:1080` | `socks5` | `transparent` | 200 0.965630 | source=`proxifly`
- 9. `socks5://150.109.81.35:1080` | `socks5` | `transparent` | 200 2.798639 | source=`proxifly`
