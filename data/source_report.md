# KR 免费代理自动刷新报告（2026-06-26T22:21:45+00:00）
...
- 1. `socks5://152.70.241.59:1080` | `socks5` | `elite` | 200 1.391597 | source=`proxyscrape`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.819330 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.544720 | source=`proxifly`
- 4. `socks5://206.123.156.227:9868` | `socks5` | `transparent` | 200 10.126981 | source=`proxifly`
