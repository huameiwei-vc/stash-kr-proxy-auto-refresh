# KR 免费代理自动刷新报告（2026-05-07T15:34:22+00:00）
...
- 1. `socks5://47.80.9.115:1080` | `socks5` | `elite` | 200 0.947176 | source=`proxyscrape`
- 2. `socks5://152.70.91.193:40000` | `socks5` | `elite` | 200 1.963177 | source=`geonode`
- 3. `socks4://47.80.9.115:1080` | `socks4` | `elite` | 200 0.746299 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 9.187088 | source=`niek`
