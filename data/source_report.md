# KR 免费代理自动刷新报告（2026-04-26T11:59:30+00:00）
...
- 1. `http://43.133.90.161:8888` | `http` | `unknown` | 200 1.947668 | source=`niek`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 5.372900 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.631225 | source=`proxifly`
