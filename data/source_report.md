# KR 免费代理自动刷新报告（2026-07-25T22:14:08+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.889997 | source=`geonode`
- 2. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 8.600467 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.714618 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.743801 | source=`monosans_kr_json`
- 5. `socks5://8.213.149.224:1080` | `socks5` | `transparent` | 200 0.728680 | source=`proxifly`
- 6. `socks5://52.78.144.96:1080` | `socks5` | `transparent` | 200 1.080729 | source=`proxifly`
- 7. `http://13.209.192.128:3129` | `http` | `transparent` | 200 5.066719 | source=`proxyscrape`
