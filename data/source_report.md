# KR 免费代理自动刷新报告（2026-08-23T14:59:48+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 3.775869 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.933313 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.802463 | source=`monosans_kr_json`
- 4. `http://124.61.132.233:4444` | `http` | `unknown` | 200 1.003012 | source=`monosans_kr_json`
- 5. `socks5://152.67.207.34:1080` | `socks5` | `transparent` | 200 2.475977 | source=`proxifly`
