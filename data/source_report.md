# KR 免费代理自动刷新报告（2026-08-25T20:44:16+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.179940 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.212385 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.762739 | source=`niek`
- 4. `http://61.110.23.137:3128` | `http` | `unknown` | 200 2.000779 | source=`monosans_kr_json`
