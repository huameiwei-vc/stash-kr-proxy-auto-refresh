# KR 免费代理自动刷新报告（2026-06-20T13:10:41+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.686288 | source=`geonode`
- 2. `socks4://146.56.191.98:14785` | `socks4` | `elite` | 200 2.491604 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.839731 | source=`monosans_kr_json`
- 4. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.693517 | source=`proxifly`
- 5. `http://112.186.12.196:3128` | `http` | `transparent` | 200 5.232418 | source=`proxyscrape`
