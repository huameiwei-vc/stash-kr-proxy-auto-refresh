# KR 免费代理自动刷新报告（2026-05-09T19:19:16+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.277638 | source=`geonode`
- 2. `socks5://27.102.134.31:1081` | `socks5` | `elite` | 200 6.274401 | source=`proxyscrape`
- 3. `http://27.102.134.30:1080` | `http` | `elite` | 200 9.356367 | source=`proxyscrape`
- 4. `http://27.102.134.32:1080` | `http` | `elite` | 200 9.496726 | source=`proxyscrape`
- 5. `socks4://27.102.134.31:1080` | `socks4` | `elite` | 200 2.920330 | source=`proxyscrape`
- 6. `socks5://152.70.91.193:40000` | `socks5` | `unknown` | 200 1.608425 | source=`monosans_kr_json`
- 7. `socks5://27.102.134.31:1090` | `socks5` | `unknown` | 200 2.787958 | source=`monosans_kr_json`
- 8. `http://1.231.81.166:3128` | `http` | `unknown` | 200 7.870889 | source=`niek`
- 9. `http://27.102.134.31:1080` | `http` | `unknown` | 200 11.465671 | source=`monosans_kr_json`
