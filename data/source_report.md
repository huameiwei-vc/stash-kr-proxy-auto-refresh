# KR 免费代理自动刷新报告（2026-07-06T11:00:51+00:00）
...
- 1. `socks5://152.70.241.59:1080` | `socks5` | `elite` | 200 1.385610 | source=`geonode`
- 2. `socks5://43.128.150.150:1080` | `socks5` | `elite` | 200 1.500559 | source=`geonode`
- 3. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 2.798370 | source=`proxyscrape`
- 4. `socks5://1.245.175.180:1080` | `socks5` | `elite` | 200 8.401982 | source=`geonode`
- 5. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 9.235944 | source=`geonode`
- 6. `socks5://221.152.171.202:9050` | `socks5` | `unknown` | 200 1.748717 | source=`monosans_kr_json`
- 7. `socks5://218.52.249.121:1080` | `socks5` | `unknown` | 200 4.876553 | source=`iplocate`
- 8. `http://220.95.121.83:1521` | `http` | `unknown` | 200 0.908954 | source=`monosans_kr_json`
- 9. `http://220.95.64.74:1521` | `http` | `unknown` | 200 0.938292 | source=`monosans_kr_json`
- 10. `http://121.180.75.228:1723` | `http` | `unknown` | 200 0.986104 | source=`niek`
- 11. `http://43.155.138.148:3128` | `http` | `unknown` | 200 3.573545 | source=`monosans_kr_json`
- 12. `http://1.231.81.166:3128` | `http` | `unknown` | 200 5.120780 | source=`monosans_kr_json`
