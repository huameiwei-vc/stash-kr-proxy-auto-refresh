# KR 免费代理自动刷新报告（2026-08-07T12:06:49+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.798223 | source=`geonode`
- 2. `http://211.233.44.58:8080` | `http` | `elite` | 200 1.058449 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.787243 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.682750 | source=`monosans_kr_json`
- 5. `http://183.101.185.89:20002` | `http` | `unknown` | 200 0.949809 | source=`monosans_kr_json`
