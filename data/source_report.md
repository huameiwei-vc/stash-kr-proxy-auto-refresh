# KR 免费代理自动刷新报告（2026-05-03T19:15:10+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.977886 | source=`geonode`
- 2. `socks4://158.247.241.3:1080` | `socks4` | `elite` | 200 3.973425 | source=`proxyscrape`
- 3. `socks5://193.123.250.39:1080` | `socks5` | `unknown` | 200 2.281696 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.109988 | source=`monosans_kr_json`
- 5. `http://193.123.250.39:1080` | `http` | `unknown` | 200 6.915797 | source=`monosans_kr_json`
