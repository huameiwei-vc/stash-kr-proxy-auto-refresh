# KR 免费代理自动刷新报告（2026-04-14T23:01:24+00:00）
...
- 1. `http://210.223.44.230:3128` | `http` | `anonymous` | 200 2.588604 | source=`proxyscrape`
- 2. `socks5://123.214.62.25:6881` | `socks5` | `unknown` | 200 1.163316 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 4.739125 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.150258 | source=`proxifly`
- 5. `socks5://1.225.116.115:1080` | `socks5` | `transparent` | 200 1.186409 | source=`proxifly`
