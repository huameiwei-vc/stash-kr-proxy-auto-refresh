# KR 免费代理自动刷新报告（2026-04-12T16:25:42+00:00）
...
- proxifly: 9
- proxyscrape: 11
- skillter_fallback: 239
- 去重后总候选: 50

## 当前验证通过的代理

- 1. `socks5://43.133.77.87:1080` | `socks5` | `unknown` | 200 1.173659 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.990923 | source=`monosans_kr_json`
