# KR 免费代理自动刷新报告（2026-08-24T09:00:33+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.810600 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.661110 | source=`monosans_kr_json`
- 3. `http://111.119.162.248:10940` | `http` | `unknown` | 200 6.333969 | source=`monosans_kr_json`
