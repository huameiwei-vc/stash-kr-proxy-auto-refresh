# KR 免费代理自动刷新报告（2026-08-13T15:35:03+00:00）
...
- 1. `socks5://52.78.144.96:1080` | `socks5` | `elite` | 200 1.032369 | source=`proxyscrape`
- 2. `http://211.233.44.58:8080` | `http` | `elite` | 200 7.980004 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 2.025403 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.647424 | source=`monosans_kr_json`
- 5. `http://112.216.54.226:12121` | `http` | `unknown` | 200 0.849627 | source=`monosans_kr_json`
