# KR 免费代理自动刷新报告（2026-07-19T20:34:51+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.089567 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.859354 | source=`monosans_kr_json`
- 3. `http://58.180.17.51:3128` | `http` | `unknown` | 200 3.466670 | source=`monosans_kr_json`
- 4. `http://47.80.60.84:3128` | `http` | `transparent` | 200 2.948416 | source=`proxifly`
