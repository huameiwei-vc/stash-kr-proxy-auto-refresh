# KR 免费代理自动刷新报告（2026-06-07T21:58:14+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.856996 | source=`geonode`
- 2. `socks5://1.245.175.180:1080` | `socks5` | `elite` | 200 1.041802 | source=`proxyscrape`
- 3. `http://169.212.15.161:5000` | `http` | `elite` | 200 0.927367 | source=`proxyscrape`
- 4. `http://43.128.145.26:1080` | `http` | `unknown` | 200 1.334114 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 8.870022 | source=`niek`
- 6. `socks5://59.11.209.162:1080` | `socks5` | `transparent` | 200 1.124035 | source=`proxifly`
