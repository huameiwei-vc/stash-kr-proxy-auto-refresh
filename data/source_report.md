# KR 免费代理自动刷新报告（2026-04-12T01:29:54+00:00）
...
- 1. `socks5://206.123.156.209:5467` | `socks5` | `unknown` | 200 6.246710 | source=`iplocate`
- 2. `socks5://206.123.156.184:4045` | `socks5` | `unknown` | 200 6.700771 | source=`iplocate`
- 3. `socks5://206.123.156.226:8200` | `socks5` | `unknown` | 200 8.527308 | source=`iplocate`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.718453 | source=`monosans_kr_json`
- 5. `http://1.225.116.115:1080` | `http` | `unknown` | 200 2.505250 | source=`monosans_kr_json`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.961945 | source=`proxifly`
- 7. `socks5://206.123.156.233:7199` | `socks5` | `transparent` | 200 5.153205 | source=`proxifly`
- 8. `http://146.56.182.165:3128` | `http` | `transparent` | 200 4.448732 | source=`proxyscrape`
