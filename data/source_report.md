# KR 免费代理自动刷新报告（2026-07-21T18:53:04+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 4.895078 | source=`geonode`
- 2. `http://8.220.216.57:3128` | `http` | `elite` | 200 6.387697 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.880325 | source=`monosans_kr_json`
- 4. `http://58.180.17.51:3128` | `http` | `unknown` | 200 1.102650 | source=`monosans_kr_json`
- 5. `http://211.233.44.58:8080` | `http` | `unknown` | 200 7.570637 | source=`niek`
- 6. `socks5://8.213.149.224:1080` | `socks5` | `transparent` | 200 0.853335 | source=`proxifly`
