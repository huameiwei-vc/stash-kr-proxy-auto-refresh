# KR 免费代理自动刷新报告（2026-06-08T05:08:32+00:00）
...
- 1. `socks5://59.11.209.162:1080` | `socks5` | `elite` | 200 0.969044 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.157144 | source=`geonode`
- 3. `http://43.128.145.26:1080` | `http` | `unknown` | 200 0.629202 | source=`niek`
- 4. `http://169.212.15.161:5000` | `http` | `unknown` | 200 1.145888 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.455576 | source=`monosans_kr_json`
- 6. `http://49.128.211.157:3128` | `http` | `transparent` | 200 0.557984 | source=`proxyscrape`
