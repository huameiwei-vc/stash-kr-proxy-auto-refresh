# KR 免费代理自动刷新报告（2026-06-20T23:23:08+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.094001 | source=`geonode`
- 2. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 4.691726 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.001551 | source=`monosans_kr_json`
- 4. `http://125.135.163.211:3144` | `http` | `transparent` | 200 1.256036 | source=`proxyscrape`
- 5. `http://125.135.136.210:3024` | `http` | `transparent` | 200 2.274499 | source=`proxyscrape`
