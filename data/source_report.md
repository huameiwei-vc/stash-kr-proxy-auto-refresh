# KR 免费代理自动刷新报告（2026-07-11T18:04:48+00:00）
...
- 1. `socks5://218.52.249.121:1080` | `socks5` | `elite` | 200 0.986539 | source=`geonode`
- 2. `socks5://119.28.234.212:1080` | `socks5` | `elite` | 200 1.006334 | source=`geonode`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 4.372710 | source=`geonode`
- 4. `http://211.233.44.58:8080` | `http` | `elite` | 200 1.418078 | source=`proxyscrape`
- 5. `http://43.164.129.36:3128` | `http` | `elite` | 200 6.804705 | source=`proxyscrape`
- 6. `http://106.249.44.10:3128` | `http` | `unknown` | 200 0.826108 | source=`niek`
- 7. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.003726 | source=`niek`
- 8. `http://168.126.169.198:808` | `http` | `unknown` | 200 3.956866 | source=`niek`
- 9. `http://58.180.17.51:3128` | `http` | `transparent` | 200 1.221549 | source=`proxifly`
- 10. `http://47.80.60.84:3128` | `http` | `transparent` | 200 6.988604 | source=`proxifly`
