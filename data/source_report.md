# KR 免费代理自动刷新报告（2026-06-13T04:46:18+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.472048 | source=`geonode`
- 2. `socks5://193.123.254.182:1080` | `socks5` | `elite` | 200 3.753747 | source=`proxyscrape`
- 3. `socks5://206.123.156.227:7617` | `socks5` | `unknown` | 200 7.956870 | source=`iplocate`
- 4. `socks5://206.123.156.227:11966` | `socks5` | `unknown` | 200 10.736105 | source=`iplocate`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.954668 | source=`monosans_kr_json`
- 6. `http://169.212.15.161:5000` | `http` | `unknown` | 200 4.480699 | source=`monosans_kr_json`
- 7. `socks5://206.123.156.209:6536` | `socks5` | `transparent` | 200 4.512127 | source=`proxifly`
- 8. `socks5://206.123.156.220:10186` | `socks5` | `transparent` | 200 5.035454 | source=`proxifly`
- 9. `socks5://158.179.173.238:1080` | `socks5` | `transparent` | 200 5.469393 | source=`proxifly`
- 10. `socks5://206.123.156.238:10411` | `socks5` | `transparent` | 200 6.155803 | source=`proxifly`
