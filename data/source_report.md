# KR 免费代理自动刷新报告（2026-08-25T16:17:01+00:00）
...
- 1. `socks5://150.109.247.86:8443` | `socks5` | `elite` | 200 0.969650 | source=`proxyscrape`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 2.404833 | source=`monosans_kr_json`
- 3. `socks5://185.204.170.179:1146` | `socks5` | `unknown` | 200 3.859579 | source=`monosans_socks5`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.776699 | source=`monosans_kr_json`
