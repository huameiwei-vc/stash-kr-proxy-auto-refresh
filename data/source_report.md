# KR 免费代理自动刷新报告（2026-05-13T02:47:48+00:00）
...
- 1. `socks5://158.247.206.191:1080` | `socks5` | `elite` | 200 2.557978 | source=`proxyscrape`
- 2. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 3.503926 | source=`proxyscrape`
- 3. `http://210.223.44.230:3128` | `http` | `anonymous` | 200 1.683032 | source=`proxyscrape`
- 4. `socks4://158.247.206.191:1080` | `socks4` | `unknown` | 200 2.739448 | source=`iplocate`
- 5. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.134746 | source=`proxifly`
- 6. `http://106.10.55.212:1121` | `http` | `transparent` | 200 1.393639 | source=`proxyscrape`
