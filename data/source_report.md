# KR 免费代理自动刷新报告（2026-04-30T21:29:43+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 5.425737 | source=`geonode`
- 2. `socks5://193.122.105.251:65535` | `socks5` | `elite` | 200 5.795979 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.931526 | source=`monosans_kr_json`
- 4. `http://146.56.164.121:3128` | `http` | `unknown` | 200 1.001498 | source=`niek`
