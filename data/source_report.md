# KR 免费代理自动刷新报告（2026-08-25T22:18:11+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.425796 | source=`geonode`
- 2. `http://112.216.54.226:12121` | `http` | `elite` | 200 0.797145 | source=`geonode`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.750019 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.652497 | source=`monosans_kr_json`
- 5. `http://61.110.23.137:3128` | `http` | `unknown` | 200 3.695069 | source=`monosans_kr_json`
