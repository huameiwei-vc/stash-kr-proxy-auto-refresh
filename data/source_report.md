# KR 免费代理自动刷新报告（2026-05-03T18:02:29+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.153751 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.038389 | source=`monosans_kr_json`
- 3. `http://193.123.250.39:1080` | `http` | `unknown` | 200 2.472910 | source=`monosans_kr_json`
