# KR 免费代理自动刷新报告（2026-08-22T03:06:05+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `elite` | 200 0.933211 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.757392 | source=`monosans_kr_json`
- 3. `http://130.162.144.61:1080` | `http` | `unknown` | 200 1.816053 | source=`niek`
- 4. `http://112.216.54.226:12121` | `http` | `unknown` | 200 1.988007 | source=`niek`
- 5. `socks5://130.162.144.61:1080` | `socks5` | `transparent` | 200 4.674780 | source=`proxifly`
