# KR 免费代理自动刷新报告（2026-04-23T23:10:18+00:00）
...
- 1. `socks5://158.247.206.191:1080` | `socks5` | `elite` | 200 1.850161 | source=`proxyscrape`
- 2. `socks5://152.70.91.193:40000` | `socks5` | `elite` | 200 2.312904 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.753222 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.178900 | source=`proxifly`
- 5. `http://121.177.17.179:3124` | `http` | `transparent` | 200 2.004831 | source=`proxyscrape`
