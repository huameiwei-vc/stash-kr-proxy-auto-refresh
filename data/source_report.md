# KR 免费代理自动刷新报告（2026-08-12T05:10:19+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.669754 | source=`geonode`
- 2. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 3.821658 | source=`proxyscrape`
- 3. `http://211.233.44.58:8080` | `http` | `elite` | 200 8.623226 | source=`proxyscrape`
- 4. `socks5://47.80.27.150:1080` | `socks5` | `unknown` | 200 0.660468 | source=`monosans_kr_json`
- 5. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.865139 | source=`monosans_kr_json`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.539094 | source=`monosans_kr_json`
