# KR 免费代理自动刷新报告（2026-08-26T10:48:44+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.646445 | source=`geonode`
- 2. `socks5://152.67.221.233:8008` | `socks5` | `elite` | 200 2.594041 | source=`proxyscrape`
- 3. `http://112.216.54.226:12121` | `http` | `elite` | 200 0.681808 | source=`geonode`
- 4. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.466968 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.510630 | source=`monosans_kr_json`
- 6. `http://211.217.231.234:8080` | `http` | `transparent` | 200 3.155969 | source=`proxifly`
