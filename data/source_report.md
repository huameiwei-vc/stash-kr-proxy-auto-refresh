# KR 免费代理自动刷新报告（2026-08-30T20:00:38+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.485276 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.533244 | source=`monosans_kr_json`
- 3. `http://43.164.136.235:3128` | `http` | `unknown` | 200 0.694130 | source=`monosans_kr_json`
- 4. `http://43.200.174.95:34728` | `http` | `unknown` | 200 6.019535 | source=`iplocate`
- 5. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.672112 | source=`proxifly`
