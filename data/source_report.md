# KR 免费代理自动刷新报告（2026-04-28T01:19:59+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `unknown` | 200 0.977014 | source=`monosans_kr_json`
- 2. `socks5://43.133.90.161:8088` | `socks5` | `unknown` | 200 2.020980 | source=`iplocate`
- 3. `http://43.133.90.161:8888` | `http` | `unknown` | 200 7.472708 | source=`niek`
- 4. `http://221.156.27.160:3068` | `http` | `transparent` | 200 4.272651 | source=`proxyscrape`
- 5. `http://1.231.81.166:3128` | `http` | `transparent` | 200 11.963632 | source=`proxyscrape`
