# KR 免费代理自动刷新报告（2026-08-15T21:09:55+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.334608 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `elite` | 200 5.250671 | source=`geonode`
- 3. `socks5://111.119.162.248:10940` | `socks5` | `unknown` | 200 2.784716 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.663534 | source=`monosans_kr_json`
- 5. `http://124.61.132.233:4444` | `http` | `unknown` | 200 0.875908 | source=`monosans_kr_json`
- 6. `http://132.226.171.101:3128` | `http` | `transparent` | 200 2.211194 | source=`proxifly`
