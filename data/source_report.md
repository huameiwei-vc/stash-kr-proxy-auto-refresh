# KR 免费代理自动刷新报告（2026-05-19T22:05:23+00:00）
...
- 1. `socks5://158.247.212.189:1080` | `socks5` | `elite` | 200 5.946492 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 5.989004 | source=`geonode`
- 3. `socks5://206.123.156.217:5661` | `socks5` | `unknown` | 200 7.473191 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.004322 | source=`monosans_kr_json`
- 5. `http://43.155.138.148:3128` | `http` | `unknown` | 200 9.246285 | source=`monosans_kr_json`
