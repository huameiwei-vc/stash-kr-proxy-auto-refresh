# KR 免费代理自动刷新报告（2026-03-29T22:17:04+00:00）
...
- iplocate: 0
- iplocate_error: 0
- monosans_fallback: 92
- monosans_kr_json: 1
- niek: 3
- proxifly: 9
- proxyscrape: 19
- skillter_fallback: 228
- 去重后总候选: 53

## 当前验证通过的代理

- 1. `http://1.225.116.115:1080` | `http` | `unknown` | 200 0.563141 | source=`skillter_http`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 4.162900 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.743033 | source=`proxifly`
- 4. `http://121.126.185.63:25152` | `http` | `transparent` | 200 4.059704 | source=`proxifly`
