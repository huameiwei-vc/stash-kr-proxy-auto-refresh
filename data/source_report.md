# KR 免费代理自动刷新报告（2026-08-22T20:35:39+00:00）
...
- 1. `socks5://193.122.105.251:65535` | `socks5` | `elite` | 200 0.898242 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.729872 | source=`geonode`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.715403 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.645254 | source=`monosans_kr_json`
- 5. `socks5://203.227.191.4:10809` | `socks5` | `transparent` | 200 0.747134 | source=`proxifly`
