# KR 免费代理自动刷新报告（2026-08-06T09:48:03+00:00）
...
- 1. `socks5://152.67.217.8:1080` | `socks5` | `elite` | 200 0.944872 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.361423 | source=`geonode`
- 3. `socks5://218.52.249.121:1080` | `socks5` | `unknown` | 200 0.915896 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.645604 | source=`monosans_kr_json`
- 5. `http://152.67.217.8:1080` | `http` | `unknown` | 200 0.802271 | source=`niek`
