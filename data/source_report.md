# KR 免费代理自动刷新报告（2026-08-23T13:31:39+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.872193 | source=`geonode`
- 2. `http://152.67.207.34:1080` | `http` | `elite` | 200 0.790986 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 2.080332 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.719799 | source=`monosans_kr_json`
- 5. `socks5://152.67.207.34:1080` | `socks5` | `transparent` | 200 1.021593 | source=`proxifly`
