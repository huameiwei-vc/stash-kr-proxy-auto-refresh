# KR 免费代理自动刷新报告（2026-06-21T06:30:40+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.705135 | source=`geonode`
- 2. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 4.887837 | source=`proxyscrape`
- 3. `socks5://206.123.156.235:8155` | `socks5` | `unknown` | 200 5.167443 | source=`iplocate`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.001734 | source=`niek`
- 5. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.979764 | source=`proxifly`
