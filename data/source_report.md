# KR 免费代理自动刷新报告（2026-07-01T06:42:59+00:00）
...
- 1. `socks5://152.70.241.59:1080` | `socks5` | `elite` | 200 1.496474 | source=`geonode`
- 2. `socks5://43.128.150.150:1080` | `socks5` | `unknown` | 200 0.887489 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.880576 | source=`niek`
- 4. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.898624 | source=`proxifly`
- 5. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.788578 | source=`proxifly`
