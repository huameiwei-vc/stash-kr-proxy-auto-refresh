# KR 免费代理自动刷新报告（2026-08-22T07:50:20+00:00）
...
- 1. `socks5://61.111.131.202:1088` | `socks5` | `elite` | 200 8.069058 | source=`proxyscrape`
- 2. `socks4://61.111.131.202:1088` | `socks4` | `elite` | 200 5.325816 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.120137 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.765701 | source=`monosans_kr_json`
- 5. `http://112.216.54.226:12121` | `http` | `unknown` | 200 0.943342 | source=`monosans_kr_json`
