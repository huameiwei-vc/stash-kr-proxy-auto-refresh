# KR 免费代理自动刷新报告（2026-08-10T08:48:30+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.879473 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.067616 | source=`monosans_kr_json`
- 3. `http://183.101.185.89:20002` | `http` | `unknown` | 200 8.609883 | source=`niek`
