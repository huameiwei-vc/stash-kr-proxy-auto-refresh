# KR 免费代理自动刷新报告（2026-05-07T21:35:07+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.886618 | source=`geonode`
- 2. `socks4://47.80.9.115:1080` | `socks4` | `elite` | 200 0.695394 | source=`proxyscrape`
- 3. `socks5://47.80.9.115:1080` | `socks5` | `unknown` | 200 0.847379 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.298271 | source=`monosans_kr_json`
- 5. `http://210.223.44.230:3128` | `http` | `unknown` | 200 5.497033 | source=`niek`
