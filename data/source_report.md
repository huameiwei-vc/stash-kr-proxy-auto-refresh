# KR 免费代理自动刷新报告（2026-08-03T08:02:26+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.884293 | source=`geonode`
- 2. `socks4://1.245.175.180:1080` | `socks4` | `elite` | 200 2.098791 | source=`proxyscrape`
- 3. `socks5://218.52.249.121:1080` | `socks5` | `unknown` | 200 0.807147 | source=`monosans_kr_json`
- 4. `socks5://43.155.232.123:1080` | `socks5` | `unknown` | 200 0.837740 | source=`monosans_kr_json`
- 5. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.999301 | source=`monosans_kr_json`
- 6. `socks5://114.218.160.53:19080` | `socks5` | `unknown` | 200 3.345660 | source=`monosans_kr_json`
- 7. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.654381 | source=`monosans_kr_json`
- 8. `http://43.155.232.123:8090` | `http` | `unknown` | 200 0.660582 | source=`monosans_kr_json`
- 9. `http://211.233.44.58:8080` | `http` | `unknown` | 200 3.680849 | source=`monosans_kr_json`
