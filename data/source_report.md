# KR 免费代理自动刷新报告（2026-06-27T17:57:27+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.020821 | source=`monosans_kr_json`
- 2. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.935664 | source=`proxifly`
- 3. `socks5://152.70.241.59:1080` | `socks5` | `transparent` | 200 1.314464 | source=`proxifly`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 4.130267 | source=`proxifly`
- 5. `socks5://206.123.156.218:6580` | `socks5` | `transparent` | 200 8.619900 | source=`proxifly`
- 6. `socks5://206.123.156.223:8109` | `socks5` | `transparent` | 200 10.167611 | source=`proxifly`
