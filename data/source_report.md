# KR 免费代理自动刷新报告（2026-08-19T23:33:30+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.680284 | source=`geonode`
- 2. `socks5://1.245.175.180:1080` | `socks5` | `elite` | 200 0.909089 | source=`proxyscrape`
- 3. `http://112.216.54.226:12121` | `http` | `elite` | 200 0.682377 | source=`geonode`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.509153 | source=`monosans_kr_json`
