# KR 免费代理自动刷新报告（2026-04-29T12:01:04+00:00）
...
- 1. `socks5://152.70.91.193:40000` | `socks5` | `elite` | 200 0.933910 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.842387 | source=`geonode`
- 3. `socks5://158.247.206.191:1080` | `socks5` | `elite` | 200 2.142420 | source=`proxyscrape`
- 4. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 1.694461 | source=`proxyscrape`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.758365 | source=`monosans_kr_json`
- 6. `socks5://43.133.90.161:8088` | `socks5` | `transparent` | 200 3.172854 | source=`proxifly`
