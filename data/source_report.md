# KR 免费代理自动刷新报告（2026-04-11T23:26:19+00:00）
...
- 1. `http://1.234.153.14:80` | `http` | `anonymous` | 200 7.006434 | source=`proxyscrape`
- 2. `socks5://1.225.116.115:1080` | `socks5` | `unknown` | 200 1.885134 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.971747 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.115814 | source=`proxifly`
- 5. `socks5://206.123.156.223:7526` | `socks5` | `transparent` | 200 7.928220 | source=`proxifly`
- 6. `http://121.177.154.16:3176` | `http` | `transparent` | 200 1.090459 | source=`proxyscrape`
