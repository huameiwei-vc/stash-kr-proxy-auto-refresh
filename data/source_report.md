# KR 免费代理自动刷新报告（2026-08-15T03:00:56+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.140730 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.767784 | source=`monosans_kr_json`
- 3. `http://112.216.54.226:12121` | `http` | `unknown` | 200 0.992098 | source=`niek`
- 4. `socks5://47.80.27.150:1080` | `socks5` | `transparent` | 200 0.956148 | source=`proxifly`
- 5. `http://132.226.171.101:3128` | `http` | `transparent` | 200 2.975532 | source=`proxifly`
