# KR 免费代理自动刷新报告（2026-08-25T23:56:23+00:00）
...
- 1. `socks5://130.162.144.61:1080` | `socks5` | `elite` | 200 0.721665 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.424312 | source=`geonode`
- 3. `http://130.162.144.61:1080` | `http` | `elite` | 200 0.600628 | source=`proxyscrape`
- 4. `http://112.216.54.226:12121` | `http` | `elite` | 200 0.763754 | source=`geonode`
- 5. `http://14.34.180.21:38157` | `http` | `elite` | 200 3.469139 | source=`geonode`
- 6. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.721099 | source=`monosans_kr_json`
- 7. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.641363 | source=`monosans_kr_json`
