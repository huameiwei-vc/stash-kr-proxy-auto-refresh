# KR 免费代理自动刷新报告（2026-06-02T10:59:16+00:00）
...
- 1. `socks5://150.230.249.50:1080` | `socks5` | `elite` | 200 0.665864 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.370983 | source=`geonode`
- 3. `socks5://193.122.105.251:65535` | `socks5` | `elite` | 200 1.679390 | source=`geonode`
- 4. `socks5://158.180.77.24:1080` | `socks5` | `elite` | 200 6.494443 | source=`proxyscrape`
- 5. `http://175.198.235.18:3128` | `http` | `unknown` | 200 0.537775 | source=`iplocate`
- 6. `http://43.128.145.26:1080` | `http` | `unknown` | 200 0.539830 | source=`monosans_kr_json`
- 7. `socks5://218.148.230.126:1080` | `socks5` | `transparent` | 200 0.692609 | source=`proxifly`
- 8. `socks5://59.11.209.162:1080` | `socks5` | `transparent` | 200 1.068165 | source=`proxifly`
- 9. `http://146.56.182.165:3128` | `http` | `transparent` | 200 1.542034 | source=`proxifly`
