# KR 免费代理自动刷新报告（2026-05-31T15:57:54+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.772012 | source=`geonode`
- 2. `socks5://152.70.91.193:40000` | `socks5` | `elite` | 200 1.208393 | source=`proxyscrape`
- 3. `socks5://193.122.105.251:65535` | `socks5` | `elite` | 200 1.642328 | source=`geonode`
- 4. `socks5://158.247.206.191:1080` | `socks5` | `elite` | 200 4.872017 | source=`geonode`
- 5. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 5.369424 | source=`proxyscrape`
- 6. `socks4://158.247.240.61:1080` | `socks4` | `elite` | 200 1.550060 | source=`proxyscrape`
- 7. `socks4://158.247.193.221:1080` | `socks4` | `elite` | 200 2.311155 | source=`proxyscrape`
- 8. `http://210.223.44.230:3128` | `http` | `anonymous` | 200 2.939668 | source=`proxyscrape`
- 9. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.816878 | source=`monosans_kr_json`
- 10. `http://43.128.145.26:1080` | `http` | `unknown` | 200 2.461547 | source=`monosans_kr_json`
- 11. `http://43.155.238.7:3128` | `http` | `unknown` | 200 3.136840 | source=`niek`
- 12. `socks5://59.11.209.162:1080` | `socks5` | `transparent` | 200 0.888743 | source=`proxifly`
