# KR 免费代理自动刷新报告（2026-08-14T11:24:07+00:00）
...
- 1. `socks5://43.155.215.149:20000` | `socks5` | `elite` | 200 0.718593 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.527225 | source=`geonode`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 3.108272 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.531110 | source=`monosans_kr_json`
- 5. `http://132.226.171.101:3128` | `http` | `transparent` | 200 8.795882 | source=`proxifly`
