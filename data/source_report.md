# KR 免费代理自动刷新报告（2026-05-22T08:58:13+00:00）
...
- 1. `socks5://158.247.206.191:1080` | `socks5` | `elite` | 200 9.556954 | source=`proxyscrape`
- 2. `http://175.194.173.105:3128` | `http` | `elite` | 200 0.714833 | source=`proxyscrape`
- 3. `socks5://206.123.156.225:8436` | `socks5` | `unknown` | 200 7.072039 | source=`iplocate`
- 4. `socks5://206.123.156.226:4583` | `socks5` | `unknown` | 200 7.344783 | source=`iplocate`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 3.451340 | source=`monosans_kr_json`
- 6. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.922639 | source=`proxifly`
- 7. `http://140.245.66.105:8081` | `http` | `transparent` | 200 2.102395 | source=`proxyscrape`
