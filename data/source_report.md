# KR 免费代理自动刷新报告（2026-08-17T19:41:25+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.976777 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.698677 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.568593 | source=`monosans_kr_json`
- 4. `socks4://152.70.237.238:3128` | `socks4` | `transparent` | 200 6.287228 | source=`proxifly`
