# KR 免费代理自动刷新报告（2026-04-17T19:18:47+00:00）
...
- 1. `socks5://206.123.156.179:4314` | `socks5` | `unknown` | 200 5.123795 | source=`monosans_kr_json`
- 2. `socks5://206.123.156.199:6912` | `socks5` | `unknown` | 200 9.105202 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.827941 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 3.059643 | source=`proxifly`
