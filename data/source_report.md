# KR 免费代理自动刷新报告（2026-07-09T09:56:23+00:00）
...
- 1. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 2.895772 | source=`proxyscrape`
- 2. `socks5://158.179.173.238:1080` | `socks5` | `elite` | 200 8.296727 | source=`proxyscrape`
- 3. `socks4://1.245.175.180:1080` | `socks4` | `elite` | 200 0.681699 | source=`proxyscrape`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `unknown` | 200 3.000042 | source=`iplocate`
- 5. `http://58.180.17.51:3128` | `http` | `unknown` | 200 4.471140 | source=`monosans_kr_json`
- 6. `http://106.10.55.212:1121` | `http` | `unknown` | 200 7.485460 | source=`niek`
