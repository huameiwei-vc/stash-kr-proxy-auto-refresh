# KR 免费代理自动刷新报告（2026-08-10T05:51:04+00:00）
...
- 1. `socks5://112.187.103.74:10808` | `socks5` | `elite` | 200 0.694925 | source=`proxyscrape`
- 2. `http://112.187.103.74:10808` | `http` | `elite` | 200 0.555269 | source=`proxyscrape`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.880541 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.544856 | source=`monosans_kr_json`
- 5. `http://211.233.44.58:8080` | `http` | `unknown` | 200 10.064385 | source=`iplocate`
