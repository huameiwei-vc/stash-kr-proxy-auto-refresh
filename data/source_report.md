# KR 免费代理自动刷新报告（2026-07-04T21:36:44+00:00）
...
- 1. `socks5://43.128.150.150:1080` | `socks5` | `elite` | 200 0.764351 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.223763 | source=`geonode`
- 3. `socks5://152.70.241.59:1080` | `socks5` | `elite` | 200 6.476880 | source=`geonode`
- 4. `http://175.194.173.105:3128` | `http` | `elite` | 200 0.590996 | source=`proxyscrape`
- 5. `http://220.95.121.83:1521` | `http` | `unknown` | 200 0.602675 | source=`monosans_kr_json`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.781976 | source=`monosans_kr_json`
- 7. `http://220.95.64.74:1521` | `http` | `transparent` | 200 0.772416 | source=`proxyscrape`
- 8. `http://121.180.75.228:1723` | `http` | `transparent` | 200 0.815243 | source=`proxyscrape`
