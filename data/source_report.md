# KR 免费代理自动刷新报告（2026-06-21T16:18:37+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.057430 | source=`geonode`
- 2. `socks5://101.33.76.248:1080` | `socks5` | `elite` | 200 1.353617 | source=`proxyscrape`
- 3. `socks5://1.245.175.180:1080` | `socks5` | `elite` | 200 2.217784 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.982080 | source=`monosans_kr_json`
- 5. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.995999 | source=`proxifly`
- 6. `http://119.205.233.238:13128` | `http` | `transparent` | 200 1.097399 | source=`proxifly`
- 7. `http://106.10.55.212:1121` | `http` | `transparent` | 200 1.755706 | source=`proxyscrape`
