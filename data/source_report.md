# KR 免费代理自动刷新报告（2026-07-16T20:31:34+00:00）
...
- 1. `socks5://193.122.105.251:65535` | `socks5` | `elite` | 200 0.738146 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 7.038597 | source=`geonode`
- 3. `http://43.155.222.216:3128` | `http` | `elite` | 200 2.863897 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.714862 | source=`niek`
- 5. `http://211.233.44.58:8080` | `http` | `unknown` | 200 1.830254 | source=`niek`
- 6. `http://193.122.96.242:3128` | `http` | `transparent` | 200 0.560046 | source=`proxyscrape`
- 7. `http://58.180.17.51:3128` | `http` | `transparent` | 200 0.777242 | source=`proxifly`
- 8. `http://106.10.55.212:1121` | `http` | `transparent` | 200 1.963932 | source=`proxyscrape`
