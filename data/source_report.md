# KR 免费代理自动刷新报告（2026-08-22T05:59:01+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.756859 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 11.352028 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.508928 | source=`monosans_kr_json`
- 4. `socks5://65.21.252.66:10808` | `socks5` | `transparent` | 200 2.322699 | source=`proxifly`
