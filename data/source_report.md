# KR 免费代理自动刷新报告（2026-07-17T10:27:29+00:00）
...
- 1. `socks5://218.52.249.121:1080` | `socks5` | `elite` | 200 0.718203 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.760847 | source=`geonode`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.667296 | source=`niek`
- 4. `http://106.10.55.212:1121` | `http` | `transparent` | 200 0.498634 | source=`proxyscrape`
