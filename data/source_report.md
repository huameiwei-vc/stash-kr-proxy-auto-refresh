# KR 免费代理自动刷新报告（2026-04-12T07:42:44+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 5.702375 | source=`monosans_kr_json`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.150262 | source=`proxifly`
- 3. `socks5://206.123.156.209:5782` | `socks5` | `transparent` | 200 7.384311 | source=`proxifly`
- 4. `socks5://206.123.156.207:7920` | `socks5` | `transparent` | 200 8.888687 | source=`proxifly`
- 5. `socks5://206.123.156.199:4954` | `socks5` | `transparent` | 200 9.745438 | source=`proxifly`
