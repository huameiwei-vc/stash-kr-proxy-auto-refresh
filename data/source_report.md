# KR 免费代理自动刷新报告（2026-07-14T21:26:53+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.365210 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.883510 | source=`niek`
- 3. `http://106.10.55.212:1121` | `http` | `transparent` | 200 0.744252 | source=`proxyscrape`
- 4. `http://58.180.17.51:3128` | `http` | `transparent` | 200 1.841423 | source=`proxifly`
- 5. `http://43.201.114.116:3128` | `http` | `transparent` | 200 5.277859 | source=`proxyscrape`
- 6. `http://43.131.224.66:80` | `http` | `transparent` | 200 5.480068 | source=`proxyscrape`
