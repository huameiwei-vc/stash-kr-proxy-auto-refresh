# KR 免费代理自动刷新报告（2026-07-12T13:51:20+00:00）
...
- 1. `socks5://218.52.249.121:1080` | `socks5` | `elite` | 200 0.823842 | source=`geonode`
- 2. `socks5://119.28.234.212:1080` | `socks5` | `elite` | 200 0.846777 | source=`geonode`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.832964 | source=`niek`
- 4. `http://211.233.44.58:8080` | `http` | `unknown` | 200 7.157976 | source=`niek`
- 5. `http://58.180.17.51:3128` | `http` | `transparent` | 200 3.394457 | source=`proxifly`
