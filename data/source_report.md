# KR 免费代理自动刷新报告（2026-06-15T03:32:13+00:00）
...
- 1. `socks5://158.179.173.238:1080` | `socks5` | `elite` | 200 2.120922 | source=`geonode`
- 2. `socks4://211.245.23.166:1080` | `socks4` | `elite` | 200 9.069487 | source=`proxyscrape`
- 3. `http://169.212.15.161:5000` | `http` | `unknown` | 200 1.000096 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.025787 | source=`monosans_kr_json`
- 5. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.507753 | source=`proxifly`
- 6. `http://106.10.55.212:1121` | `http` | `transparent` | 200 0.952975 | source=`proxyscrape`
