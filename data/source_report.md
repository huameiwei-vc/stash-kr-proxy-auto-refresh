# KR 免费代理自动刷新报告（2026-07-14T12:20:57+00:00）
...
- 1. `socks5://218.52.249.121:1080` | `socks5` | `elite` | 200 0.721345 | source=`geonode`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 3.691585 | source=`geonode`
- 3. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 5.205239 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.760697 | source=`monosans_kr_json`
- 5. `http://43.201.114.116:3128` | `http` | `transparent` | 200 0.581270 | source=`proxifly`
