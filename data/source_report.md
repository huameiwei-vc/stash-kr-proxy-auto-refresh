# KR 免费代理自动刷新报告（2026-08-15T19:51:55+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.267367 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.764318 | source=`monosans_kr_json`
- 3. `http://124.61.132.233:4444` | `http` | `unknown` | 200 0.811535 | source=`monosans_kr_json`
- 4. `http://132.226.171.101:3128` | `http` | `transparent` | 200 8.389798 | source=`proxifly`
