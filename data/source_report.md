# KR 免费代理自动刷新报告（2026-04-17T18:01:34+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.884227 | source=`monosans_kr_json`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.558166 | source=`proxifly`
- 3. `socks5://206.123.156.225:38222` | `socks5` | `transparent` | 200 7.766515 | source=`proxifly`
- 4. `socks5://206.123.156.224:4971` | `socks5` | `transparent` | 200 8.679523 | source=`proxifly`
