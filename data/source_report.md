# KR 免费代理自动刷新报告（2026-08-19T04:19:36+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.002925 | source=`geonode`
- 2. `socks5://146.56.185.39:34500` | `socks5` | `elite` | 200 1.170147 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.515066 | source=`monosans_kr_json`
- 4. `socks4://111.48.191.24:7890` | `socks4` | `transparent` | 200 4.649170 | source=`proxifly`
