# KR 免费代理自动刷新报告（2026-05-01T04:13:52+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.098961 | source=`geonode`
- 2. `socks5://152.70.237.238:3128` | `socks5` | `elite` | 200 10.388778 | source=`proxyscrape`
- 3. `http://106.10.55.212:1121` | `http` | `unknown` | 200 0.800200 | source=`niek`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.242084 | source=`monosans_kr_json`
- 5. `http://220.92.130.114:3084` | `http` | `transparent` | 200 9.442646 | source=`proxyscrape`
