# KR 免费代理自动刷新报告（2026-08-01T19:49:47+00:00）
...
- 1. `socks4://168.107.13.220:50161` | `socks4` | `elite` | 200 0.752712 | source=`proxyscrape`
- 2. `socks5://43.155.232.123:1080` | `socks5` | `unknown` | 200 0.698694 | source=`monosans_kr_json`
- 3. `socks5://43.155.185.73:1080` | `socks5` | `unknown` | 200 0.701129 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.560679 | source=`monosans_kr_json`
- 5. `socks5://168.107.13.220:50161` | `socks5` | `transparent` | 200 0.893877 | source=`proxifly`
