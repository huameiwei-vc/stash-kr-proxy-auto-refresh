# KR 免费代理自动刷新报告（2026-07-23T17:51:32+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.958799 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.849680 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.218900 | source=`monosans_kr_json`
- 4. `http://58.180.17.51:3128` | `http` | `unknown` | 200 1.433111 | source=`monosans_kr_json`
- 5. `http://106.10.55.212:1121` | `http` | `unknown` | 200 3.887340 | source=`niek`
- 6. `socks5://8.213.149.224:1080` | `socks5` | `transparent` | 200 0.856692 | source=`proxifly`
- 7. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 1.472712 | source=`proxifly`
