# KR 免费代理自动刷新报告（2026-08-25T10:55:42+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.663213 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.796759 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.643950 | source=`monosans_kr_json`
- 4. `http://185.204.170.179:1142` | `http` | `unknown` | 200 5.828493 | source=`monosans_http`
