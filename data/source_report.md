# KR 免费代理自动刷新报告（2026-09-01T21:59:06+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.138002 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.759112 | source=`monosans_kr_json`
- 3. `http://43.155.203.19:3128` | `http` | `transparent` | 200 10.015483 | source=`geonode`
