# KR 免费代理自动刷新报告（2026-06-08T23:55:27+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.930265 | source=`geonode`
- 2. `socks5://59.11.209.162:1080` | `socks5` | `elite` | 200 1.236001 | source=`proxyscrape`
- 3. `http://169.212.15.161:5000` | `http` | `unknown` | 200 1.000476 | source=`monosans_kr_json`
- 4. `http://43.128.145.26:1080` | `http` | `unknown` | 200 1.546999 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.714832 | source=`monosans_kr_json`
- 6. `socks5://52.231.219.53:1433` | `socks5` | `transparent` | 200 1.879768 | source=`proxifly`
- 7. `http://43.155.138.148:3128` | `http` | `transparent` | 200 3.471846 | source=`proxifly`
