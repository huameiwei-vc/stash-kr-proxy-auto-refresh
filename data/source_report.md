# KR 免费代理自动刷新报告（2026-07-15T19:42:37+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 5.223269 | source=`geonode`
- 2. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 8.183345 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.842369 | source=`niek`
- 4. `http://58.180.17.51:3128` | `http` | `transparent` | 200 0.747516 | source=`proxifly`
