# KR 免费代理自动刷新报告（2026-06-05T21:51:16+00:00）
...
- 1. `socks5://59.11.209.162:1080` | `socks5` | `elite` | 200 1.282352 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.853083 | source=`geonode`
- 3. `socks5://150.230.249.50:1080` | `socks5` | `elite` | 200 2.020255 | source=`geonode`
- 4. `socks5://168.107.55.115:50161` | `socks5` | `elite` | 200 2.323099 | source=`proxyscrape`
- 5. `socks5://193.122.105.251:65535` | `socks5` | `elite` | 200 6.125277 | source=`geonode`
- 6. `http://175.194.173.105:3128` | `http` | `elite` | 200 0.798319 | source=`proxyscrape`
- 7. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.987153 | source=`monosans_kr_json`
