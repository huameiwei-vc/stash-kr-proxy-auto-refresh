# KR 免费代理自动刷新报告（2026-08-24T19:20:25+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.133805 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.532658 | source=`monosans_kr_json`
- 3. `http://43.203.234.171:3128` | `http` | `transparent` | 200 1.121115 | source=`proxifly`
