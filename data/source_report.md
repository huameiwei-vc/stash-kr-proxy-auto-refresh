# KR 免费代理自动刷新报告（2026-08-23T13:57:31+00:00）
...
- 1. `http://152.67.207.34:1080` | `http` | `elite` | 200 5.721815 | source=`proxyscrape`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.155357 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.714998 | source=`monosans_kr_json`
- 4. `socks5://152.67.207.34:1080` | `socks5` | `transparent` | 200 4.306295 | source=`proxifly`
