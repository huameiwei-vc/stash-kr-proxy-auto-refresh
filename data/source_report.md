# KR 免费代理自动刷新报告（2026-09-01T23:46:45+00:00）
...
- 1. `socks5://43.155.215.149:20000` | `socks5` | `unknown` | 200 0.705739 | source=`monosans_kr_json`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 1.318689 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.551862 | source=`monosans_kr_json`
- 4. `http://47.80.60.84:3128` | `http` | `transparent` | 200 8.538200 | source=`proxyscrape`
