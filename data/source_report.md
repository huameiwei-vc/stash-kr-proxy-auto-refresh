# KR 免费代理自动刷新报告（2026-08-03T04:44:38+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.946197 | source=`geonode`
- 2. `socks5://43.155.232.123:1080` | `socks5` | `unknown` | 200 0.788988 | source=`monosans_kr_json`
- 3. `socks5://218.52.249.121:1080` | `socks5` | `unknown` | 200 0.793373 | source=`monosans_kr_json`
- 4. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.816995 | source=`monosans_kr_json`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.638611 | source=`niek`
- 6. `http://43.155.232.123:8090` | `http` | `unknown` | 200 0.654169 | source=`monosans_kr_json`
- 7. `http://121.174.186.199:8080` | `http` | `unknown` | 200 2.037569 | source=`iplocate`
