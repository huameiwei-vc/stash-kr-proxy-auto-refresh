# KR 免费代理自动刷新报告（2026-04-02T18:32:43+00:00）
...
- 1. `http://210.223.44.230:3128` | `http` | `anonymous` | 200 0.757062 | source=`proxyscrape`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `unknown` | 200 1.044519 | source=`iplocate`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.008806 | source=`monosans_kr_json`
- 4. `http://59.11.138.229:3128` | `http` | `transparent` | 200 0.757546 | source=`proxyscrape`
