# KR 免费代理自动刷新报告（2026-04-19T16:24:54+00:00）
...
- 1. `socks5://123.214.62.25:6881` | `socks5` | `unknown` | 200 1.193211 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.745460 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.363783 | source=`proxifly`
- 4. `http://106.10.55.212:1121` | `http` | `transparent` | 200 0.944783 | source=`proxyscrape`
