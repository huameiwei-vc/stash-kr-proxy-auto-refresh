# KR 免费代理自动刷新报告（2026-05-15T22:34:55+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.859111 | source=`geonode`
- 2. `socks4://158.247.241.3:1080` | `socks4` | `elite` | 200 1.817708 | source=`proxyscrape`
- 3. `socks5://206.123.156.226:5167` | `socks5` | `unknown` | 200 5.631188 | source=`iplocate`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.897901 | source=`monosans_kr_json`
- 5. `http://121.177.17.179:3131` | `http` | `transparent` | 200 5.586800 | source=`proxifly`
