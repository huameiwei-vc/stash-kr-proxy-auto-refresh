# KR 免费代理自动刷新报告（2026-08-15T21:32:24+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.897667 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 3.825018 | source=`monosans_kr_json`
- 3. `http://112.216.54.226:12121` | `http` | `unknown` | 200 0.711988 | source=`niek`
- 4. `http://132.226.171.101:3128` | `http` | `transparent` | 200 1.466435 | source=`proxifly`
- 5. `http://193.122.96.242:3128` | `http` | `transparent` | 200 9.109438 | source=`proxyscrape`
