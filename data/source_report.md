# KR 免费代理自动刷新报告（2026-07-16T21:41:41+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.777890 | source=`geonode`
- 2. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 2.293920 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.899623 | source=`niek`
- 4. `http://106.10.55.212:1121` | `http` | `transparent` | 200 0.756518 | source=`proxyscrape`
- 5. `http://168.126.169.198:808` | `http` | `transparent` | 200 8.131958 | source=`proxyscrape`
- 6. `http://175.215.145.180:3160` | `http` | `transparent` | 200 10.707420 | source=`proxyscrape`
