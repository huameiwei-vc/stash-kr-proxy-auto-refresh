# KR 免费代理自动刷新报告（2026-04-28T13:04:26+00:00）
...
- proxifly: 14
- proxyscrape: 6
- skillter_fallback: 224
- 去重后总候选: 94

## 当前验证通过的代理

- 1. `http://43.133.90.161:8888` | `http` | `unknown` | 200 5.285205 | source=`niek`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.897700 | source=`proxifly`
- 3. `socks5://43.133.90.161:8088` | `socks5` | `transparent` | 200 11.135940 | source=`proxifly`
