# KR 免费代理自动刷新报告（2026-06-19T14:28:40+00:00）
...
- geonode: 104
- iplocate: 2
- monosans_fallback: 35
- monosans_kr_json: 0
- niek: 9
- proxifly: 14
- proxyscrape: 23
- skillter_fallback: 116
- 去重后总候选: 148

## 当前验证通过的代理

- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.705462 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.755184 | source=`niek`
- 3. `socks5://218.52.249.121:1080` | `socks5` | `transparent` | 200 0.709916 | source=`proxifly`
