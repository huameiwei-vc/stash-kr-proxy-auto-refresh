# KR 免费代理自动刷新报告（2026-08-20T06:21:11+00:00）
...
- 1. `http://14.34.180.21:38157` | `http` | `elite` | 200 3.013341 | source=`geonode`
- 2. `http://124.61.132.233:4444` | `http` | `unknown` | 200 1.124599 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.159857 | source=`monosans_kr_json`
- 4. `socks5://150.230.249.50:1080` | `socks5` | `transparent` | 200 0.681854 | source=`proxifly`
- 5. `socks4://111.48.191.24:7890` | `socks4` | `transparent` | 200 6.714580 | source=`proxifly`
