# KR 免费代理自动刷新报告（2026-04-27T10:02:58+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `unknown` | 200 1.460596 | source=`iplocate`
- 2. `socks5://43.133.90.161:8088` | `socks5` | `unknown` | 200 6.427326 | source=`monosans_kr_json`
- 3. `socks5://152.70.237.238:3128` | `socks5` | `transparent` | 200 2.498361 | source=`proxifly`
