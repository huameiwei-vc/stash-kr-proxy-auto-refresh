# KR 免费代理自动刷新报告（2026-05-04T18:13:08+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.940192 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.961387 | source=`monosans_kr_json`
- 3. `http://193.123.250.39:1080` | `http` | `unknown` | 200 10.535611 | source=`niek`
- 4. `socks5://193.123.250.39:1080` | `socks5` | `transparent` | 200 1.877269 | source=`proxifly`
- 5. `http://121.148.239.82:3064` | `http` | `transparent` | 200 2.826297 | source=`proxyscrape`
- 6. `http://121.126.88.27:15648` | `http` | `transparent` | 200 4.074538 | source=`proxifly`
