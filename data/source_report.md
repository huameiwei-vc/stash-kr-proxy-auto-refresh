# KR 免费代理自动刷新报告（2026-05-28T16:45:32+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.981393 | source=`geonode`
- 2. `socks5://193.123.250.39:1080` | `socks5` | `elite` | 200 1.697553 | source=`proxyscrape`
- 3. `socks5://158.180.77.24:1080` | `socks5` | `elite` | 200 2.164202 | source=`geonode`
- 4. `socks5://211.200.27.100:11111` | `socks5` | `unknown` | 200 3.233039 | source=`iplocate`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.070835 | source=`monosans_kr_json`
- 6. `http://193.123.250.39:1080` | `http` | `unknown` | 200 1.073974 | source=`monosans_kr_json`
- 7. `http://43.128.145.26:1080` | `http` | `unknown` | 200 3.025763 | source=`niek`
- 8. `http://43.155.208.105:80` | `http` | `unknown` | 200 3.117328 | source=`monosans_kr_json`
