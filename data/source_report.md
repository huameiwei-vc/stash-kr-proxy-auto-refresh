# KR 免费代理自动刷新报告（2026-08-03T01:11:44+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.868553 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `elite` | 200 4.830258 | source=`geonode`
- 3. `socks5://43.155.232.123:1080` | `socks5` | `unknown` | 200 1.402264 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.511763 | source=`monosans_kr_json`
- 5. `http://43.155.232.123:8090` | `http` | `unknown` | 200 0.529448 | source=`monosans_kr_json`
