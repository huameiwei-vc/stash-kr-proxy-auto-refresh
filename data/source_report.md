# KR 免费代理自动刷新报告（2026-06-06T15:37:10+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.039202 | source=`geonode`
- 2. `socks5://150.230.249.50:1080` | `socks5` | `elite` | 200 1.323483 | source=`geonode`
- 3. `http://43.128.145.26:1080` | `http` | `unknown` | 200 2.079177 | source=`niek`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.255666 | source=`monosans_kr_json`
- 5. `http://146.56.182.165:3128` | `http` | `transparent` | 200 3.621499 | source=`proxyscrape`
