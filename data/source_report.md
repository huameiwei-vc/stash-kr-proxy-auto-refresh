# KR 免费代理自动刷新报告（2026-09-01T19:39:52+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.658863 | source=`monosans_kr_json`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.539233 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.712117 | source=`proxifly`
- 4. `http://112.186.12.207:3128` | `http` | `transparent` | 200 2.782951 | source=`proxifly`
- 5. `http://43.155.203.19:3128` | `http` | `transparent` | 200 7.773905 | source=`geonode`
