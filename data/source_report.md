# KR 免费代理自动刷新报告（2026-08-12T19:44:33+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.536890 | source=`monosans_kr_json`
- 2. `http://47.80.60.84:3128` | `http` | `transparent` | 200 0.531065 | source=`proxyscrape`
