# KR 免费代理自动刷新报告（2026-08-20T07:12:42+00:00）
...
- 1. `http://112.216.54.226:12121` | `http` | `elite` | 200 0.826208 | source=`geonode`
- 2. `http://124.61.132.233:4444` | `http` | `unknown` | 200 1.206897 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.463225 | source=`monosans_kr_json`
- 4. `socks5://150.230.249.50:1080` | `socks5` | `transparent` | 200 0.913967 | source=`proxifly`
