# KR 免费代理自动刷新报告（2026-08-23T20:35:18+00:00）
...
- 1. `http://134.185.122.68:3128` | `http` | `anonymous` | 200 1.295032 | source=`proxyscrape`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.754189 | source=`monosans_kr_json`
