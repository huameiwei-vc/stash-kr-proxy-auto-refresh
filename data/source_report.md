# KR 免费代理自动刷新报告（2026-08-21T09:49:13+00:00）
...
- 1. `socks5://150.109.247.86:8443` | `socks5` | `elite` | 200 2.952050 | source=`proxyscrape`
- 2. `socks5://182.231.145.236:1080` | `socks5` | `unknown` | 200 0.954153 | source=`monosans_kr_json`
- 3. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 2.441496 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.751933 | source=`monosans_kr_json`
- 5. `http://182.231.145.236:1080` | `http` | `unknown` | 200 0.763483 | source=`monosans_kr_json`
- 6. `http://112.216.54.226:12121` | `http` | `unknown` | 200 0.988872 | source=`niek`
