# KR 免费代理自动刷新报告（2026-08-21T17:19:38+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 3.168113 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 2.970732 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.697630 | source=`monosans_kr_json`
- 4. `socks5://111.119.162.248:10940` | `socks5` | `transparent` | 200 4.347222 | source=`proxifly`
