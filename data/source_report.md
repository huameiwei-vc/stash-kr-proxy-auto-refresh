# KR 免费代理自动刷新报告（2026-04-18T19:52:58+00:00）
...
- 1. `http://112.163.160.93:3128` | `http` | `elite` | 200 0.561850 | source=`geonode`
- 2. `http://210.223.44.230:3128` | `http` | `anonymous` | 200 1.356844 | source=`geonode`
- 3. `socks5://123.214.62.25:6881` | `socks5` | `unknown` | 200 0.859027 | source=`monosans_kr_json`
- 4. `socks5://158.179.173.238:1080` | `socks5` | `unknown` | 200 2.286111 | source=`monosans_kr_json`
- 5. `socks5://206.123.156.187:46668` | `socks5` | `unknown` | 200 6.390219 | source=`monosans_kr_json`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.590701 | source=`monosans_kr_json`
- 7. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.985687 | source=`proxifly`
