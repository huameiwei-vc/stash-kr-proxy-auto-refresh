# KR 免费代理自动刷新报告（2026-07-14T20:20:16+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.525932 | source=`geonode`
- 2. `http://211.233.44.58:8080` | `http` | `elite` | 200 7.858438 | source=`proxyscrape`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.016160 | source=`monosans_kr_json`
- 4. `http://43.201.114.116:3128` | `http` | `transparent` | 200 4.023203 | source=`proxyscrape`
- 5. `http://146.56.182.165:3128` | `http` | `transparent` | 200 4.872154 | source=`proxyscrape`
