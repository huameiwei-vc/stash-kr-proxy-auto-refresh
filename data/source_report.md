# KR 免费代理自动刷新报告（2026-08-15T14:35:29+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.759539 | source=`monosans_kr_json`
- 2. `http://124.61.132.233:4444` | `http` | `unknown` | 200 1.012817 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.945285 | source=`proxifly`
- 4. `socks5://43.164.136.189:1080` | `socks5` | `transparent` | 200 0.966724 | source=`proxifly`
