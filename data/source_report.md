# KR 免费代理自动刷新报告（2026-08-03T11:39:50+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `elite` | 200 0.938246 | source=`geonode`
- 2. `http://47.80.26.236:8080` | `http` | `elite` | 200 1.060937 | source=`proxyscrape`
- 3. `socks5://218.52.249.121:1080` | `socks5` | `unknown` | 200 4.955146 | source=`monosans_kr_json`
- 4. `socks5://216.106.179.216:49429` | `socks5` | `unknown` | 200 5.715867 | source=`iplocate`
- 5. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.791601 | source=`monosans_kr_json`
- 6. `http://211.233.44.58:8080` | `http` | `unknown` | 200 6.224839 | source=`iplocate`
