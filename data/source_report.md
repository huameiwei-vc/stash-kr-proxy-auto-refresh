# KR 免费代理自动刷新报告（2026-05-29T23:39:55+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 0.923753 | source=`geonode`
- 2. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.755082 | source=`monosans_kr_json`
- 3. `http://43.128.145.26:1080` | `http` | `unknown` | 200 1.238681 | source=`monosans_kr_json`
- 4. `http://43.155.208.105:80` | `http` | `unknown` | 200 1.776813 | source=`monosans_kr_json`
- 5. `http://146.56.182.165:3128` | `http` | `transparent` | 200 1.662601 | source=`proxyscrape`
