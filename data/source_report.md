# KR 免费代理自动刷新报告（2026-08-13T21:08:41+00:00）
...
- 1. `http://211.233.44.58:8080` | `http` | `elite` | 200 6.098195 | source=`proxyscrape`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.935946 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.768251 | source=`monosans_kr_json`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.844408 | source=`proxifly`
