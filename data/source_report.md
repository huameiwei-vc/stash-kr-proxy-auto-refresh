# KR 免费代理自动刷新报告（2026-04-25T17:22:42+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.513688 | source=`monosans_kr_json`
- 2. `http://43.133.90.161:8888` | `http` | `unknown` | 200 8.047189 | source=`monosans_kr_json`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.635150 | source=`proxifly`
- 4. `socks5://152.70.237.238:3128` | `socks5` | `transparent` | 200 1.595855 | source=`proxifly`
