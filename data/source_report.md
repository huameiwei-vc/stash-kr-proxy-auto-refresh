# KR 免费代理自动刷新报告（2026-07-09T19:11:01+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 2.236557 | source=`geonode`
- 2. `http://106.249.44.10:3128` | `http` | `elite` | 200 0.755874 | source=`proxyscrape`
- 3. `socks4://152.70.237.238:3128` | `socks4` | `elite` | 200 8.360884 | source=`proxyscrape`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.811872 | source=`niek`
- 5. `http://58.180.17.51:3128` | `http` | `transparent` | 200 3.142490 | source=`proxifly`
- 6. `http://47.80.60.84:3128` | `http` | `transparent` | 200 7.236623 | source=`proxyscrape`
