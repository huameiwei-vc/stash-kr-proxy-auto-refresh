# KR 免费代理自动刷新报告（2026-06-07T18:18:06+00:00）
...
- 1. `socks5://59.11.209.162:1080` | `socks5` | `elite` | 200 0.909005 | source=`proxyscrape`
- 2. `socks5://158.180.77.24:1080` | `socks5` | `elite` | 200 1.286953 | source=`geonode`
- 3. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.692868 | source=`geonode`
- 4. `socks5://146.56.191.98:19422` | `socks5` | `elite` | 200 8.624596 | source=`proxyscrape`
- 5. `http://169.212.15.161:5000` | `http` | `unknown` | 200 1.154592 | source=`monosans_kr_json`
- 6. `http://1.231.81.166:3128` | `http` | `unknown` | 200 2.249514 | source=`monosans_kr_json`
- 7. `http://112.168.176.184:3128` | `http` | `unknown` | 200 7.342167 | source=`niek`
- 8. `socks5://211.245.23.166:1080` | `socks5` | `transparent` | 200 0.943276 | source=`proxifly`
