# KR 免费代理自动刷新报告（2026-04-14T22:02:00+00:00）
...
- 1. `socks5://193.122.105.251:65535` | `socks5` | `elite` | 200 1.310271 | source=`proxyscrape`
- 2. `http://210.223.44.230:3128` | `http` | `anonymous` | 200 1.419973 | source=`proxyscrape`
- 3. `socks5://123.214.62.25:6881` | `socks5` | `unknown` | 200 1.100216 | source=`monosans_kr_json`
- 4. `http://1.231.81.166:3128` | `http` | `unknown` | 200 3.133929 | source=`monosans_kr_json`
- 5. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 2.002992 | source=`proxifly`
