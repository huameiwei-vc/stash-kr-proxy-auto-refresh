# KR 免费代理自动刷新报告（2026-08-10T22:53:16+00:00）
...
- 1. `socks5://121.169.46.116:1090` | `socks5` | `elite` | 200 1.156858 | source=`geonode`
- 2. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.924762 | source=`monosans_kr_json`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.582871 | source=`monosans_kr_json`
- 4. `http://43.155.138.148:3128` | `http` | `unknown` | 200 2.803863 | source=`monosans_kr_json`
- 5. `http://115.144.37.67:15648` | `http` | `unknown` | 200 4.602720 | source=`monosans_kr_json`
- 6. `socks5://47.80.27.150:1080` | `socks5` | `transparent` | 200 0.722848 | source=`proxifly`
