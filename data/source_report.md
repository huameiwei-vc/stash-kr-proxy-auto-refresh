# KR 免费代理自动刷新报告（2026-04-13T17:17:32+00:00）
...
- 1. `socks5://43.133.77.87:1080` | `socks5` | `unknown` | 200 1.163783 | source=`monosans_kr_json`
- 2. `http://112.163.160.93:3128` | `http` | `unknown` | 200 0.925563 | source=`niek`
- 3. `http://1.231.81.166:3128` | `http` | `unknown` | 200 1.823526 | source=`niek`
- 4. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 1.595391 | source=`proxifly`
- 5. `socks5://206.123.156.213:5378` | `socks5` | `transparent` | 200 2.877451 | source=`proxifly`
