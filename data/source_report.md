# KR 免费代理自动刷新报告（2026-08-20T03:35:11+00:00）
...
- 1. `http://1.231.81.166:3128` | `http` | `unknown` | 200 0.747472 | source=`monosans_kr_json`
- 2. `http://124.61.132.233:4444` | `http` | `unknown` | 200 2.685458 | source=`monosans_kr_json`
- 3. `socks5://150.230.249.50:1080` | `socks5` | `transparent` | 200 1.014325 | source=`proxifly`
