# KR 免费代理自动刷新报告（2026-08-15T16:37:11+00:00）
...
- 1. `socks5://43.164.136.189:1080` | `socks5` | `unknown` | 200 0.658014 | source=`monosans_kr_json`
- 2. `socks5://121.169.46.116:1090` | `socks5` | `transparent` | 200 0.655299 | source=`proxifly`
- 3. `http://132.226.171.101:3128` | `http` | `transparent` | 200 1.428476 | source=`proxifly`
